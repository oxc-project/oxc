...
// NOTE: Prettier version is now pinned to `v3.8.1` (not updated by workflow above), Update manually as needed
...
const PRETTIER_SHA = "55fc5dbe0737c56ce09ebf4a3c25159374b9c8a1";
