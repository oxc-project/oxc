...
if an entry about the Prettier-fallback boundary itself is ever added, group it under a separate
heading so the removal scope stays obvious when the fallback goes away.
