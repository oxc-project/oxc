...
use taplo::formatter::Options as TaploFormatterOptions;
...
pub enum ResolvedOptions {
    ...
    /// For TOML files formatted by taplo.
    OxfmtToml { taplo_options: TaploFormatterOptions },
    ...
    pub fn resolve(&self, strategy: &FormatFileStrategy) -> ResolvedOptions {
        ...
        match strategy {
            ...
            FormatFileStrategy::OxfmtToml { .. } => {
                ResolvedOptions::OxfmtToml { taplo_options: build_taplo_options(&format_options) }
            }
            #[cfg(feature = "napi")]
...
fn build_taplo_options(format_options: &FormatOptions) -> TaploFormatterOptions {
    TaploFormatterOptions {
