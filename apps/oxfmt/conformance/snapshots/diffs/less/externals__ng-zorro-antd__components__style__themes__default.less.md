...
// Extra extra extra large screen / full hd desktop
@screen-xxxl: 1920px;
...
@select-multiple-item-height: @input-height-base -
  @input-padding-vertical-base * 2; // Normal 24px
@select-multiple-item-height-sm: @input-height-sm -
  @input-padding-vertical-base * 2;
...
@modal-header-close-size: @modal-header-title-line-height + 2 *
