# externals/ng-zorro-antd/components/date-picker/style/panel.less
...
@@ -181,10 +181,10 @@
     ...
     // >>> Hover
     &:hover:not(&-in-view),
     &:hover:not(&-selected):not(&-range-start):not(&-range-end):not(
-        &-range-hover-start
-      ):not(&-range-hover-end) {
+      &-range-hover-start
+    ):not(&-range-hover-end) {
...
@@ -237,13 +237,13 @@
     ...
     // >>> Range Hover
     &-in-view&-range-hover-start:not(&-in-range):not(&-range-start):not(
-        &-range-end
-      ),
+      &-range-end
+    ),
     &-in-view&-range-hover-end:not(&-in-range):not(&-range-start):not(
-        &-range-end
-      ),
+      &-range-end
+    ),
...
@@ -343,10 +343,10 @@
     ...
     &-in-view&-range-hover-edge-start:not(
-        &-range-hover-edge-start-near-range
-      )::after,
+      &-range-hover-edge-start-near-range
+    )::after,
...
@@ -358,10 +358,10 @@
     ...
     &-in-view&-range-hover-edge-end:not(
-        &-range-hover-edge-end-near-range
-      )::after,
+      &-range-hover-edge-end-near-range
+    )::after,
