 ...
 */
export declare function lint(args: Array<string>, loadPlugin: JsLoadPluginCb, setupConfigs: JsSetupConfigsCb, lintFile: JsLintFileCb, loadJsConfigs: JsLoadJsConfigsCb): Promise<boolean>
