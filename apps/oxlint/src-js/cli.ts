...
function loadPluginWrapper(
  ...
  pluginSettingsName: string | null | undefined,
  ...
  debugAssertIsNotUndefined(pluginSettingsName, "`pluginSettingsName` should not be `undefined`");
  ...
  if (loadPlugin === null) {
    ...
    return import("./plugins/index.ts").then((mod) => {
      ...
      return loadPlugin(path, pluginName, pluginSettingsName, pluginNameIsAlias, workspaceUri);
    });
  }
  return loadPlugin(path, pluginName, pluginSettingsName, pluginNameIsAlias, workspaceUri);
}
