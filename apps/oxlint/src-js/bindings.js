...
function requireNative() {
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === 'x64') {
      ...
      try {
        return require('@oxlint/win32-x64')
      } catch (e) {
        loadErrors.push(e)
      }
      ...
      try {
        return require('@oxlint/win32-ia32')
      } catch (e) {
        loadErrors.push(e)
      }
      ...
      try {
        return require('@oxlint/win32-arm64')
      } catch (e) {
        loadErrors.push(e)
      }
    } else {
    ...
    if (process.arch === 'arm64') {
      try {
        return require('./oxlint.linux-arm64-ohos.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
      ...
      try {
        return require('./oxlint.linux-x64-ohos.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
      ...
      try {
        return require('./oxlint.linux-arm-ohos.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
...
if (!nativeBinding || process.env.NAPI_RS_FORCE_WASI) {
  try {
    nativeBinding = require('./oxlint.wasi.cjs')
  } catch (err) {
