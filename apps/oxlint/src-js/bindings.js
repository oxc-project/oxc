  ...
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === 'arm64') {
      ...
      try {
        ...
        if (bindingPackageVersion !== '1.78.0' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          throw new Error(`Native binding package version mismatch, expected 1.78.0 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
        }
        return binding
      } catch (e) {
        loadErrors.push(e)
...
if (!nativeBinding || forceWasi) {
  ...
  if (!wasiBindingLoaded && (!__napiWasiFlavorRequested || __napiWasiFlavor === "wasm32-wasi")) {
    ...
    try {
      candidateError = __napiWasiResolveCandidate('./oxlint.wasi.cjs', false, ["./oxlint.wasm32-wasi.debug.wasm","./oxlint.wasm32-wasi.wasm"])
    ...
    try {
      ...
      if (!candidateFailed) {
        if (process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          ...
          if (bindingPackageVersion !== '1.78.0') {
            throw new Error(`WASI binding package version mismatch, expected 1.78.0 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
          }
        }
...
const { Severity, applyFixes, getBufferOffset, lint, notifyWorkerDied, parseRawSync, rawTransferSupported, registerWorker, setJsPluginWorkerCount } = nativeBinding
export { Severity }
export { applyFixes }
export { getBufferOffset }
export { lint }
export { notifyWorkerDied }
export { parseRawSync }
