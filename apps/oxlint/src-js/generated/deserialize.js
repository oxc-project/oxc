...
const textDecoder = new TextDecoder("utf-8", { ignoreBOM: true }), decodeStr = textDecoder.decode.bind(textDecoder), { fromCodePoint } = String, NodeProto = Object.create(null, { loc: {
	get() {
		return getLoc(this);
	},
	enumerable: true
