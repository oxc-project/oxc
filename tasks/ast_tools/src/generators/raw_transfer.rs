...
fn generate_deserializers(
    ...
    let mut code = format!("
        ...
        const textDecoder = new TextDecoder('utf-8', {{ ignoreBOM: true }}),
            ...
            {{ fromCodePoint, fromCharCode }} = String;
...
static STR_DESERIALIZER_BODY: &str = "
    ...
    // Use `TextDecoder` for strings longer than 48 bytes.
    // For shorter strings, a single `fromCharCode` call with all byte values is faster
    // than both TextDecoder (native call overhead) and the byte-by-byte concat loop.
    // V8 optimizes a direct `fromCharCode` call with known argument count much better
    // than repeated string concatenation.
    const end = pos + len;
    if (len > 48) return decodeStr(uint8.subarray(pos, end));

    // Check if all bytes are ASCII
    let allAscii = true;
    for (let i = pos; i < end; i++) {
        if (uint8[i] >= 0x80) { allAscii = false; break; }
    }
    if (allAscii) {
        switch (len) {
            ...
            case 25: return fromCharCode(uint8[pos], uint8[pos+1], uint8[pos+2], uint8[pos+3], uint8[pos+4], uint8[pos+5], uint8[pos+6], uint8[pos+7], uint8[pos+8], uint8[pos+9], uint8[pos+10], uint8[pos+11], uint8[pos+12], uint8[pos+13], uint8[pos+14], uint8[pos+15], uint8[pos+16], uint8[pos+17], uint8[pos+18], uint8[pos+19], uint8[pos+20], uint8[pos+21], uint8[pos+22], uint8[pos+23], uint8[pos+24]);
            case 26: return fromCharCode(uint8[pos], uint8[pos+1], uint8[pos+2], uint8[pos+3], uint8[pos+4], uint8[pos+5], uint8[pos+6], uint8[pos+7], uint8[pos+8], uint8[pos+9], uint8[pos+10], uint8[pos+11], uint8[pos+12], uint8[pos+13], uint8[pos+14], uint8[pos+15], uint8[pos+16], uint8[pos+17], uint8[pos+18], uint8[pos+19], uint8[pos+20], uint8[pos+21], uint8[pos+22], uint8[pos+23], uint8[pos+24], uint8[pos+25]);
            case 27: return fromCharCode(uint8[pos], uint8[pos+1], uint8[pos+2], uint8[pos+3], uint8[pos+4], uint8[pos+5], uint8[pos+6], uint8[pos+7], uint8[pos+8], uint8[pos+9], uint8[pos+10], uint8[pos+11], uint8[pos+12], uint8[pos+13], uint8[pos+14], uint8[pos+15], uint8[pos+16], uint8[pos+17], uint8[pos+18], uint8[pos+19], uint8[pos+20], uint8[pos+21], uint8[pos+22], uint8[pos+23], uint8[pos+24], uint8[pos+25], uint8[pos+26]);
            case 28: return fromCharCode(uint8[pos], uint8[pos+1], uint8[pos+2], uint8[pos+3], uint8[pos+4], uint8[pos+5], uint8[pos+6], uint8[pos+7], uint8[pos+8], uint8[pos+9], uint8[pos+10], uint8[pos+11], uint8[pos+12], uint8[pos+13], uint8[pos+14], uint8[pos+15], uint8[pos+16], uint8[pos+17], uint8[pos+18], uint8[pos+19], uint8[pos+20], uint8[pos+21], uint8[pos+22], uint8[pos+23], uint8[pos+24], uint8[pos+25], uint8[pos+26], uint8[pos+27]);
            case 29: return fromCharCode(uint8[pos], uint8[pos+1], uint8[pos+2], uint8[pos+3], uint8[pos+4], uint8[pos+5], uint8[pos+6], uint8[pos+7], uint8[pos+8], uint8[pos+9], uint8[pos+10], uint8[pos+11], uint8[pos+12], uint8[pos+13], uint8[pos+14], uint8[pos+15], uint8[pos+16], uint8[pos+17], uint8[pos+18], uint8[pos+19], uint8[pos+20], uint8[pos+21], uint8[pos+22], uint8[pos+23], uint8[pos+24], uint8[pos+25], uint8[pos+26], uint8[pos+27], uint8[pos+28]);
            case 30: return fromCharCode(uint8[pos], uint8[pos+1], uint8[pos+2], uint8[pos+3], uint8[pos+4], uint8[pos+5], uint8[pos+6], uint8[pos+7], uint8[pos+8], uint8[pos+9], uint8[pos+10], uint8[pos+11], uint8[pos+12], uint8[pos+13], uint8[pos+14], uint8[pos+15], uint8[pos+16], uint8[pos+17], uint8[pos+18], uint8[pos+19], uint8[pos+20], uint8[pos+21], uint8[pos+22], uint8[pos+23], uint8[pos+24], uint8[pos+25], uint8[pos+26], uint8[pos+27], uint8[pos+28], uint8[pos+29]);
            case 31: return fromCharCode(uint8[pos], uint8[pos+1], uint8[pos+2], uint8[pos+3], uint8[pos+4], uint8[pos+5], uint8[pos+6], uint8[pos+7], uint8[pos+8], uint8[pos+9], uint8[pos+10], uint8[pos+11], uint8[pos+12], uint8[pos+13], uint8[pos+14], uint8[pos+15], uint8[pos+16], uint8[pos+17], uint8[pos+18], uint8[pos+19], uint8[pos+20], uint8[pos+21], uint8[pos+22], uint8[pos+23], uint8[pos+24], uint8[pos+25], uint8[pos+26], uint8[pos+27], uint8[pos+28], uint8[pos+29], uint8[pos+30]);
            case 32: return fromCharCode(uint8[pos], uint8[pos+1], uint8[pos+2], uint8[pos+3], uint8[pos+4], uint8[pos+5], uint8[pos+6], uint8[pos+7], uint8[pos+8], uint8[pos+9], uint8[pos+10], uint8[pos+11], uint8[pos+12], uint8[pos+13], uint8[pos+14], uint8[pos+15], uint8[pos+16], uint8[pos+17], uint8[pos+18], uint8[pos+19], uint8[pos+20], uint8[pos+21], uint8[pos+22], uint8[pos+23], uint8[pos+24], uint8[pos+25], uint8[pos+26], uint8[pos+27], uint8[pos+28], uint8[pos+29], uint8[pos+30], uint8[pos+31]);
            case 33: return fromCharCode(uint8[pos], uint8[pos+1], uint8[pos+2], uint8[pos+3], uint8[pos+4], uint8[pos+5], uint8[pos+6], uint8[pos+7], uint8[pos+8], uint8[pos+9], uint8[pos+10], uint8[pos+11], uint8[pos+12], uint8[pos+13], uint8[pos+14], uint8[pos+15], uint8[pos+16], uint8[pos+17], uint8[pos+18], uint8[pos+19], uint8[pos+20], uint8[pos+21], uint8[pos+22], uint8[pos+23], uint8[pos+24], uint8[pos+25], uint8[pos+26], uint8[pos+27], uint8[pos+28], uint8[pos+29], uint8[pos+30], uint8[pos+31], uint8[pos+32]);
            case 34: return fromCharCode(uint8[pos], uint8[pos+1], uint8[pos+2], uint8[pos+3], uint8[pos+4], uint8[pos+5], uint8[pos+6], uint8[pos+7], uint8[pos+8], uint8[pos+9], uint8[pos+10], uint8[pos+11], uint8[pos+12], uint8[pos+13], uint8[pos+14], uint8[pos+15], uint8[pos+16], uint8[pos+17], uint8[pos+18], uint8[pos+19], uint8[pos+20], uint8[pos+21], uint8[pos+22], uint8[pos+23], uint8[pos+24], uint8[pos+25], uint8[pos+26], uint8[pos+27], uint8[pos+28], uint8[pos+29], uint8[pos+30], uint8[pos+31], uint8[pos+32], uint8[pos+33]);
            case 35: return fromCharCode(uint8[pos], uint8[pos+1], uint8[pos+2], uint8[pos+3], uint8[pos+4], uint8[pos+5], uint8[pos+6], uint8[pos+7], uint8[pos+8], uint8[pos+9], uint8[pos+10], uint8[pos+11], uint8[pos+12], uint8[pos+13], uint8[pos+14], uint8[pos+15], uint8[pos+16], uint8[pos+17], uint8[pos+18], uint8[pos+19], uint8[pos+20], uint8[pos+21], uint8[pos+22], uint8[pos+23], uint8[pos+24], uint8[pos+25], uint8[pos+26], uint8[pos+27], uint8[pos+28], uint8[pos+29], uint8[pos+30], uint8[pos+31], uint8[pos+32], uint8[pos+33], uint8[pos+34]);
            case 36: return fromCharCode(uint8[pos], uint8[pos+1], uint8[pos+2], uint8[pos+3], uint8[pos+4], uint8[pos+5], uint8[pos+6], uint8[pos+7], uint8[pos+8], uint8[pos+9], uint8[pos+10], uint8[pos+11], uint8[pos+12], uint8[pos+13], uint8[pos+14], uint8[pos+15], uint8[pos+16], uint8[pos+17], uint8[pos+18], uint8[pos+19], uint8[pos+20], uint8[pos+21], uint8[pos+22], uint8[pos+23], uint8[pos+24], uint8[pos+25], uint8[pos+26], uint8[pos+27], uint8[pos+28], uint8[pos+29], uint8[pos+30], uint8[pos+31], uint8[pos+32], uint8[pos+33], uint8[pos+34], uint8[pos+35]);
            case 37: return fromCharCode(uint8[pos], uint8[pos+1], uint8[pos+2], uint8[pos+3], uint8[pos+4], uint8[pos+5], uint8[pos+6], uint8[pos+7], uint8[pos+8], uint8[pos+9], uint8[pos+10], uint8[pos+11], uint8[pos+12], uint8[pos+13], uint8[pos+14], uint8[pos+15], uint8[pos+16], uint8[pos+17], uint8[pos+18], uint8[pos+19], uint8[pos+20], uint8[pos+21], uint8[pos+22], uint8[pos+23], uint8[pos+24], uint8[pos+25], uint8[pos+26], uint8[pos+27], uint8[pos+28], uint8[pos+29], uint8[pos+30], uint8[pos+31], uint8[pos+32], uint8[pos+33], uint8[pos+34], uint8[pos+35], uint8[pos+36]);
            case 38: return fromCharCode(uint8[pos], uint8[pos+1], uint8[pos+2], uint8[pos+3], uint8[pos+4], uint8[pos+5], uint8[pos+6], uint8[pos+7], uint8[pos+8], uint8[pos+9], uint8[pos+10], uint8[pos+11], uint8[pos+12], uint8[pos+13], uint8[pos+14], uint8[pos+15], uint8[pos+16], uint8[pos+17], uint8[pos+18], uint8[pos+19], uint8[pos+20], uint8[pos+21], uint8[pos+22], uint8[pos+23], uint8[pos+24], uint8[pos+25], uint8[pos+26], uint8[pos+27], uint8[pos+28], uint8[pos+29], uint8[pos+30], uint8[pos+31], uint8[pos+32], uint8[pos+33], uint8[pos+34], uint8[pos+35], uint8[pos+36], uint8[pos+37]);
            case 39: return fromCharCode(uint8[pos], uint8[pos+1], uint8[pos+2], uint8[pos+3], uint8[pos+4], uint8[pos+5], uint8[pos+6], uint8[pos+7], uint8[pos+8], uint8[pos+9], uint8[pos+10], uint8[pos+11], uint8[pos+12], uint8[pos+13], uint8[pos+14], uint8[pos+15], uint8[pos+16], uint8[pos+17], uint8[pos+18], uint8[pos+19], uint8[pos+20], uint8[pos+21], uint8[pos+22], uint8[pos+23], uint8[pos+24], uint8[pos+25], uint8[pos+26], uint8[pos+27], uint8[pos+28], uint8[pos+29], uint8[pos+30], uint8[pos+31], uint8[pos+32], uint8[pos+33], uint8[pos+34], uint8[pos+35], uint8[pos+36], uint8[pos+37], uint8[pos+38]);
            case 40: return fromCharCode(uint8[pos], uint8[pos+1], uint8[pos+2], uint8[pos+3], uint8[pos+4], uint8[pos+5], uint8[pos+6], uint8[pos+7], uint8[pos+8], uint8[pos+9], uint8[pos+10], uint8[pos+11], uint8[pos+12], uint8[pos+13], uint8[pos+14], uint8[pos+15], uint8[pos+16], uint8[pos+17], uint8[pos+18], uint8[pos+19], uint8[pos+20], uint8[pos+21], uint8[pos+22], uint8[pos+23], uint8[pos+24], uint8[pos+25], uint8[pos+26], uint8[pos+27], uint8[pos+28], uint8[pos+29], uint8[pos+30], uint8[pos+31], uint8[pos+32], uint8[pos+33], uint8[pos+34], uint8[pos+35], uint8[pos+36], uint8[pos+37], uint8[pos+38], uint8[pos+39]);
            case 41: return fromCharCode(uint8[pos], uint8[pos+1], uint8[pos+2], uint8[pos+3], uint8[pos+4], uint8[pos+5], uint8[pos+6], uint8[pos+7], uint8[pos+8], uint8[pos+9], uint8[pos+10], uint8[pos+11], uint8[pos+12], uint8[pos+13], uint8[pos+14], uint8[pos+15], uint8[pos+16], uint8[pos+17], uint8[pos+18], uint8[pos+19], uint8[pos+20], uint8[pos+21], uint8[pos+22], uint8[pos+23], uint8[pos+24], uint8[pos+25], uint8[pos+26], uint8[pos+27], uint8[pos+28], uint8[pos+29], uint8[pos+30], uint8[pos+31], uint8[pos+32], uint8[pos+33], uint8[pos+34], uint8[pos+35], uint8[pos+36], uint8[pos+37], uint8[pos+38], uint8[pos+39], uint8[pos+40]);
            case 42: return fromCharCode(uint8[pos], uint8[pos+1], uint8[pos+2], uint8[pos+3], uint8[pos+4], uint8[pos+5], uint8[pos+6], uint8[pos+7], uint8[pos+8], uint8[pos+9], uint8[pos+10], uint8[pos+11], uint8[pos+12], uint8[pos+13], uint8[pos+14], uint8[pos+15], uint8[pos+16], uint8[pos+17], uint8[pos+18], uint8[pos+19], uint8[pos+20], uint8[pos+21], uint8[pos+22], uint8[pos+23], uint8[pos+24], uint8[pos+25], uint8[pos+26], uint8[pos+27], uint8[pos+28], uint8[pos+29], uint8[pos+30], uint8[pos+31], uint8[pos+32], uint8[pos+33], uint8[pos+34], uint8[pos+35], uint8[pos+36], uint8[pos+37], uint8[pos+38], uint8[pos+39], uint8[pos+40], uint8[pos+41]);
            case 43: return fromCharCode(uint8[pos], uint8[pos+1], uint8[pos+2], uint8[pos+3], uint8[pos+4], uint8[pos+5], uint8[pos+6], uint8[pos+7], uint8[pos+8], uint8[pos+9], uint8[pos+10], uint8[pos+11], uint8[pos+12], uint8[pos+13], uint8[pos+14], uint8[pos+15], uint8[pos+16], uint8[pos+17], uint8[pos+18], uint8[pos+19], uint8[pos+20], uint8[pos+21], uint8[pos+22], uint8[pos+23], uint8[pos+24], uint8[pos+25], uint8[pos+26], uint8[pos+27], uint8[pos+28], uint8[pos+29], uint8[pos+30], uint8[pos+31], uint8[pos+32], uint8[pos+33], uint8[pos+34], uint8[pos+35], uint8[pos+36], uint8[pos+37], uint8[pos+38], uint8[pos+39], uint8[pos+40], uint8[pos+41], uint8[pos+42]);
            case 44: return fromCharCode(uint8[pos], uint8[pos+1], uint8[pos+2], uint8[pos+3], uint8[pos+4], uint8[pos+5], uint8[pos+6], uint8[pos+7], uint8[pos+8], uint8[pos+9], uint8[pos+10], uint8[pos+11], uint8[pos+12], uint8[pos+13], uint8[pos+14], uint8[pos+15], uint8[pos+16], uint8[pos+17], uint8[pos+18], uint8[pos+19], uint8[pos+20], uint8[pos+21], uint8[pos+22], uint8[pos+23], uint8[pos+24], uint8[pos+25], uint8[pos+26], uint8[pos+27], uint8[pos+28], uint8[pos+29], uint8[pos+30], uint8[pos+31], uint8[pos+32], uint8[pos+33], uint8[pos+34], uint8[pos+35], uint8[pos+36], uint8[pos+37], uint8[pos+38], uint8[pos+39], uint8[pos+40], uint8[pos+41], uint8[pos+42], uint8[pos+43]);
            case 45: return fromCharCode(uint8[pos], uint8[pos+1], uint8[pos+2], uint8[pos+3], uint8[pos+4], uint8[pos+5], uint8[pos+6], uint8[pos+7], uint8[pos+8], uint8[pos+9], uint8[pos+10], uint8[pos+11], uint8[pos+12], uint8[pos+13], uint8[pos+14], uint8[pos+15], uint8[pos+16], uint8[pos+17], uint8[pos+18], uint8[pos+19], uint8[pos+20], uint8[pos+21], uint8[pos+22], uint8[pos+23], uint8[pos+24], uint8[pos+25], uint8[pos+26], uint8[pos+27], uint8[pos+28], uint8[pos+29], uint8[pos+30], uint8[pos+31], uint8[pos+32], uint8[pos+33], uint8[pos+34], uint8[pos+35], uint8[pos+36], uint8[pos+37], uint8[pos+38], uint8[pos+39], uint8[pos+40], uint8[pos+41], uint8[pos+42], uint8[pos+43], uint8[pos+44]);
            case 46: return fromCharCode(uint8[pos], uint8[pos+1], uint8[pos+2], uint8[pos+3], uint8[pos+4], uint8[pos+5], uint8[pos+6], uint8[pos+7], uint8[pos+8], uint8[pos+9], uint8[pos+10], uint8[pos+11], uint8[pos+12], uint8[pos+13], uint8[pos+14], uint8[pos+15], uint8[pos+16], uint8[pos+17], uint8[pos+18], uint8[pos+19], uint8[pos+20], uint8[pos+21], uint8[pos+22], uint8[pos+23], uint8[pos+24], uint8[pos+25], uint8[pos+26], uint8[pos+27], uint8[pos+28], uint8[pos+29], uint8[pos+30], uint8[pos+31], uint8[pos+32], uint8[pos+33], uint8[pos+34], uint8[pos+35], uint8[pos+36], uint8[pos+37], uint8[pos+38], uint8[pos+39], uint8[pos+40], uint8[pos+41], uint8[pos+42], uint8[pos+43], uint8[pos+44], uint8[pos+45]);
            case 47: return fromCharCode(uint8[pos], uint8[pos+1], uint8[pos+2], uint8[pos+3], uint8[pos+4], uint8[pos+5], uint8[pos+6], uint8[pos+7], uint8[pos+8], uint8[pos+9], uint8[pos+10], uint8[pos+11], uint8[pos+12], uint8[pos+13], uint8[pos+14], uint8[pos+15], uint8[pos+16], uint8[pos+17], uint8[pos+18], uint8[pos+19], uint8[pos+20], uint8[pos+21], uint8[pos+22], uint8[pos+23], uint8[pos+24], uint8[pos+25], uint8[pos+26], uint8[pos+27], uint8[pos+28], uint8[pos+29], uint8[pos+30], uint8[pos+31], uint8[pos+32], uint8[pos+33], uint8[pos+34], uint8[pos+35], uint8[pos+36], uint8[pos+37], uint8[pos+38], uint8[pos+39], uint8[pos+40], uint8[pos+41], uint8[pos+42], uint8[pos+43], uint8[pos+44], uint8[pos+45], uint8[pos+46]);
            case 48: return fromCharCode(uint8[pos], uint8[pos+1], uint8[pos+2], uint8[pos+3], uint8[pos+4], uint8[pos+5], uint8[pos+6], uint8[pos+7], uint8[pos+8], uint8[pos+9], uint8[pos+10], uint8[pos+11], uint8[pos+12], uint8[pos+13], uint8[pos+14], uint8[pos+15], uint8[pos+16], uint8[pos+17], uint8[pos+18], uint8[pos+19], uint8[pos+20], uint8[pos+21], uint8[pos+22], uint8[pos+23], uint8[pos+24], uint8[pos+25], uint8[pos+26], uint8[pos+27], uint8[pos+28], uint8[pos+29], uint8[pos+30], uint8[pos+31], uint8[pos+32], uint8[pos+33], uint8[pos+34], uint8[pos+35], uint8[pos+36], uint8[pos+37], uint8[pos+38], uint8[pos+39], uint8[pos+40], uint8[pos+41], uint8[pos+42], uint8[pos+43], uint8[pos+44], uint8[pos+45], uint8[pos+46], uint8[pos+47]);
        }
    }
