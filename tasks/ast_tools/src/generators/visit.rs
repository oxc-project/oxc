...
/// and recusively walking dependent types (e.g. types of struct fields for a struct)
...
impl<'s> VisitBuilder<'s> {
    ...
    fn generate_struct_visitor(&mut self, struct_def: &StructDef) {
        ...
        // TODO: Don't hard-code this. Represent it in an attr in AST type defintion instead.
