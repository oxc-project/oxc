...
impl Context {
    ...
    pub fn render_rule_docs_page(&mut self, rule: &RuleTableRow) -> Result<String, fmt::Error> {
        ...
        writeln!(
            self.page,
            "<!-- This file is auto-generated by {file}. Do not edit it manually. -->\n"
        )?;
...
// - If plugin is "eslint" and `explicit_plugin_name: false`, return "rule-name"
// - If plugin is "eslint" and `explicit_plugin_name: true`, return "eslint/rule-name"
// - If plugin is "react_perf" and `explicit_plugin_name: false`, return "react-perf/rule-name"
// - If plugin is "react_perf" and `explicit_plugin_name: true`, return "react-perf/rule-name"
fn full_rule_name(
    rule: &RuleTableRow,
    normalized_plugin_name: &str,
    explicit_plugin_name: bool,
) -> String {
    if normalized_plugin_name.is_empty() && explicit_plugin_name {
        format!("{}/{}", "eslint", rule.name)
    } else if normalized_plugin_name.is_empty() {
        rule.name.to_string()
    } else {
