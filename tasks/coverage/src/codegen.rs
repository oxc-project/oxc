...
fn get_normal_result(
    ...
    let source_text1 =
        Codegen::<false>::new(&source_text, options, None).build(&parse_result1.program);
    let parse_result2 = Parser::new(&allocator, &source_text1, source_type).parse();
    let source_text2 =
        Codegen::<false>::new(&source_text1, options, None).build(&parse_result2.program);
...
fn get_minify_result(
    ...
    let parse_result1 = Parser::new(&allocator, source_text, source_type).parse();
    let source_text1 =
        Codegen::<true>::new(&source_text, options, None).build(&parse_result1.program);
    let parse_result2 = Parser::new(&allocator, source_text1.as_str(), source_type).parse();
    let source_text2 =
        Codegen::<true>::new(&source_text1, options, None).build(&parse_result2.program);
    let result = source_text1 == source_text2;
