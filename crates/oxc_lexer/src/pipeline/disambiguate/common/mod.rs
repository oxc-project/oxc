...
pub(super) const KW_ABSTRACT: u8 = kw(TokenKind::KwAbstract);
pub(super) const KW_AS: u8 = kw(TokenKind::KwAs);
pub(super) const KW_ASSERTS: u8 = kw(TokenKind::KwAsserts);
pub(super) const KW_AWAIT: u8 = kw(TokenKind::KwAwait);
pub(super) const KW_BREAK: u8 = kw(TokenKind::KwBreak);
pub(super) const KW_CASE: u8 = kw(TokenKind::KwCase);
pub(super) const KW_CATCH: u8 = kw(TokenKind::KwCatch);
pub(super) const KW_CLASS: u8 = kw(TokenKind::KwClass);
pub(super) const KW_CONST: u8 = kw(TokenKind::KwConst);
pub(super) const KW_CONTINUE: u8 = kw(TokenKind::KwContinue);
pub(super) const KW_DEBUGGER: u8 = kw(TokenKind::KwDebugger);
pub(super) const KW_DEFAULT: u8 = kw(TokenKind::KwDefault);
pub(super) const KW_DELETE: u8 = kw(TokenKind::KwDelete);
pub(super) const KW_DO: u8 = kw(TokenKind::KwDo);
pub(super) const KW_ELSE: u8 = kw(TokenKind::KwElse);
pub(super) const KW_ENUM: u8 = kw(TokenKind::KwEnum);
pub(super) const KW_EXPORT: u8 = kw(TokenKind::KwExport);
pub(super) const KW_EXTENDS: u8 = kw(TokenKind::KwExtends);
pub(super) const KW_FINALLY: u8 = kw(TokenKind::KwFinally);
pub(super) const KW_FOR: u8 = kw(TokenKind::KwFor);
pub(super) const KW_FUNCTION: u8 = kw(TokenKind::KwFunction);
pub(super) const KW_IF: u8 = kw(TokenKind::KwIf);
pub(super) const KW_IMPORT: u8 = kw(TokenKind::KwImport);
pub(super) const KW_IN: u8 = kw(TokenKind::KwIn);
pub(super) const KW_INFER: u8 = kw(TokenKind::KwInfer);
pub(super) const KW_INSTANCEOF: u8 = kw(TokenKind::KwInstanceof);
pub(super) const KW_IS: u8 = kw(TokenKind::KwIs);
pub(super) const KW_KEYOF: u8 = kw(TokenKind::KwKeyof);
pub(super) const KW_LET: u8 = kw(TokenKind::KwLet);
pub(super) const KW_NEW: u8 = kw(TokenKind::KwNew);
pub(super) const KW_READONLY: u8 = kw(TokenKind::KwReadonly);
pub(super) const KW_RETURN: u8 = kw(TokenKind::KwReturn);
pub(super) const KW_SUPER: u8 = kw(TokenKind::KwSuper);
pub(super) const KW_SWITCH: u8 = kw(TokenKind::KwSwitch);
pub(super) const KW_THIS: u8 = kw(TokenKind::KwThis);
pub(super) const KW_THROW: u8 = kw(TokenKind::KwThrow);
pub(super) const KW_TRY: u8 = kw(TokenKind::KwTry);
pub(super) const KW_TYPEOF: u8 = kw(TokenKind::KwTypeof);
pub(super) const KW_UNIQUE: u8 = kw(TokenKind::KwUnique);
pub(super) const KW_VAR: u8 = kw(TokenKind::KwVar);
pub(super) const KW_WHILE: u8 = kw(TokenKind::KwWhile);
pub(super) const KW_WITH: u8 = kw(TokenKind::KwWith);
pub(super) const KW_YIELD: u8 = kw(TokenKind::KwYield);
