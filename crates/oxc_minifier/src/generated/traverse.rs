...
pub trait MinifierTraverse<'a> {
    #[inline]
    fn enter_program(&mut self, node: &mut Program<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    #[inline]
    fn exit_program(&mut self, node: &mut Program<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}

    #[inline]
    fn enter_expression(&mut self, node: &mut Expression<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    #[inline]
    fn exit_expression(&mut self, node: &mut Expression<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}

    #[inline]
    fn enter_identifier_name(
        &mut self,
        node: &mut IdentifierName<'a>,
        ctx: &mut MinifierTraverseCtx<'a>,
    ) {
    }
    #[inline]
    fn exit_identifier_name(
        &mut self,
        node: &mut IdentifierName<'a>,
        ctx: &mut MinifierTraverseCtx<'a>,
    ) {
    ...
    #[inline]
    fn enter_elision(&mut self, node: &mut Elision, ctx: &mut MinifierTraverseCtx<'a>) {}
    #[inline]
    fn exit_elision(&mut self, node: &mut Elision, ctx: &mut MinifierTraverseCtx<'a>) {}
    ...
    #[inline]
    fn exit_property_key(&mut self, node: &mut PropertyKey<'a>, ctx: &mut MinifierTraverseCtx<'a>) {
    }
    ...
    #[inline]
    fn enter_argument(&mut self, node: &mut Argument<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    #[inline]
    fn exit_argument(&mut self, node: &mut Argument<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    ...
    #[inline]
    fn enter_super(&mut self, node: &mut Super, ctx: &mut MinifierTraverseCtx<'a>) {}
    #[inline]
    fn exit_super(&mut self, node: &mut Super, ctx: &mut MinifierTraverseCtx<'a>) {}
    ...
    #[inline]
    fn enter_statement(&mut self, node: &mut Statement<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    #[inline]
    fn exit_statement(&mut self, node: &mut Statement<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}

    #[inline]
    fn enter_directive(&mut self, node: &mut Directive<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    #[inline]
    fn exit_directive(&mut self, node: &mut Directive<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}

    #[inline]
    fn enter_hashbang(&mut self, node: &mut Hashbang<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    #[inline]
    fn exit_hashbang(&mut self, node: &mut Hashbang<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    ...
    #[inline]
    fn enter_declaration(&mut self, node: &mut Declaration<'a>, ctx: &mut MinifierTraverseCtx<'a>) {
    }
    #[inline]
    fn exit_declaration(&mut self, node: &mut Declaration<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    ...
    #[inline]
    fn exit_if_statement(&mut self, node: &mut IfStatement<'a>, ctx: &mut MinifierTraverseCtx<'a>) {
    }
    ...
    #[inline]
    fn enter_switch_case(&mut self, node: &mut SwitchCase<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    #[inline]
    fn exit_switch_case(&mut self, node: &mut SwitchCase<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    ...
    #[inline]
    fn exit_catch_clause(&mut self, node: &mut CatchClause<'a>, ctx: &mut MinifierTraverseCtx<'a>) {
    }
    ...
    #[inline]
    fn enter_function(&mut self, node: &mut Function<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    #[inline]
    fn exit_function(&mut self, node: &mut Function<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    ...
    #[inline]
    fn enter_class(&mut self, node: &mut Class<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    #[inline]
    fn exit_class(&mut self, node: &mut Class<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}

    #[inline]
    fn enter_class_body(&mut self, node: &mut ClassBody<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    #[inline]
    fn exit_class_body(&mut self, node: &mut ClassBody<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    ...
    #[inline]
    fn exit_static_block(&mut self, node: &mut StaticBlock<'a>, ctx: &mut MinifierTraverseCtx<'a>) {
    }
    ...
    #[inline]
    fn enter_with_clause(&mut self, node: &mut WithClause<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    #[inline]
    fn exit_with_clause(&mut self, node: &mut WithClause<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    ...
    #[inline]
    fn enter_null_literal(&mut self, node: &mut NullLiteral, ctx: &mut MinifierTraverseCtx<'a>) {}
    #[inline]
    fn exit_null_literal(&mut self, node: &mut NullLiteral, ctx: &mut MinifierTraverseCtx<'a>) {}
    ...
    #[inline]
    fn enter_jsx_element(&mut self, node: &mut JSXElement<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    #[inline]
    fn exit_jsx_element(&mut self, node: &mut JSXElement<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    ...
    #[inline]
    fn exit_jsx_fragment(&mut self, node: &mut JSXFragment<'a>, ctx: &mut MinifierTraverseCtx<'a>) {
    }
    ...
    #[inline]
    fn enter_jsx_child(&mut self, node: &mut JSXChild<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    #[inline]
    fn exit_jsx_child(&mut self, node: &mut JSXChild<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    ...
    #[inline]
    fn enter_jsx_text(&mut self, node: &mut JSXText<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    #[inline]
    fn exit_jsx_text(&mut self, node: &mut JSXText<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    ...
    #[inline]
    fn enter_ts_enum_body(&mut self, node: &mut TSEnumBody<'a>, ctx: &mut MinifierTraverseCtx<'a>) {
    }
    #[inline]
    fn exit_ts_enum_body(&mut self, node: &mut TSEnumBody<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    ...
    #[inline]
    fn enter_ts_literal(&mut self, node: &mut TSLiteral<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    #[inline]
    fn exit_ts_literal(&mut self, node: &mut TSLiteral<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}

    #[inline]
    fn enter_ts_type(&mut self, node: &mut TSType<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    #[inline]
    fn exit_ts_type(&mut self, node: &mut TSType<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    ...
    #[inline]
    fn enter_ts_rest_type(&mut self, node: &mut TSRestType<'a>, ctx: &mut MinifierTraverseCtx<'a>) {
    }
    #[inline]
    fn exit_ts_rest_type(&mut self, node: &mut TSRestType<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    ...
    #[inline]
    fn enter_ts_any_keyword(&mut self, node: &mut TSAnyKeyword, ctx: &mut MinifierTraverseCtx<'a>) {
    }
    #[inline]
    fn exit_ts_any_keyword(&mut self, node: &mut TSAnyKeyword, ctx: &mut MinifierTraverseCtx<'a>) {}
    ...
    #[inline]
    fn enter_ts_this_type(&mut self, node: &mut TSThisType, ctx: &mut MinifierTraverseCtx<'a>) {}
    #[inline]
    fn exit_ts_this_type(&mut self, node: &mut TSThisType, ctx: &mut MinifierTraverseCtx<'a>) {}
    ...
    #[inline]
    fn enter_ts_type_name(&mut self, node: &mut TSTypeName<'a>, ctx: &mut MinifierTraverseCtx<'a>) {
    }
    #[inline]
    fn exit_ts_type_name(&mut self, node: &mut TSTypeName<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    ...
    #[inline]
    fn exit_ts_signature(&mut self, node: &mut TSSignature<'a>, ctx: &mut MinifierTraverseCtx<'a>) {
    }
    ...
    #[inline]
    fn enter_decorator(&mut self, node: &mut Decorator<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
    #[inline]
    fn exit_decorator(&mut self, node: &mut Decorator<'a>, ctx: &mut MinifierTraverseCtx<'a>) {}
