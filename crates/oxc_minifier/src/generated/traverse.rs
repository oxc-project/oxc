...
pub trait Traverse<'a> {
    ...
    #[inline]
    fn enter_leading_dot_expression(
        &mut self,
    ...
    #[inline]
    fn exit_leading_dot_expression(
        &mut self,
        node: &mut LeadingDotExpression<'a>,
        ctx: &mut TraverseCtx<'a>,
    ) {
    ...
    #[inline]
    fn exit_struct_statement(&mut self, node: &mut StructStatement<'a>, ctx: &mut TraverseCtx<'a>) {
    }

    #[inline]
    fn enter_struct_body(&mut self, node: &mut StructBody<'a>, ctx: &mut TraverseCtx<'a>) {}
    #[inline]
    fn exit_struct_body(&mut self, node: &mut StructBody<'a>, ctx: &mut TraverseCtx<'a>) {}

    #[inline]
    fn enter_struct_element(&mut self, node: &mut StructElement<'a>, ctx: &mut TraverseCtx<'a>) {}
    #[inline]
    fn exit_struct_element(&mut self, node: &mut StructElement<'a>, ctx: &mut TraverseCtx<'a>) {}

    #[inline]
    fn enter_ark_ui_component_expression(
        &mut self,
    ...
    #[inline]
    fn exit_ark_ui_component_expression(
        &mut self,
        node: &mut ArkUIComponentExpression<'a>,
        ctx: &mut TraverseCtx<'a>,
    ) {
    ...
    #[inline]
    fn enter_ark_ui_child(&mut self, node: &mut ArkUIChild<'a>, ctx: &mut TraverseCtx<'a>) {}
    #[inline]
    fn exit_ark_ui_child(&mut self, node: &mut ArkUIChild<'a>, ctx: &mut TraverseCtx<'a>) {}
    ...
    #[inline]
    fn enter_annotation_body(&mut self, node: &mut AnnotationBody<'a>, ctx: &mut TraverseCtx<'a>) {}
    #[inline]
    fn exit_annotation_body(&mut self, node: &mut AnnotationBody<'a>, ctx: &mut TraverseCtx<'a>) {}
