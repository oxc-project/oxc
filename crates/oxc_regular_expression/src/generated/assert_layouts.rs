...
const _: () = {
    ...
    assert!(offset_of!(CapturingGroup, name) == 40);
    assert!(offset_of!(CapturingGroup, body) == 8);
...
const _: () = {
    ...
    // Padding: 6 bytes
    assert!(size_of::<UnicodePropertyEscape>() == 32);
    assert!(align_of::<UnicodePropertyEscape>() == 8);
    assert!(offset_of!(UnicodePropertyEscape, span) == 0);
    ...
    assert!(align_of::<CapturingGroup>() == 8);
    assert!(offset_of!(CapturingGroup, span) == 0);
    assert!(offset_of!(CapturingGroup, name) == 32);
    assert!(offset_of!(CapturingGroup, body) == 8);
