...
impl<'a, 'ctx> ReactRefresh<'a, 'ctx> {
    pub fn new(
        ...
        Self {
            refresh_reg: RefreshIdentifierResolver::parse(&options.refresh_reg, traverse_ctx.ast),
            refresh_sig: RefreshIdentifierResolver::parse(&options.refresh_sig, traverse_ctx.ast),
