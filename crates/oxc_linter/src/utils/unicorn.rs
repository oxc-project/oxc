...
pub fn is_same_member_expression(
    ...
    let left_static_property_name = left.static_property_name().and_then(oxc_str::JSStr::as_str);
    let right_static_property_name = right.static_property_name().and_then(oxc_str::JSStr::as_str);
