                            ...
                            let labels = &message.error.labels.clone().map(|labels| {
                                labels
                                    ...
                                    .map(|labeled_span| {
                                        ...
                                        SpanPositionMessage::new(start_position, end_position)
                            ...
                            MessageWithPosition {
                                ...
                                fixes: match &message.fixes {
                                    ...
                                    PossibleFixes::Single(fix) => {
                                        PossibleFixesWithPosition::Single(fix_to_fix_with_position(
                                            fix,
                                            rope,
                                            source_text,
                                        ))
                                    ...
                                    PossibleFixes::Multiple(fixes) => {
                                        PossibleFixesWithPosition::Multiple(
                                            fixes
                                                .iter()
                                                .map(|fix| {
                                                    fix_to_fix_with_position(fix, rope, source_text)
                                                })
                                                .collect(),
                                        )
                                    }
