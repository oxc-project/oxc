...
fn no_distracting_elements_diagnostic(span0: Span) -> OxcDiagnostic {
    OxcDiagnostic::warning("eslint-plugin-jsx-a11y(no-distracting-elements): Do not use <marquee> or <blink> elements as they can create visual accessibility issues and are deprecated.")
