...
fn missing_alt_prop(span0: Span) -> OxcDiagnostic {
    OxcDiagnostic::warning("eslint-plugin-jsx-a11y(alt-text): Missing `alt` attribute.")
...
fn missing_alt_value(span0: Span) -> OxcDiagnostic {
    OxcDiagnostic::warning("eslint-plugin-jsx-a11y(alt-text): Invalid `alt` value.")
        .with_help(
...
fn aria_label_value(span0: Span) -> OxcDiagnostic {
    OxcDiagnostic::warning("eslint-plugin-jsx-a11y(alt-text): Missing value for aria-label attribute.")
...
fn prefer_alt(span0: Span) -> OxcDiagnostic {
    OxcDiagnostic::warning("eslint-plugin-jsx-a11y(alt-text): ARIA used where native HTML could suffice.")
...
fn object(span0: Span) -> OxcDiagnostic {
    OxcDiagnostic::warning("eslint-plugin-jsx-a11y(alt-text): Missing alternative text.")
