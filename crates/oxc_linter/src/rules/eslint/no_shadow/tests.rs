...
fn test_eslint() {
    ...
    let pass = vec![
        ...
        ("function foo() { var Form = 0; }", Some(serde_json::json!([{ "builtinGlobals": true }])), Some(serde_json::json!({ "env": { "browser": true } })), None),
        ("function foo() { var removeFile = 0; }", Some(serde_json::json!([{ "builtinGlobals": true }])), Some(serde_json::json!({ "env": { "browser": true } })), None),
        ("function foo() { var Form = 0; }", Some(serde_json::json!([{ "builtinGlobals": true }])), Some(serde_json::json!({ "env": { "browser": true, "node": true } })), None),
        ("function foo() { var removeFile = 0; }", Some(serde_json::json!([{ "builtinGlobals": true }])), Some(serde_json::json!({ "env": { "browser": true, "node": true } })), None),
        (
    ...
    let fail = vec![
        ...
        ("var top = 0;", Some(serde_json::json!([{ "builtinGlobals": true }])), Some(serde_json::json!({ "env": { "browser": true } })), None),
        ("function foo() { var window = 0; var process = 0; }", Some(serde_json::json!([{ "builtinGlobals": true }])), Some(serde_json::json!({ "env": { "browser": true, "node": true } })), None),
