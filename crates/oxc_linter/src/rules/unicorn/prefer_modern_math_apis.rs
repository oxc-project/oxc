...
fn test() {
    ...
    let pass = vec![
        ...
        "Math.log(x) * LOG2E",
        "Math[log](x) * Math.LOG2E",
        "foo.Math.log(x) * Math.LOG2E",
        "Math.log(x) * foo.Math.LOG2E",
        "Math.log(x) * Math.NOT_LOG2E",
        "Math.log(x) * Math?.LOG2E",
        "Math?.log(x) * Math.LOG2E",
        "log(x) * Math.LOG2E",
        "new Math.log(x) * Math.LOG2E",
        "Math.not_log(x) + Math.LOG2E",
        "Math.log(x)[Math.LOG2E]",
        "Math.log() * Math.LOG2E",
        "Math.log(x, extraArgument) * Math.LOG2E",
        "Math.log(...x) * Math.LOG2E",
        "Math.LN2 / Math.LN2",
        "Math.log(x) /Math[LN2]",
        "Math.log(x) / LN2",
        "Math[log](x) / Math.LN2",
        "foo.Math.log(x) / Math.LN2",
        "Math.log(x) / foo.Math.LN2",
        "Math.log(x) / Math.log(x)",
        "Math.log(x) / Math.NOT_LN2",
        "Math.log(x) / Math?.LN2",
        "Math?.log(x) / Math.LN2",
        "log(x) / Math.LN2",
        "new Math.log(x) / Math.LN2",
        "Math.not_log(x) + Math.LN2",
        "Math.log(x)[Math.LN2]",
        "Math.log() / Math.LN2",
        "Math.log(x, extraArgument) / Math.LN2",
        "Math.log(...x) / Math.LN2",
    ];
    ...
    let fail = vec![
        ...
        "Math.log(x) / Math.LN2",
        "Math.log((( 0,x ))) * Math.LOG2E",
        "Math.LOG2E * Math.log((( 0,x )))",
        "Math.log((( 0,x ))) / Math.LN2",
        "
            function foo(x) {
                return (
                    Math.log(x)
