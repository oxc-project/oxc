...
fn test() {
    ...
    let pass = vec![
        ...
        // `String#split("")` splits into UTF-16 code units, so it is not interchangeable with
        // spreading, which iterates code points. eslint-plugin-unicorn dropped it in v66.
        r#""string".split("")"#,
        r#""string".split('')"#,
        r#"unknown.split("")"#,
