...
fn test() {
    ...
    let pass = vec![
        ...
        "function foo() { array?.push(value); }",
        "function foo() { array?.unshift(value); }",
    ...
    let fail = vec![
        ...
        "function foo() { return array.push?.(value); }",
        "function foo() { return array.unshift?.(value); }",
        "async function foo() { return await array.push(value); }",
        "async function foo() { return await array.unshift(value); }",
        ...
        "function foo() { return /* comment */ array.push(value); }",
        "function foo() { return /* comment */ array.unshift(value); }",
        "function foo() { return array.push(/* comment */ value); }",
        "function foo() { return array.unshift(/* comment */ value); }",
        "function foo() { if (condition) return array.push(value); }",
        "function foo() { if (condition) return array.unshift(value); }",
        "function foo() { return condition && array.push(value); }",
        "function foo() { return condition && array.unshift(value); }",
        "function foo() { return condition ? array.push(value) : value; }",
        "function foo() { return condition ? array.unshift(value) : value; }",
        "function foo() { return condition ? value : array.push(value); }",
        "function foo() { return condition ? value : array.unshift(value); }",
        "function foo() { return (sideEffect(), array.push(value)); }",
        "function foo() { return (sideEffect(), array.unshift(value)); }",
        "function foo() { foo(); return [array].push(value); }",
        "function foo() { foo(); return [array].unshift(value); }",
    ...
    let fix = vec![
        ...
        (
            "function foo() { foo(); return [array].unshift(value); }",
            "function foo() { foo(); [array].unshift(value); return; }",
        ),
        (
            "function foo() { return array.push(/* comment */ value); }",
            "function foo() { array.push(/* comment */ value); return; }",
        ),
        (
            "function foo() { return array.unshift(/* comment */ value); }",
            "function foo() { array.unshift(/* comment */ value); return; }",
        ),
        (
