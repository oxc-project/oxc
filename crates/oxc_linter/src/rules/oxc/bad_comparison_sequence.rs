...
fn is_bad_comparison(expr: &BinaryExpression) -> bool {
    if expr.operator.is_equality()
        && matches!(&expr.left, ExpressionKind::BinaryExpression(left_expr) if left_expr.operator.is_equality())
    {
        return true;
    }

    if expr.operator.is_compare()
        && matches!(&expr.left, ExpressionKind::BinaryExpression(left_expr) if left_expr.operator.is_compare())
    {
        return true;
    }
...
fn test() {
    ...
    let pass = vec![
        ...
        "if (a <= b != c) { console.log('foo') }",
        "if (a <= b !== c) { console.log('foo') }",
        "if ((a == b) && (b == c)) { console.log('foo') }",
        "if ((a > b) && (b > c)) { console.log('foo') }",
    ];

    let fail = vec![
        "if (a == b == c) { console.log('foo') }",
        "if (a == b == c == d) { console.log('foo') }",
        "if ((a == b == c) == d) { console.log('foo') }",
        "if ((a == b == c) == d == e == f) { console.log('foo') }",
        "if (a == b === c) { console.log('foo') }",
        "if (a == b != c) { console.log('foo') }",
        "if (a == b !== c) { console.log('foo') }",
        "if (a === b == c) { console.log('foo') }",
