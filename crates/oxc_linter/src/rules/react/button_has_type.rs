...
fn test() {
    ...
    let pass = vec![
        (r"<span/>", None, None),
        (r#"<span type="foo"/>"#, None, None),
        (r#"<button type="button"/>"#, None, None),
        (r#"<button type="submit"/>"#, None, None),
        (r#"<button type="reset"/>"#, None, None),
        (r#"<button type={"button"}/>"#, None, None),
        (r"<button type={'button'}/>", None, None),
        (r"<button type={`button`}/>", None, None),
        (r#"<button type={condition ? "button" : "submit"}/>"#, None, None),
        (r"<button type={condition ? 'button' : 'submit'}/>", None, None),
        (r"<button type={condition ? `button` : `submit`}/>", None, None),
        (r#"<button type="button"/>"#, Some(serde_json::json!([{ "reset": false }])), None),
        (r#"createElement("span")"#, None, None),
        (r#"React.createElement("span")"#, None, None),
        (r#"React.createElement("span", {type: "foo"})"#, None, None),
        (r#"React.createElement("button", {type: "button"})"#, None, None),
        (r#"React.createElement("button", {type: 'button'})"#, None, None),
        (r#"React.createElement("button", {type: `button`})"#, None, None),
        (r#"React.createElement("button", {type: "submit"})"#, None, None),
        (r#"React.createElement("button", {type: 'submit'})"#, None, None),
        (r#"React.createElement("button", {type: `submit`})"#, None, None),
        (r#"React.createElement("button", {type: "reset"})"#, None, None),
        (r#"React.createElement("button", {type: 'reset'})"#, None, None),
        (r#"React.createElement("button", {type: `reset`})"#, None, None),
        (r#"React.createElement("button", {type: condition ? "button" : "submit"})"#, None, None),
        (r#"React.createElement("button", {type: condition ? 'button' : 'submit'})"#, None, None),
        (r#"React.createElement("button", {type: condition ? `button` : `submit`})"#, None, None),
        (
    ...
    let fail = vec![
        (r"<button/>", None, None),
        (r#"<button type="foo"/>"#, None, None),
        (r"<button type={foo}/>", None, None),
        (r#"<button type={"foo"}/>"#, None, None),
        (r"<button type={'foo'}/>", None, None),
        (r"<button type={`foo`}/>", None, None),
        (r"<button type={`button${foo}`}/>", None, None),
        (r#"<button type="reset"/>"#, Some(serde_json::json!([{ "reset": false }])), None),
        (r#"<button type={condition ? "button" : foo}/>"#, None, None),
        (r#"<button type={condition ? "button" : "foo"}/>"#, None, None),
        (
        ...
        (r#"<button type={condition ? foo : "button"}/>"#, None, None),
        (r#"<button type={condition ? "foo" : "button"}/>"#, None, None),
        (r"button type/>", None, None),
        (
            r#"<button type={condition ? "reset" : "button"}/>"#,
            Some(serde_json::json!([{ "reset": false }])),
            None,
        ),
        (r#"createElement("button")"#, None, None),
        (r#"React.createElement("button")"#, None, None),
        (r#"React.createElement("button", {type: foo})"#, None, None),
        (r#"React.createElement("button", {type: "foo"})"#, None, None),
        (
        ...
        (r#"React.createElement("button", {type: condition ? "button" : foo})"#, None, None),
        (r#"React.createElement("button", {type: condition ? "button" : "foo"})"#, None, None),
        (
        ...
        (r#"React.createElement("button", {type: condition ? foo : "button"})"#, None, None),
        (r#"React.createElement("button", {type: condition ? "foo" : "button"})"#, None, None),
        (
