...
lazy_static! {
    static ref ATTRIBUTE_TAGS_MAP: Map<&'static str, Set<&'static str>> = phf_map! {
        "abbr" => phf_set! {"th", "td"},
    ...
    static ref DOM_PROPERTIES_NAMES: Set<&'static str> = phf_set! {
    ...
    static ref DOM_PROPERTIES_LOWER_MAP: HashMap<String, &'static str> = DOM_PROPERTIES_NAMES.iter().map(|it| (it.to_lowercase(), *it)).collect::<HashMap<_, _>>();

    static ref ARIA_PROPERTIES: Set<&'static str> = phf_set! {
    ...
    static ref DOM_PROPERTIES_IGNORE_CASE: [&'static str; 5] = [
        "charset",
        "allowFullScreen",
    ...
    static ref DOM_ATTRIBUTES_TO_CAMEL: Map<&'static str, &'static str> = phf_map! {
