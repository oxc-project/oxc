...
impl RuleRunner for crate::rules::eslint::arrow_body_style::ArrowBodyStyle {
    const NODE_TYPES: &AstTypesBitset =
        &AstTypesBitset::from_types(&[AstType::ArrowFunctionExpression]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::eslint::default_case::DefaultCase {
    const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::SwitchStatement]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::eslint::for_direction::ForDirection {
    const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::ForStatement]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = true;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::eslint::grouped_accessor_pairs::GroupedAccessorPairs {
    const NODE_TYPES: &AstTypesBitset =
        &AstTypesBitset::from_types(&[AstType::ClassBody, AstType::ObjectExpression]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::eslint::no_async_promise_executor::NoAsyncPromiseExecutor {
    const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::NewExpression]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = true;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
{
    const NODE_TYPES: &AstTypesBitset =
        &AstTypesBitset::from_types(&[AstType::BinaryExpression, AstType::LogicalExpression]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = true;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::eslint::no_constructor_return::NoConstructorReturn {
    const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::ReturnStatement]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = true;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::eslint::no_delete_var::NoDeleteVar {
    const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::UnaryExpression]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = true;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::eslint::no_dupe_else_if::NoDupeElseIf {
    const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::IfStatement]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = true;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::eslint::no_empty_function::NoEmptyFunction {
    const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::FunctionBody]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::eslint::no_label_var::NoLabelVar {
    const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::LabeledStatement]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = true;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::eslint::no_lone_blocks::NoLoneBlocks {
    const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::BlockStatement]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = true;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::eslint::no_plusplus::NoPlusplus {
    const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::UpdateExpression]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::eslint::no_restricted_imports::NoRestrictedImports {
    const NODE_TYPES: &AstTypesBitset =
        &AstTypesBitset::from_types(&[AstType::TSImportEqualsDeclaration]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
impl RuleRunner for crate::rules::eslint::no_return_assign::NoReturnAssign {
    const NODE_TYPES: &AstTypesBitset =
        &AstTypesBitset::from_types(&[AstType::AssignmentExpression]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::eslint::no_throw_literal::NoThrowLiteral {
    const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::ThrowStatement]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = true;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
impl RuleRunner for crate::rules::eslint::no_unassigned_vars::NoUnassignedVars {
    const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::VariableDeclarator]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = true;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::eslint::no_undefined::NoUndefined {
    const NODE_TYPES: &AstTypesBitset =
        &AstTypesBitset::from_types(&[AstType::BindingIdentifier, AstType::IdentifierReference]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = true;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::eslint::no_unused_expressions::NoUnusedExpressions {
    const NODE_TYPES: &AstTypesBitset =
        &AstTypesBitset::from_types(&[AstType::ExpressionStatement]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::eslint::no_useless_catch::NoUselessCatch {
    const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::TryStatement]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = true;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::eslint::no_useless_constructor::NoUselessConstructor {
    const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::MethodDefinition]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = true;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
{
    const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::ImportDeclaration]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::import::no_anonymous_default_export::NoAnonymousDefaultExport {
    const NODE_TYPES: &AstTypesBitset =
        &AstTypesBitset::from_types(&[AstType::ExportDefaultDeclaration]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::import::no_dynamic_require::NoDynamicRequire {
    const NODE_TYPES: &AstTypesBitset =
        &AstTypesBitset::from_types(&[AstType::CallExpression, AstType::ImportExpression]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::import::no_unassigned_import::NoUnassignedImport {
    const NODE_TYPES: &AstTypesBitset =
        &AstTypesBitset::from_types(&[AstType::ExpressionStatement, AstType::ImportDeclaration]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::jest::no_alias_methods::NoAliasMethods {
    ...
    const ANY_NODE_TYPE: bool = true;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = true;
}
...
impl RuleRunner for crate::rules::nextjs::inline_script_id::InlineScriptId {
    const NODE_TYPES: &AstTypesBitset =
        &AstTypesBitset::from_types(&[AstType::ImportDefaultSpecifier]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = true;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::oxc::no_accumulating_spread::NoAccumulatingSpread {
    const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::SpreadElement]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = true;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::react::checked_requires_onchange_or_readonly::CheckedRequiresOnchangeOrReadonly {
                const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::CallExpression, AstType::JSXOpeningElement]);
                const ANY_NODE_TYPE: bool = false;
                const ONLY_RUNS_ON_NODES: bool = false;
                const ONLY_RUNS_ON_JEST_NODES: bool = false;
            }
...
impl RuleRunner for crate::rules::react::no_children_prop::NoChildrenProp {
    const NODE_TYPES: &AstTypesBitset =
        &AstTypesBitset::from_types(&[AstType::CallExpression, AstType::JSXAttribute]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = true;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::react::no_direct_mutation_state::NoDirectMutationState {
    const NODE_TYPES: &AstTypesBitset =
        &AstTypesBitset::from_types(&[AstType::AssignmentExpression, AstType::UpdateExpression]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::typescript::ban_types::BanTypes {
    const NODE_TYPES: &AstTypesBitset =
        &AstTypesBitset::from_types(&[AstType::TSTypeLiteral, AstType::TSTypeReference]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::typescript::no_duplicate_enum_values::NoDuplicateEnumValues {
    const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::TSEnumBody]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::typescript::no_explicit_any::NoExplicitAny {
    const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::TSAnyKeyword]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::typescript::no_extraneous_class::NoExtraneousClass {
    const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::Class]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::typescript::no_namespace::NoNamespace {
    const NODE_TYPES: &AstTypesBitset =
        &AstTypesBitset::from_types(&[AstType::TSModuleDeclaration]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::typescript::no_non_null_asserted_optional_chain::NoNonNullAssertedOptionalChain {
                const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::TSNonNullExpression]);
                const ANY_NODE_TYPE: bool = false;
                const ONLY_RUNS_ON_NODES: bool = false;
                const ONLY_RUNS_ON_JEST_NODES: bool = false;
            }
impl RuleRunner for crate::rules::typescript::no_non_null_assertion::NoNonNullAssertion {
    const NODE_TYPES: &AstTypesBitset =
        &AstTypesBitset::from_types(&[AstType::TSNonNullExpression]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::typescript::no_require_imports::NoRequireImports {
    const NODE_TYPES: &AstTypesBitset =
        &AstTypesBitset::from_types(&[AstType::CallExpression, AstType::TSImportEqualsDeclaration]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
{
    const NODE_TYPES: &AstTypesBitset =
        &AstTypesBitset::from_types(&[AstType::TSTypeParameterDeclaration]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
{
    const NODE_TYPES: &AstTypesBitset =
        &AstTypesBitset::from_types(&[AstType::Class, AstType::TSInterfaceDeclaration]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::typescript::prefer_literal_enum_member::PreferLiteralEnumMember {
    const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::TSEnumMember]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::unicorn::no_accessor_recursion::NoAccessorRecursion {
    const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::ThisExpression]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = true;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::unicorn::no_null::NoNull {
    const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::NullLiteral]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = false;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
{
    const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::AssignmentPattern]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = true;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::unicorn::prefer_array_some::PreferArraySome {
    const NODE_TYPES: &AstTypesBitset =
        &AstTypesBitset::from_types(&[AstType::BinaryExpression, AstType::CallExpression]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = true;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
...
impl RuleRunner for crate::rules::unicorn::prefer_logical_operator_over_ternary::PreferLogicalOperatorOverTernary {
                const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::ConditionalExpression]);
                const ANY_NODE_TYPE: bool = false;
                const ONLY_RUNS_ON_NODES: bool = true;
                const ONLY_RUNS_ON_JEST_NODES: bool = false;
            }
...
{
    const NODE_TYPES: &AstTypesBitset = &AstTypesBitset::from_types(&[AstType::CatchParameter]);
    const ANY_NODE_TYPE: bool = false;
    const ONLY_RUNS_ON_NODES: bool = true;
    const ONLY_RUNS_ON_JEST_NODES: bool = false;
}
