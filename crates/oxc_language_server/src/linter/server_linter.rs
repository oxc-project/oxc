...
mod test {
    ...
    fn test_cross_module_debugger() {
        ...
        Tester::new_with_linter_cross_module(linter)
    ...
    fn test_cross_module_no_cycle_nested_config() {
        ...
        nested_configs.insert(folder_config_path.clone(), folder_store);
    ...
    fn test_cross_module_no_cycle_extended_config() {
        ...
        let mut nested_configs = FxHashMap::default();
        nested_configs.insert(folder_config_path.clone(), folder_store);
        nested_configs.insert(extended_config_path.clone(), extended_store);
