...
fn lower_statement(
    ...
    match stmt {
        ...
        oxc::Statement::TSEnumDeclaration(e) => {
            ...
            // `UnsupportedNode` carrying the enum's source byte span so the
            // back-end can re-parse it verbatim from source (matching the original
            ...
            lower_value_to_temporary(
                ...
                InstructionValue::UnsupportedNode {
                    ...
                    original_span: Some((e.span.start, e.span.end)),
                    loc,
                },
            )?;
        }
