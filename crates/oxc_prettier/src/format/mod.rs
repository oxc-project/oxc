...
impl<'a> Format<'a> for ForStatementInit<'a> {
    fn format(&self, p: &mut Prettier<'a>) -> Doc<'a> {
        match self {
            ...
            ForStatementInit::Dummy => dummy!(unreachable),
        }
    }
}
...
impl<'a> Format<'a> for ForStatementLeft<'a> {
    fn format(&self, p: &mut Prettier<'a>) -> Doc<'a> {
        match self {
            ...
            ForStatementLeft::Dummy => dummy!(unreachable),
        }
    }
}
...
impl<'a> Format<'a> for TSType<'a> {
    fn format(&self, p: &mut Prettier<'a>) -> Doc<'a> {
        match self {
            ...
            TSType::Dummy => dummy!(unreachable),
        }
    }
}
...
impl<'a> Format<'a> for TSLiteralType<'a> {
    fn format(&self, p: &mut Prettier<'a>) -> Doc<'a> {
        match &self.literal {
            ...
            TSLiteral::Dummy => dummy!(unreachable),
        }
    }
}
...
impl<'a> Format<'a> for TSTypeName<'a> {
    fn format(&self, p: &mut Prettier<'a>) -> Doc<'a> {
        match self {
            ...
            TSTypeName::Dummy => dummy!(unreachable),
        }
    }
}
...
impl<'a> Format<'a> for ClassElement<'a> {
    fn format(&self, p: &mut Prettier<'a>) -> Doc<'a> {
        match self {
            ...
            ClassElement::Dummy => dummy!(unreachable),
        }
    }
}
