...
impl<'a> trustfall::provider::Adapter<'a> for Adapter {
    ...
    fn resolve_property(
        ...
        match type_name.as_ref() {
            ...
            "Class" => super::properties::resolve_class_property(
                contexts,
                property_name.as_ref(),
                resolve_info,
            ),
            "ClassAST" => super::properties::resolve_class_ast_property(
                contexts,
                property_name.as_ref(),
                resolve_info,
            ),
            ...
            "Type_" => super::properties::resolve_type_property(
                contexts,
                property_name.as_ref(),
                resolve_info,
            ),
    ...
    fn resolve_neighbors(
        ...
        match type_name.as_ref() {
            ...
            "Type_" => super::edges::resolve_type_edge(
                contexts,
                edge_name.as_ref(),
                parameters,
                resolve_info,
