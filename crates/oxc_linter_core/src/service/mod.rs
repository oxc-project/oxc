...
use crate::{Linter, RuleTimingStore, rule::BuiltinRule, suppression::DiffManager};
...
pub struct LintService<R: BuiltinRule> {
    runtime: Runtime<R>,
}

impl<R: BuiltinRule> LintService<R> {
    pub fn new(linter: Linter<R>, options: LintServiceOptions) -> Self {
