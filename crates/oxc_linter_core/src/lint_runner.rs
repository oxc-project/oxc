...
use crate::{
    ...
    OsFileSystem, RuleTimingStore, TsGoLintState, rule::BuiltinRule, suppression::DiffManager,
};
...
pub struct LintRunner<R: BuiltinRule> {
    /// Regular oxc linter
    lint_service: LintService<R>,
    /// Type-aware tsgolint
    type_aware_linter: Option<TsGoLintState<R>>,
...
pub struct LintRunnerBuilder<R: BuiltinRule> {
    regular_linter: Linter<R>,
...
impl<R: BuiltinRule> LintRunnerBuilder<R> {
    pub fn new(lint_service_options: LintServiceOptions, linter: Linter<R>) -> Self {
        Self {
    ...
    pub fn build(self) -> Result<LintRunner<R>, String> {
...
impl<R: BuiltinRule> LintRunner<R> {
