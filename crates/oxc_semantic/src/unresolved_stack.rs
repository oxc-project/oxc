...
/// Uses `SmallVec` with inline capacity of 1 to avoid heap allocations for the common case
/// where an identifier is referenced only once within a given scope.
pub type ReferenceIds = SmallVec<[ReferenceId; 1]>;
