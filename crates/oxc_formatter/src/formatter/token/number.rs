...
mod tests {
    ...
    fn removes_unnecessary_plus_and_zeros_from_scientific_notation() {
        assert_eq!("1e2", format_trimmed_number("1e02", NumberFormatOptions::default()));
        assert_eq!("1e2", format_trimmed_number("1e+2", NumberFormatOptions::default()));
    }

    #[test]
    fn removes_unnecessary_scientific_notation() {
        assert_eq!("1", format_trimmed_number("1e0", NumberFormatOptions::default()));
        assert_eq!("1", format_trimmed_number("1e-0", NumberFormatOptions::default()));
    }
    #[test]
    fn does_not_get_bamboozled_by_hex() {
        assert_eq!("0xe0", format_trimmed_number("0xe0", NumberFormatOptions::default()));
        assert_eq!("0x10e0", format_trimmed_number("0x10e0", NumberFormatOptions::default()));
    }

    #[test]
    fn makes_sure_numbers_always_start_with_a_digit() {
        assert_eq!("0.2", format_trimmed_number(".2", NumberFormatOptions::default()));
    }

    #[test]
    fn removes_extraneous_trailing_decimal_zeroes() {
        assert_eq!("0.1", format_trimmed_number("0.10", NumberFormatOptions::default()));
    }
    #[test]
    fn keeps_one_trailing_decimal_zero() {
        assert_eq!(
            ...
            format_trimmed_number(
                "0.00",
                NumberFormatOptions { keep_one_trailing_decimal_zero: true }
            )
        );
    }
    ...
    fn removes_trailing_dot() {
        assert_eq!("1", format_trimmed_number("1.", NumberFormatOptions::default()));
    }
    ...
    fn keep_one_trailing_decimal_zero() {
        assert_eq!("1", format_trimmed_number("1.0", NumberFormatOptions::default()));
    }
}
