...
a"#,
    ...
    fn it_converts_line_endings() {
        let options = PrinterOptions { line_ending: LineEnding::Crlf, ..PrinterOptions::default() };
    ...
    fn it_converts_line_endings_to_cr() {
        let options = PrinterOptions { line_ending: LineEnding::Cr, ..PrinterOptions::default() };
...
two lines`,
  ...
  ["0123456789", "0123456789", "0123456789", "0123456789", "0123456789"],
    ...
    fn it_prints_consecutive_empty_lines_as_one() {
        let result =
            format(&format_args![text("a"), empty_line(), empty_line(), empty_line(), text("b"),]);
