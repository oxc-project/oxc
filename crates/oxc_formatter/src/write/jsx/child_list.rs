...
use crate::{
    ...
    formatter::{
        FormatContext, Formatter, VecBuffer,
...
impl FormatJsxChildList {
    ...
    pub fn fmt_children<'a>(
        &self,
        children: &AstNode<'a, AllocVec<'a, JSXChild<'a>>>,
        f: &mut Formatter<'_, 'a>,
    ...
    fn children_meta(
        &self,
        children: &AstNode<'_, AllocVec<'_, JSXChild<'_>>>,
        comments: &crate::formatter::comments::Comments<'_>,
    ) -> ChildrenMeta {
