...
/// Node.js builtin modules list generated by `require('node:module').builtinModules`
static NODE_BUILTINS: phf::Set<&'static str> = phf_set! {
    ...
    "_tls_common", "_tls_wrap", "assert", "assert/strict", "async_hooks", "buffer", "child_process", "cluster",
    "console", "constants", "crypto", "dgram", "diagnostics_channel", "dns", "dns/promises", "domain",
    "events", "fs", "fs/promises", "http", "http2", "https", "inspector", "inspector/promises", "module",
