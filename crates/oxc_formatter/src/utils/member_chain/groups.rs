...
impl<'me, 'a, 'b> MemberChainGroupsBuilder<'a, 'b> {
    /// starts a new group
    pub fn start_group(&mut self, member: ChainMember<'me, 'a, 'b>) {
    ...
    pub fn start_or_continue_group(&mut self, member: ChainMember<'me, 'a, 'b>) {
...
impl<'me, 'a, 'b> TailChainGroups<'a, 'b> {
    ...
    pub(super) fn members(&self) -> impl Iterator<Item = &ChainMember<'me, 'a, 'b>> {
...
pub(super) struct MemberChainGroup<'a, 'b> {
    members: Vec<ChainMember<'me, 'a, 'b>>,
...
impl<'me, 'a, 'b> MemberChainGroup<'a, 'b> {
    pub(super) fn into_members(self) -> Vec<ChainMember<'me, 'a, 'b>> {
        self.members
    }

    /// Returns the chain members of the group.
    pub(super) fn members(&self) -> &[ChainMember<'me, 'a, 'b>] {
        &self.members
    }
...
impl<'me, 'a, 'b> From<Vec<ChainMember<'me, 'a, 'b>>> for MemberChainGroup<'a, 'b> {
    fn from(entries: Vec<ChainMember<'me, 'a, 'b>>) -> Self {
