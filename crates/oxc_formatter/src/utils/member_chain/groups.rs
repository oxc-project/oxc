...
use crate::formatter::{Format, prelude::*};
...
impl<'a, 'b> TailChainGroups<'a, 'b> {
    ...
    pub(super) fn any_except_last_will_break(&self, f: &JsFormatter<'_, '_>) -> bool {
...
impl<'a, 'b> MemberChainGroup<'a, 'b> {
    ...
    pub(super) fn will_break(&self, _f: &JsFormatter<'_, '_>) -> bool {
    ...
    fn needs_empty_line_before(&self, f: &JsFormatter<'_, '_>) -> bool {
