...
pub struct FormatOpeningElement<'me, 'a, 'b> {
    element: &'b AstNode<'me, 'a, JSXOpeningElement<'a>>,
...
impl<'me, 'a, 'b> FormatOpeningElement<'me, 'a, 'b> {
    pub fn new(element: &'b AstNode<'me, 'a, JSXOpeningElement<'a>>, is_self_closing: bool) -> Self {
