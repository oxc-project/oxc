...
impl<'me, 'a> FormatWrite<'a> for AstNode<'me, 'a, VariableDeclaration<'a>> {
...
impl<'me, 'a> Format<'a> for AstNode<'me, 'a, Vec<'a, VariableDeclarator<'a>>> {
...
impl<'me, 'a> FormatWrite<'a> for AstNode<'me, 'a, VariableDeclarator<'a>> {
    fn write(&self, f: &mut Formatter<'_, 'a>) {
