...
pub enum ObjectPatternLike<'me, 'a> {
    ObjectPattern(AstNode<'me, 'a, ObjectPattern<'a>>),
    ObjectAssignmentTarget(AstNode<'me, 'a, ObjectAssignmentTarget<'a>>),
}

impl<'me> GetSpan for ObjectPatternLike<'_, '_> {
    fn span(&self) -> Span {
        match self {
