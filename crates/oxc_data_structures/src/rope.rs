...
pub fn get_offset_from_line_and_column(rope: &Rope, line: u32, column: u32) -> u32 {
    ...
    for ch in line_text.chars() {
        // Count UTF-16 code units for the column comparison
        ...
        if utf16_count + ch_utf16_len > column {
            return (line_offset + byte_count) as u32; // Return byte offset
        }
        utf16_count += ch_utf16_len;
        byte_count += ch_utf8_len;
    }
