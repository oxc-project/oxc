...
pub trait Traverse<'a, State> {
    ...
    #[inline]
    fn enter_char_literal(&mut self, node: &mut CharLiteral<'a>, ctx: &mut TraverseCtx<'a, State>) {
    }
    #[inline]
    fn exit_char_literal(&mut self, node: &mut CharLiteral<'a>, ctx: &mut TraverseCtx<'a, State>) {}
