...
#![expect(clippy::semicolon_if_nothing_returned, clippy::ptr_as_ptr, clippy::ref_as_ptr)]
...
unsafe fn walk_program<'a, Tr: Traverse<'a>>(
    ...
    for item in &mut (*node).directives {
        walk_directive(traverser, item as *mut _, ctx);
    }
    ctx.retag_stack(AncestorType::ProgramBody);
    walk_statements(traverser, from_mut(&mut (*node).body), ctx);
...
unsafe fn walk_object_expression<'a, Tr: Traverse<'a>>(
    ...
    for item in &mut (*node).properties {
...
unsafe fn walk_object_property<'a, Tr: Traverse<'a>>(
    ...
    walk_property_key(traverser, from_mut(&mut (*node).key), ctx);
    ctx.retag_stack(AncestorType::ObjectPropertyValue);
    walk_expression(traverser, from_mut(&mut (*node).value), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_tagged_template_expression<'a, Tr: Traverse<'a>>(
    ...
    walk_expression(traverser, from_mut(&mut (*node).tag), ctx);
    ctx.retag_stack(AncestorType::TaggedTemplateExpressionQuasi);
    walk_template_literal(traverser, from_mut(&mut (*node).quasi), ctx);
...
unsafe fn walk_computed_member_expression<'a, Tr: Traverse<'a>>(
    ...
    walk_expression(traverser, from_mut(&mut (*node).object), ctx);
    ctx.retag_stack(AncestorType::ComputedMemberExpressionExpression);
    walk_expression(traverser, from_mut(&mut (*node).expression), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_static_member_expression<'a, Tr: Traverse<'a>>(
    ...
    walk_identifier_name(traverser, from_mut(&mut (*node).property), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_private_field_expression<'a, Tr: Traverse<'a>>(
    ...
    walk_private_identifier(traverser, from_mut(&mut (*node).field), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_call_expression<'a, Tr: Traverse<'a>>(
    ...
    walk_expression(traverser, from_mut(&mut (*node).callee), ctx);
    if let Some(field) = &mut (*node).type_parameters {
...
unsafe fn walk_meta_property<'a, Tr: Traverse<'a>>(
    ...
    walk_identifier_name(traverser, from_mut(&mut (*node).meta), ctx);
...
unsafe fn walk_spread_element<'a, Tr: Traverse<'a>>(
    ...
    walk_expression(traverser, from_mut(&mut (*node).argument), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_update_expression<'a, Tr: Traverse<'a>>(
    ...
    walk_simple_assignment_target(traverser, from_mut(&mut (*node).argument), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_binary_expression<'a, Tr: Traverse<'a>>(
    ...
    walk_expression(traverser, from_mut(&mut (*node).left), ctx);
    ctx.retag_stack(AncestorType::BinaryExpressionRight);
    walk_expression(traverser, from_mut(&mut (*node).right), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_private_in_expression<'a, Tr: Traverse<'a>>(
    ...
    walk_private_identifier(traverser, from_mut(&mut (*node).left), ctx);
...
unsafe fn walk_conditional_expression<'a, Tr: Traverse<'a>>(
    ...
    walk_expression(traverser, from_mut(&mut (*node).test), ctx);
    ctx.retag_stack(AncestorType::ConditionalExpressionConsequent);
    walk_expression(traverser, from_mut(&mut (*node).consequent), ctx);
    ctx.retag_stack(AncestorType::ConditionalExpressionAlternate);
    walk_expression(traverser, from_mut(&mut (*node).alternate), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_assignment_expression<'a, Tr: Traverse<'a>>(
    ...
    walk_assignment_target(traverser, from_mut(&mut (*node).left), ctx);
...
unsafe fn walk_assignment_target_rest<'a, Tr: Traverse<'a>>(
    ...
    walk_assignment_target(traverser, from_mut(&mut (*node).target), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_assignment_target_with_default<'a, Tr: Traverse<'a>>(
    ...
    walk_assignment_target(traverser, from_mut(&mut (*node).binding), ctx);
    ctx.retag_stack(AncestorType::AssignmentTargetWithDefaultInit);
    walk_expression(traverser, from_mut(&mut (*node).init), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_assignment_target_property_identifier<'a, Tr: Traverse<'a>>(
    ...
    walk_identifier_reference(traverser, from_mut(&mut (*node).binding), ctx);
...
unsafe fn walk_assignment_target_property_property<'a, Tr: Traverse<'a>>(
    ...
    walk_property_key(traverser, from_mut(&mut (*node).name), ctx);
    ctx.retag_stack(AncestorType::AssignmentTargetPropertyPropertyBinding);
    walk_assignment_target_maybe_default(traverser, from_mut(&mut (*node).binding), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_chain_expression<'a, Tr: Traverse<'a>>(
    ...
    walk_chain_element(traverser, from_mut(&mut (*node).expression), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_directive<'a, Tr: Traverse<'a>>(
    ...
    walk_string_literal(traverser, from_mut(&mut (*node).expression), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_variable_declaration<'a, Tr: Traverse<'a>>(
    ...
    for item in &mut (*node).declarations {
...
unsafe fn walk_variable_declarator<'a, Tr: Traverse<'a>>(
    ...
    walk_binding_pattern(traverser, from_mut(&mut (*node).id), ctx);
    if let Some(field) = &mut (*node).init {
...
unsafe fn walk_if_statement<'a, Tr: Traverse<'a>>(
    ...
    walk_statement(traverser, from_mut(&mut (*node).consequent), ctx);
...
unsafe fn walk_do_while_statement<'a, Tr: Traverse<'a>>(
    ...
    walk_statement(traverser, from_mut(&mut (*node).body), ctx);
...
unsafe fn walk_for_in_statement<'a, Tr: Traverse<'a>>(
    ...
    walk_for_statement_left(traverser, from_mut(&mut (*node).left), ctx);
...
unsafe fn walk_switch_statement<'a, Tr: Traverse<'a>>(
    ...
    walk_expression(traverser, from_mut(&mut (*node).discriminant), ctx);
    let previous_scope_id = ctx.current_scope_id();
    let current_scope_id = (*node).scope_id.get().unwrap();
    ctx.set_current_scope_id(current_scope_id);
...
unsafe fn walk_switch_case<'a, Tr: Traverse<'a>>(
    ...
    walk_statements(traverser, from_mut(&mut (*node).consequent), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_labeled_statement<'a, Tr: Traverse<'a>>(
    ...
    walk_label_identifier(traverser, from_mut(&mut (*node).label), ctx);
...
unsafe fn walk_try_statement<'a, Tr: Traverse<'a>>(
    ...
    walk_block_statement(traverser, from_mut(&mut *((*node).block)), ctx);
...
unsafe fn walk_catch_clause<'a, Tr: Traverse<'a>>(
    ...
    walk_block_statement(traverser, from_mut(&mut *((*node).body)), ctx);
    ctx.pop_stack(pop_token);
    ctx.set_current_scope_id(previous_scope_id);
...
unsafe fn walk_catch_parameter<'a, Tr: Traverse<'a>>(
    ...
    walk_binding_pattern(traverser, from_mut(&mut (*node).pattern), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_binding_pattern<'a, Tr: Traverse<'a>>(
    ...
    walk_binding_pattern_kind(traverser, from_mut(&mut (*node).kind), ctx);
...
unsafe fn walk_assignment_pattern<'a, Tr: Traverse<'a>>(
    ...
    walk_binding_pattern(traverser, from_mut(&mut (*node).left), ctx);
...
unsafe fn walk_binding_property<'a, Tr: Traverse<'a>>(
    ...
    walk_binding_pattern(traverser, from_mut(&mut (*node).value), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_binding_rest_element<'a, Tr: Traverse<'a>>(
    ...
    walk_binding_pattern(traverser, from_mut(&mut (*node).argument), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_function<'a, Tr: Traverse<'a>>(
    ...
    walk_formal_parameters(traverser, from_mut(&mut *((*node).params)), ctx);
...
unsafe fn walk_formal_parameter<'a, Tr: Traverse<'a>>(
    ...
    for item in &mut (*node).decorators {
...
unsafe fn walk_function_body<'a, Tr: Traverse<'a>>(
    ...
    walk_statements(traverser, from_mut(&mut (*node).statements), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_arrow_function_expression<'a, Tr: Traverse<'a>>(
    ...
    walk_function_body(traverser, from_mut(&mut *((*node).body)), ctx);
    ctx.pop_stack(pop_token);
    ctx.set_current_scope_id(previous_scope_id);
    ctx.set_current_hoist_scope_id(previous_hoist_scope_id);
    ctx.set_current_block_scope_id(previous_block_scope_id);
...
unsafe fn walk_class<'a, Tr: Traverse<'a>>(
    ...
    walk_class_body(traverser, from_mut(&mut *((*node).body)), ctx);
    ctx.pop_stack(pop_token);
    ctx.set_current_scope_id(previous_scope_id);
...
unsafe fn walk_method_definition<'a, Tr: Traverse<'a>>(
    ...
    walk_function(traverser, from_mut(&mut *((*node).value)), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_import_expression<'a, Tr: Traverse<'a>>(
    ...
    walk_expression(traverser, from_mut(&mut (*node).source), ctx);
...
unsafe fn walk_import_declaration<'a, Tr: Traverse<'a>>(
    ...
    walk_string_literal(traverser, from_mut(&mut (*node).source), ctx);
...
unsafe fn walk_import_specifier<'a, Tr: Traverse<'a>>(
    ...
    walk_module_export_name(traverser, from_mut(&mut (*node).imported), ctx);
    ctx.retag_stack(AncestorType::ImportSpecifierLocal);
    walk_binding_identifier(traverser, from_mut(&mut (*node).local), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_with_clause<'a, Tr: Traverse<'a>>(
    ...
    walk_identifier_name(traverser, from_mut(&mut (*node).attributes_keyword), ctx);
    ctx.retag_stack(AncestorType::WithClauseWithEntries);
    for item in &mut (*node).with_entries {
...
unsafe fn walk_import_attribute<'a, Tr: Traverse<'a>>(
    ...
    walk_import_attribute_key(traverser, from_mut(&mut (*node).key), ctx);
    ctx.retag_stack(AncestorType::ImportAttributeValue);
    walk_string_literal(traverser, from_mut(&mut (*node).value), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_export_named_declaration<'a, Tr: Traverse<'a>>(
    ...
    for item in &mut (*node).specifiers {
...
unsafe fn walk_export_default_declaration<'a, Tr: Traverse<'a>>(
    ...
    walk_export_default_declaration_kind(traverser, from_mut(&mut (*node).declaration), ctx);
    ctx.retag_stack(AncestorType::ExportDefaultDeclarationExported);
    walk_module_export_name(traverser, from_mut(&mut (*node).exported), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_export_specifier<'a, Tr: Traverse<'a>>(
    ...
    walk_module_export_name(traverser, from_mut(&mut (*node).local), ctx);
...
unsafe fn walk_jsx_element<'a, Tr: Traverse<'a>>(
    ...
    walk_jsx_opening_element(traverser, from_mut(&mut *((*node).opening_element)), ctx);
...
unsafe fn walk_jsx_opening_element<'a, Tr: Traverse<'a>>(
    ...
    walk_jsx_element_name(traverser, from_mut(&mut (*node).name), ctx);
...
unsafe fn walk_jsx_namespaced_name<'a, Tr: Traverse<'a>>(
    ...
    walk_jsx_identifier(traverser, from_mut(&mut (*node).namespace), ctx);
    ctx.retag_stack(AncestorType::JSXNamespacedNameProperty);
    walk_jsx_identifier(traverser, from_mut(&mut (*node).property), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_jsx_member_expression<'a, Tr: Traverse<'a>>(
    ...
    walk_jsx_member_expression_object(traverser, from_mut(&mut (*node).object), ctx);
...
unsafe fn walk_jsx_expression_container<'a, Tr: Traverse<'a>>(
    ...
    walk_jsx_expression(traverser, from_mut(&mut (*node).expression), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_jsx_attribute<'a, Tr: Traverse<'a>>(
    ...
    walk_jsx_attribute_name(traverser, from_mut(&mut (*node).name), ctx);
    if let Some(field) = &mut (*node).value {
...
unsafe fn walk_ts_enum_declaration<'a, Tr: Traverse<'a>>(
    ...
    walk_binding_identifier(traverser, from_mut(&mut (*node).id), ctx);
    let previous_scope_id = ctx.current_scope_id();
    let current_scope_id = (*node).scope_id.get().unwrap();
    ctx.set_current_scope_id(current_scope_id);
...
unsafe fn walk_ts_enum_member<'a, Tr: Traverse<'a>>(
    ...
    walk_ts_enum_member_name(traverser, from_mut(&mut (*node).id), ctx);
...
unsafe fn walk_ts_type_annotation<'a, Tr: Traverse<'a>>(
    ...
    walk_ts_type(traverser, from_mut(&mut (*node).type_annotation), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_ts_literal_type<'a, Tr: Traverse<'a>>(
    ...
    walk_ts_literal(traverser, from_mut(&mut (*node).literal), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_ts_conditional_type<'a, Tr: Traverse<'a>>(
    ...
    walk_ts_type(traverser, from_mut(&mut (*node).check_type), ctx);
    let previous_scope_id = ctx.current_scope_id();
    let current_scope_id = (*node).scope_id.get().unwrap();
    ctx.set_current_scope_id(current_scope_id);
    ctx.retag_stack(AncestorType::TSConditionalTypeExtendsType);
    walk_ts_type(traverser, from_mut(&mut (*node).extends_type), ctx);
    ctx.retag_stack(AncestorType::TSConditionalTypeTrueType);
    walk_ts_type(traverser, from_mut(&mut (*node).true_type), ctx);
    ctx.set_current_scope_id(previous_scope_id);
    ctx.retag_stack(AncestorType::TSConditionalTypeFalseType);
    walk_ts_type(traverser, from_mut(&mut (*node).false_type), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_ts_array_type<'a, Tr: Traverse<'a>>(
    ...
    walk_ts_type(traverser, from_mut(&mut (*node).element_type), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_ts_indexed_access_type<'a, Tr: Traverse<'a>>(
    ...
    walk_ts_type(traverser, from_mut(&mut (*node).object_type), ctx);
    ctx.retag_stack(AncestorType::TSIndexedAccessTypeIndexType);
    walk_ts_type(traverser, from_mut(&mut (*node).index_type), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_ts_tuple_type<'a, Tr: Traverse<'a>>(
    ...
    for item in &mut (*node).element_types {
...
unsafe fn walk_ts_named_tuple_member<'a, Tr: Traverse<'a>>(
    ...
    walk_ts_tuple_element(traverser, from_mut(&mut (*node).element_type), ctx);
    ctx.retag_stack(AncestorType::TSNamedTupleMemberLabel);
    walk_identifier_name(traverser, from_mut(&mut (*node).label), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_ts_type_reference<'a, Tr: Traverse<'a>>(
    ...
    walk_ts_type_name(traverser, from_mut(&mut (*node).type_name), ctx);
    if let Some(field) = &mut (*node).type_parameters {
...
unsafe fn walk_ts_qualified_name<'a, Tr: Traverse<'a>>(
    ...
    walk_ts_type_name(traverser, from_mut(&mut (*node).left), ctx);
    ctx.retag_stack(AncestorType::TSQualifiedNameRight);
    walk_identifier_name(traverser, from_mut(&mut (*node).right), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_ts_type_parameter<'a, Tr: Traverse<'a>>(
    ...
    walk_binding_identifier(traverser, from_mut(&mut (*node).name), ctx);
...
unsafe fn walk_ts_class_implements<'a, Tr: Traverse<'a>>(
    ...
    walk_ts_type_name(traverser, from_mut(&mut (*node).expression), ctx);
    if let Some(field) = &mut (*node).type_parameters {
...
unsafe fn walk_ts_interface_declaration<'a, Tr: Traverse<'a>>(
    ...
    walk_ts_interface_body(traverser, from_mut(&mut *((*node).body)), ctx);
    ctx.pop_stack(pop_token);
    ctx.set_current_scope_id(previous_scope_id);
...
unsafe fn walk_ts_type_predicate<'a, Tr: Traverse<'a>>(
    ...
    walk_ts_type_predicate_name(traverser, from_mut(&mut (*node).parameter_name), ctx);
    if let Some(field) = &mut (*node).type_annotation {
...
unsafe fn walk_ts_module_declaration<'a, Tr: Traverse<'a>>(
    ...
    walk_ts_module_declaration_name(traverser, from_mut(&mut (*node).id), ctx);
    let previous_scope_id = ctx.current_scope_id();
    let current_scope_id = (*node).scope_id.get().unwrap();
    ctx.set_current_scope_id(current_scope_id);
    let previous_hoist_scope_id = ctx.current_hoist_scope_id();
...
unsafe fn walk_ts_infer_type<'a, Tr: Traverse<'a>>(
    ...
    walk_ts_type_parameter(traverser, from_mut(&mut *((*node).type_parameter)), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_ts_type_query<'a, Tr: Traverse<'a>>(
    ...
    walk_ts_type_query_expr_name(traverser, from_mut(&mut (*node).expr_name), ctx);
    if let Some(field) = &mut (*node).type_parameters {
...
unsafe fn walk_ts_import_type<'a, Tr: Traverse<'a>>(
    ...
    walk_ts_type(traverser, from_mut(&mut (*node).parameter), ctx);
...
unsafe fn walk_ts_import_attribute<'a, Tr: Traverse<'a>>(
    ...
    walk_ts_import_attribute_name(traverser, from_mut(&mut (*node).name), ctx);
...
unsafe fn walk_ts_function_type<'a, Tr: Traverse<'a>>(
    ...
    walk_ts_type_annotation(traverser, from_mut(&mut *((*node).return_type)), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_ts_import_equals_declaration<'a, Tr: Traverse<'a>>(
    ...
    walk_ts_module_reference(traverser, from_mut(&mut (*node).module_reference), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_ts_namespace_export_declaration<'a, Tr: Traverse<'a>>(
    ...
    walk_identifier_name(traverser, from_mut(&mut (*node).id), ctx);
    ctx.pop_stack(pop_token);
...
unsafe fn walk_ts_instantiation_expression<'a, Tr: Traverse<'a>>(
    ...
    walk_ts_type_parameter_instantiation(traverser, from_mut(&mut *((*node).type_parameters)), ctx);
    ctx.pop_stack(pop_token);
