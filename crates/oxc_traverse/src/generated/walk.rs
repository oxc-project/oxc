...
unsafe fn walk_ts_module_declaration_attribute_clause<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_ts_module_declaration_attribute<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_ts_module_declaration_attribute_value<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
