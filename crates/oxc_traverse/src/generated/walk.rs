...
unsafe fn walk_char_literal<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_ets_package_declaration<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_ets_instance_of_expression<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_ets_new_class_instance_expression<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_ets_new_array_instance_expression<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_ets_new_multi_dim_array_instance_expression<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_ets_trailing_block_expression<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_ets_overload_declaration<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
