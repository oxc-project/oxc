...
pub(crate) enum AncestorType {
    None = 0,
    ProgramDirectives = ancestor_discriminant(1, 0),
    ProgramHashbang = ancestor_discriminant(1, 1),
    ProgramBody = ancestor_discriminant(1, 2),
    ArrayExpressionElements = ancestor_discriminant(2, 0),
    ObjectExpressionProperties = ancestor_discriminant(3, 0),
    ObjectPropertyKey = ancestor_discriminant(4, 0),
    ObjectPropertyValue = ancestor_discriminant(4, 1),
    ObjectPropertyInit = ancestor_discriminant(4, 2),
    TemplateLiteralQuasis = ancestor_discriminant(5, 0),
    TemplateLiteralExpressions = ancestor_discriminant(5, 1),
    TaggedTemplateExpressionTag = ancestor_discriminant(6, 0),
    TaggedTemplateExpressionQuasi = ancestor_discriminant(6, 1),
    TaggedTemplateExpressionTypeParameters = ancestor_discriminant(6, 2),
    ComputedMemberExpressionObject = ancestor_discriminant(7, 0),
    ComputedMemberExpressionExpression = ancestor_discriminant(7, 1),
    StaticMemberExpressionObject = ancestor_discriminant(8, 0),
    StaticMemberExpressionProperty = ancestor_discriminant(8, 1),
    PrivateFieldExpressionObject = ancestor_discriminant(9, 0),
    PrivateFieldExpressionField = ancestor_discriminant(9, 1),
    CallExpressionCallee = ancestor_discriminant(10, 0),
    CallExpressionArguments = ancestor_discriminant(10, 1),
    CallExpressionTypeParameters = ancestor_discriminant(10, 2),
    NewExpressionCallee = ancestor_discriminant(11, 0),
    NewExpressionArguments = ancestor_discriminant(11, 1),
    NewExpressionTypeParameters = ancestor_discriminant(11, 2),
    MetaPropertyMeta = ancestor_discriminant(12, 0),
    MetaPropertyProperty = ancestor_discriminant(12, 1),
    SpreadElementArgument = ancestor_discriminant(13, 0),
    UpdateExpressionArgument = ancestor_discriminant(14, 0),
    UnaryExpressionArgument = ancestor_discriminant(15, 0),
    BinaryExpressionLeft = ancestor_discriminant(16, 0),
    BinaryExpressionRight = ancestor_discriminant(16, 1),
    PrivateInExpressionLeft = ancestor_discriminant(17, 0),
    PrivateInExpressionRight = ancestor_discriminant(17, 1),
    LogicalExpressionLeft = ancestor_discriminant(18, 0),
    LogicalExpressionRight = ancestor_discriminant(18, 1),
    ConditionalExpressionTest = ancestor_discriminant(19, 0),
    ConditionalExpressionConsequent = ancestor_discriminant(19, 1),
    ConditionalExpressionAlternate = ancestor_discriminant(19, 2),
    AssignmentExpressionLeft = ancestor_discriminant(20, 0),
    AssignmentExpressionRight = ancestor_discriminant(20, 1),
    ArrayAssignmentTargetElements = ancestor_discriminant(21, 0),
    ArrayAssignmentTargetRest = ancestor_discriminant(21, 1),
    ObjectAssignmentTargetProperties = ancestor_discriminant(22, 0),
    ObjectAssignmentTargetRest = ancestor_discriminant(22, 1),
    AssignmentTargetRestTarget = ancestor_discriminant(23, 0),
    AssignmentTargetWithDefaultBinding = ancestor_discriminant(24, 0),
    AssignmentTargetWithDefaultInit = ancestor_discriminant(24, 1),
    AssignmentTargetPropertyIdentifierBinding = ancestor_discriminant(25, 0),
    AssignmentTargetPropertyIdentifierInit = ancestor_discriminant(25, 1),
    AssignmentTargetPropertyPropertyName = ancestor_discriminant(26, 0),
    AssignmentTargetPropertyPropertyBinding = ancestor_discriminant(26, 1),
    SequenceExpressionExpressions = ancestor_discriminant(27, 0),
    AwaitExpressionArgument = ancestor_discriminant(28, 0),
    ChainExpressionExpression = ancestor_discriminant(29, 0),
    ParenthesizedExpressionExpression = ancestor_discriminant(30, 0),
    DirectiveExpression = ancestor_discriminant(31, 0),
    BlockStatementBody = ancestor_discriminant(32, 0),
    VariableDeclarationDeclarations = ancestor_discriminant(33, 0),
    VariableDeclaratorId = ancestor_discriminant(34, 0),
    VariableDeclaratorInit = ancestor_discriminant(34, 1),
    UsingDeclarationDeclarations = ancestor_discriminant(35, 0),
    ExpressionStatementExpression = ancestor_discriminant(36, 0),
    IfStatementTest = ancestor_discriminant(37, 0),
    IfStatementConsequent = ancestor_discriminant(37, 1),
    IfStatementAlternate = ancestor_discriminant(37, 2),
    DoWhileStatementBody = ancestor_discriminant(38, 0),
    DoWhileStatementTest = ancestor_discriminant(38, 1),
    WhileStatementTest = ancestor_discriminant(39, 0),
    WhileStatementBody = ancestor_discriminant(39, 1),
    ForStatementInit = ancestor_discriminant(40, 0),
    ForStatementTest = ancestor_discriminant(40, 1),
    ForStatementUpdate = ancestor_discriminant(40, 2),
    ForStatementBody = ancestor_discriminant(40, 3),
    ForInStatementLeft = ancestor_discriminant(41, 0),
    ForInStatementRight = ancestor_discriminant(41, 1),
    ForInStatementBody = ancestor_discriminant(41, 2),
    ForOfStatementLeft = ancestor_discriminant(42, 0),
    ForOfStatementRight = ancestor_discriminant(42, 1),
    ForOfStatementBody = ancestor_discriminant(42, 2),
    ContinueStatementLabel = ancestor_discriminant(43, 0),
    BreakStatementLabel = ancestor_discriminant(44, 0),
    ReturnStatementArgument = ancestor_discriminant(45, 0),
    WithStatementObject = ancestor_discriminant(46, 0),
    WithStatementBody = ancestor_discriminant(46, 1),
    SwitchStatementDiscriminant = ancestor_discriminant(47, 0),
    SwitchStatementCases = ancestor_discriminant(47, 1),
    SwitchCaseTest = ancestor_discriminant(48, 0),
    SwitchCaseConsequent = ancestor_discriminant(48, 1),
    LabeledStatementLabel = ancestor_discriminant(49, 0),
    LabeledStatementBody = ancestor_discriminant(49, 1),
    ThrowStatementArgument = ancestor_discriminant(50, 0),
    TryStatementBlock = ancestor_discriminant(51, 0),
    TryStatementHandler = ancestor_discriminant(51, 1),
    TryStatementFinalizer = ancestor_discriminant(51, 2),
    CatchClauseParam = ancestor_discriminant(52, 0),
    CatchClauseBody = ancestor_discriminant(52, 1),
    CatchParameterPattern = ancestor_discriminant(53, 0),
    BindingPatternKind = ancestor_discriminant(54, 0),
    BindingPatternTypeAnnotation = ancestor_discriminant(54, 1),
    AssignmentPatternLeft = ancestor_discriminant(55, 0),
    AssignmentPatternRight = ancestor_discriminant(55, 1),
    ObjectPatternProperties = ancestor_discriminant(56, 0),
    ObjectPatternRest = ancestor_discriminant(56, 1),
    BindingPropertyKey = ancestor_discriminant(57, 0),
    BindingPropertyValue = ancestor_discriminant(57, 1),
    ArrayPatternElements = ancestor_discriminant(58, 0),
    ArrayPatternRest = ancestor_discriminant(58, 1),
    BindingRestElementArgument = ancestor_discriminant(59, 0),
    FunctionId = ancestor_discriminant(60, 0),
    FunctionThisParam = ancestor_discriminant(60, 1),
    FunctionParams = ancestor_discriminant(60, 2),
    FunctionBody = ancestor_discriminant(60, 3),
    FunctionTypeParameters = ancestor_discriminant(60, 4),
    FunctionReturnType = ancestor_discriminant(60, 5),
    FormalParametersItems = ancestor_discriminant(61, 0),
    FormalParametersRest = ancestor_discriminant(61, 1),
    FormalParameterPattern = ancestor_discriminant(62, 0),
    FormalParameterDecorators = ancestor_discriminant(62, 1),
    FunctionBodyDirectives = ancestor_discriminant(63, 0),
    FunctionBodyStatements = ancestor_discriminant(63, 1),
    ArrowFunctionExpressionParams = ancestor_discriminant(64, 0),
    ArrowFunctionExpressionBody = ancestor_discriminant(64, 1),
    ArrowFunctionExpressionTypeParameters = ancestor_discriminant(64, 2),
    ArrowFunctionExpressionReturnType = ancestor_discriminant(64, 3),
    YieldExpressionArgument = ancestor_discriminant(65, 0),
    ClassId = ancestor_discriminant(66, 0),
    ClassSuperClass = ancestor_discriminant(66, 1),
    ClassBody = ancestor_discriminant(66, 2),
    ClassTypeParameters = ancestor_discriminant(66, 3),
    ClassSuperTypeParameters = ancestor_discriminant(66, 4),
    ClassImplements = ancestor_discriminant(66, 5),
    ClassDecorators = ancestor_discriminant(66, 6),
    ClassBodyBody = ancestor_discriminant(67, 0),
    MethodDefinitionKey = ancestor_discriminant(68, 0),
    MethodDefinitionValue = ancestor_discriminant(68, 1),
    MethodDefinitionDecorators = ancestor_discriminant(68, 2),
    PropertyDefinitionKey = ancestor_discriminant(69, 0),
    PropertyDefinitionValue = ancestor_discriminant(69, 1),
    PropertyDefinitionTypeAnnotation = ancestor_discriminant(69, 2),
    PropertyDefinitionDecorators = ancestor_discriminant(69, 3),
    StaticBlockBody = ancestor_discriminant(70, 0),
    AccessorPropertyKey = ancestor_discriminant(71, 0),
    AccessorPropertyValue = ancestor_discriminant(71, 1),
    AccessorPropertyDecorators = ancestor_discriminant(71, 2),
    ImportExpressionSource = ancestor_discriminant(72, 0),
    ImportExpressionArguments = ancestor_discriminant(72, 1),
    ImportDeclarationSpecifiers = ancestor_discriminant(73, 0),
    ImportDeclarationSource = ancestor_discriminant(73, 1),
    ImportDeclarationWithClause = ancestor_discriminant(73, 2),
    ImportSpecifierImported = ancestor_discriminant(74, 0),
    ImportSpecifierLocal = ancestor_discriminant(74, 1),
    ImportDefaultSpecifierLocal = ancestor_discriminant(75, 0),
    ImportNamespaceSpecifierLocal = ancestor_discriminant(76, 0),
    WithClauseAttributesKeyword = ancestor_discriminant(77, 0),
    WithClauseWithEntries = ancestor_discriminant(77, 1),
    ImportAttributeKey = ancestor_discriminant(78, 0),
    ImportAttributeValue = ancestor_discriminant(78, 1),
    ExportNamedDeclarationDeclaration = ancestor_discriminant(79, 0),
    ExportNamedDeclarationSpecifiers = ancestor_discriminant(79, 1),
    ExportNamedDeclarationSource = ancestor_discriminant(79, 2),
    ExportNamedDeclarationWithClause = ancestor_discriminant(79, 3),
    ExportDefaultDeclarationDeclaration = ancestor_discriminant(80, 0),
    ExportDefaultDeclarationExported = ancestor_discriminant(80, 1),
    ExportAllDeclarationExported = ancestor_discriminant(81, 0),
    ExportAllDeclarationSource = ancestor_discriminant(81, 1),
    ExportAllDeclarationWithClause = ancestor_discriminant(81, 2),
    ExportSpecifierLocal = ancestor_discriminant(82, 0),
    ExportSpecifierExported = ancestor_discriminant(82, 1),
    JSXElementOpeningElement = ancestor_discriminant(83, 0),
    JSXElementClosingElement = ancestor_discriminant(83, 1),
    JSXElementChildren = ancestor_discriminant(83, 2),
    JSXOpeningElementName = ancestor_discriminant(84, 0),
    JSXOpeningElementAttributes = ancestor_discriminant(84, 1),
    JSXOpeningElementTypeParameters = ancestor_discriminant(84, 2),
    JSXClosingElementName = ancestor_discriminant(85, 0),
    JSXFragmentChildren = ancestor_discriminant(86, 0),
    JSXNamespacedNameNamespace = ancestor_discriminant(87, 0),
    JSXNamespacedNameProperty = ancestor_discriminant(87, 1),
    JSXMemberExpressionObject = ancestor_discriminant(88, 0),
    JSXMemberExpressionProperty = ancestor_discriminant(88, 1),
    JSXExpressionContainerExpression = ancestor_discriminant(89, 0),
    JSXAttributeName = ancestor_discriminant(90, 0),
    JSXAttributeValue = ancestor_discriminant(90, 1),
    JSXSpreadAttributeArgument = ancestor_discriminant(91, 0),
    JSXSpreadChildExpression = ancestor_discriminant(92, 0),
    TSThisParameterThis = ancestor_discriminant(93, 0),
    TSThisParameterTypeAnnotation = ancestor_discriminant(93, 1),
    TSEnumDeclarationId = ancestor_discriminant(94, 0),
    TSEnumDeclarationMembers = ancestor_discriminant(94, 1),
    TSEnumMemberId = ancestor_discriminant(95, 0),
    TSEnumMemberInitializer = ancestor_discriminant(95, 1),
    TSTypeAnnotationTypeAnnotation = ancestor_discriminant(96, 0),
    TSLiteralTypeLiteral = ancestor_discriminant(97, 0),
    TSConditionalTypeCheckType = ancestor_discriminant(98, 0),
    TSConditionalTypeExtendsType = ancestor_discriminant(98, 1),
    TSConditionalTypeTrueType = ancestor_discriminant(98, 2),
    TSConditionalTypeFalseType = ancestor_discriminant(98, 3),
    TSUnionTypeTypes = ancestor_discriminant(99, 0),
    TSIntersectionTypeTypes = ancestor_discriminant(100, 0),
    TSTypeOperatorTypeAnnotation = ancestor_discriminant(101, 0),
    TSArrayTypeElementType = ancestor_discriminant(102, 0),
    TSIndexedAccessTypeObjectType = ancestor_discriminant(103, 0),
    TSIndexedAccessTypeIndexType = ancestor_discriminant(103, 1),
    TSTupleTypeElementTypes = ancestor_discriminant(104, 0),
    TSNamedTupleMemberElementType = ancestor_discriminant(105, 0),
    TSNamedTupleMemberLabel = ancestor_discriminant(105, 1),
    TSOptionalTypeTypeAnnotation = ancestor_discriminant(106, 0),
    TSRestTypeTypeAnnotation = ancestor_discriminant(107, 0),
    TSTypeReferenceTypeName = ancestor_discriminant(108, 0),
    TSTypeReferenceTypeParameters = ancestor_discriminant(108, 1),
    TSQualifiedNameLeft = ancestor_discriminant(109, 0),
    TSQualifiedNameRight = ancestor_discriminant(109, 1),
    TSTypeParameterInstantiationParams = ancestor_discriminant(110, 0),
    TSTypeParameterName = ancestor_discriminant(111, 0),
    TSTypeParameterConstraint = ancestor_discriminant(111, 1),
    TSTypeParameterDefault = ancestor_discriminant(111, 2),
    TSTypeParameterDeclarationParams = ancestor_discriminant(112, 0),
    TSTypeAliasDeclarationId = ancestor_discriminant(113, 0),
    TSTypeAliasDeclarationTypeAnnotation = ancestor_discriminant(113, 1),
    TSTypeAliasDeclarationTypeParameters = ancestor_discriminant(113, 2),
    TSClassImplementsExpression = ancestor_discriminant(114, 0),
    TSClassImplementsTypeParameters = ancestor_discriminant(114, 1),
    TSInterfaceDeclarationId = ancestor_discriminant(115, 0),
    TSInterfaceDeclarationBody = ancestor_discriminant(115, 1),
    TSInterfaceDeclarationTypeParameters = ancestor_discriminant(115, 2),
    TSInterfaceDeclarationExtends = ancestor_discriminant(115, 3),
    TSInterfaceBodyBody = ancestor_discriminant(116, 0),
    TSPropertySignatureKey = ancestor_discriminant(117, 0),
    TSPropertySignatureTypeAnnotation = ancestor_discriminant(117, 1),
    TSIndexSignatureParameters = ancestor_discriminant(118, 0),
    TSIndexSignatureTypeAnnotation = ancestor_discriminant(118, 1),
    TSCallSignatureDeclarationThisParam = ancestor_discriminant(119, 0),
    TSCallSignatureDeclarationParams = ancestor_discriminant(119, 1),
    TSCallSignatureDeclarationReturnType = ancestor_discriminant(119, 2),
    TSCallSignatureDeclarationTypeParameters = ancestor_discriminant(119, 3),
    TSMethodSignatureKey = ancestor_discriminant(120, 0),
    TSMethodSignatureThisParam = ancestor_discriminant(120, 1),
    TSMethodSignatureParams = ancestor_discriminant(120, 2),
    TSMethodSignatureReturnType = ancestor_discriminant(120, 3),
    TSMethodSignatureTypeParameters = ancestor_discriminant(120, 4),
    TSConstructSignatureDeclarationParams = ancestor_discriminant(121, 0),
    TSConstructSignatureDeclarationReturnType = ancestor_discriminant(121, 1),
    TSConstructSignatureDeclarationTypeParameters = ancestor_discriminant(121, 2),
    TSIndexSignatureNameTypeAnnotation = ancestor_discriminant(122, 0),
    TSInterfaceHeritageExpression = ancestor_discriminant(123, 0),
    TSInterfaceHeritageTypeParameters = ancestor_discriminant(123, 1),
    TSTypePredicateParameterName = ancestor_discriminant(124, 0),
    TSTypePredicateTypeAnnotation = ancestor_discriminant(124, 1),
    TSModuleDeclarationId = ancestor_discriminant(125, 0),
    TSModuleDeclarationBody = ancestor_discriminant(125, 1),
    TSModuleBlockBody = ancestor_discriminant(126, 0),
    TSTypeLiteralMembers = ancestor_discriminant(127, 0),
    TSInferTypeTypeParameter = ancestor_discriminant(128, 0),
    TSTypeQueryExprName = ancestor_discriminant(129, 0),
    TSTypeQueryTypeParameters = ancestor_discriminant(129, 1),
    TSImportTypeArgument = ancestor_discriminant(130, 0),
    TSImportTypeQualifier = ancestor_discriminant(130, 1),
    TSImportTypeAttributes = ancestor_discriminant(130, 2),
    TSImportTypeTypeParameters = ancestor_discriminant(130, 3),
    TSImportAttributesElements = ancestor_discriminant(131, 0),
    TSImportAttributeName = ancestor_discriminant(132, 0),
    TSImportAttributeValue = ancestor_discriminant(132, 1),
    TSFunctionTypeThisParam = ancestor_discriminant(133, 0),
    TSFunctionTypeParams = ancestor_discriminant(133, 1),
    TSFunctionTypeReturnType = ancestor_discriminant(133, 2),
    TSFunctionTypeTypeParameters = ancestor_discriminant(133, 3),
    TSConstructorTypeParams = ancestor_discriminant(134, 0),
    TSConstructorTypeReturnType = ancestor_discriminant(134, 1),
    TSConstructorTypeTypeParameters = ancestor_discriminant(134, 2),
    TSMappedTypeTypeParameter = ancestor_discriminant(135, 0),
    TSMappedTypeNameType = ancestor_discriminant(135, 1),
    TSMappedTypeTypeAnnotation = ancestor_discriminant(135, 2),
    TSTemplateLiteralTypeQuasis = ancestor_discriminant(136, 0),
    TSTemplateLiteralTypeTypes = ancestor_discriminant(136, 1),
    TSAsExpressionExpression = ancestor_discriminant(137, 0),
    TSAsExpressionTypeAnnotation = ancestor_discriminant(137, 1),
    TSSatisfiesExpressionExpression = ancestor_discriminant(138, 0),
    TSSatisfiesExpressionTypeAnnotation = ancestor_discriminant(138, 1),
    TSTypeAssertionExpression = ancestor_discriminant(139, 0),
    TSTypeAssertionTypeAnnotation = ancestor_discriminant(139, 1),
    TSImportEqualsDeclarationId = ancestor_discriminant(140, 0),
    TSImportEqualsDeclarationModuleReference = ancestor_discriminant(140, 1),
    TSExternalModuleReferenceExpression = ancestor_discriminant(141, 0),
    TSNonNullExpressionExpression = ancestor_discriminant(142, 0),
    DecoratorExpression = ancestor_discriminant(143, 0),
    TSExportAssignmentExpression = ancestor_discriminant(144, 0),
    TSNamespaceExportDeclarationId = ancestor_discriminant(145, 0),
    TSInstantiationExpressionExpression = ancestor_discriminant(146, 0),
    TSInstantiationExpressionTypeParameters = ancestor_discriminant(146, 1),
    JSDocNullableTypeTypeAnnotation = ancestor_discriminant(147, 0),
}
