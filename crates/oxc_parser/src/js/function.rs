...
impl<'a> ParserImpl<'a> {
    ...
    ) -> (oxc_allocator::Vec<'a, FormalParameter<'a>>, Option<Box<'a, FormalParameterRest<'a>>>)
    {
        ...
        loop {
            ...
            // Parse decorators before checking for rest parameter or regular parameter
            // Start span before decorators so they are included
            let span = self.start_span();
            ...
            if self.at(Kind::Dot3) {
                ...
                // Validate decorators on rest parameters
                ...
                list.push(self.parse_formal_parameter_with_decorators(span, func_kind, decorators));
            }
        }
