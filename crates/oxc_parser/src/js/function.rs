...
impl<'a> ParserImpl<'a> {
    ...
    fn parse_formal_parameter(&mut self, func_kind: FunctionKind) -> FormalParameter<'a> {
        ...
        // Check for parameter property with binding pattern (TS1187)
        // A parameter property (has accessibility, readonly, or override modifier) cannot use a binding pattern
