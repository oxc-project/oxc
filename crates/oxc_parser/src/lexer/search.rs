...
/// Increased to 128 to process more data per iteration while staying within
/// typical L1 cache line size. Larger batches reduce loop overhead.
pub const SEARCH_BATCH_SIZE: usize = 128;
