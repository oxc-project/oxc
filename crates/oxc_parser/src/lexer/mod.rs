...
pub struct Lexer<'a, C: Config> {
    ...
    /// Decoded string literals, indexed by [Token::start] when [Token::escaped] is true.
    pub escaped_js_strings: FxHashMap<u32, JSStr<'a>>,
...
impl<'a, C: Config> Lexer<'a, C> {
    ...
    pub(super) fn new(
        ...
        Self {
            ...
            escaped_js_strings: FxHashMap::default(),
