...
pub struct ParserReturn<'a> {
    ...
    ///
    /// These counts can be passed to [`SemanticBuilder::with_parser_stats`] to avoid a
    /// redundant AST traversal for stats collection.
    ///
    /// [`SemanticBuilder::with_parser_stats`]: https://docs.rs/oxc_semantic/latest/oxc_semantic/struct.SemanticBuilder.html#method.with_parser_stats
    pub stats: &'a AstBuilderStats,
}
