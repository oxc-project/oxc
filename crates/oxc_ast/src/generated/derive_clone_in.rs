...
impl<'new_alloc> CloneIn<'new_alloc> for LeadingDotExpression<'_> {
    type Cloned = LeadingDotExpression<'new_alloc>;
...
impl<'new_alloc> CloneIn<'new_alloc> for Declaration<'_> {
    ...
    fn clone_in_impl(
        ...
        match self {
            ...
            Self::StructStatement(it) => Declaration::StructStatement(CloneIn::clone_in_impl(
                it,
                with_semantic_ids,
                allocator,
            )),
...
impl<'new_alloc> CloneIn<'new_alloc> for StructElement<'_> {
    ...
    fn clone_in_impl(
        ...
        match self {
            ...
            Self::MethodDefinition(it) => StructElement::MethodDefinition(CloneIn::clone_in_impl(
                it,
                with_semantic_ids,
                allocator,
            )),
            Self::StaticBlock(it) => {
                StructElement::StaticBlock(CloneIn::clone_in_impl(it, with_semantic_ids, allocator))
            }
            Self::TSIndexSignature(it) => StructElement::TSIndexSignature(CloneIn::clone_in_impl(
                it,
                with_semantic_ids,
                allocator,
            )),
            Self::AccessorProperty(it) => StructElement::AccessorProperty(CloneIn::clone_in_impl(
                it,
                with_semantic_ids,
                allocator,
            )),
...
impl<'new_alloc> CloneIn<'new_alloc> for ArkUIComponentExpression<'_> {
    ...
    fn clone_in_impl(
        ...
        ArkUIComponentExpression {
            ...
            arguments: CloneIn::clone_in_impl(&self.arguments, with_semantic_ids, allocator),
            children: CloneIn::clone_in_impl(&self.children, with_semantic_ids, allocator),
            has_children: CloneIn::clone_in_impl(&self.has_children, with_semantic_ids, allocator),
            chain_expressions: CloneIn::clone_in_impl(
...
impl<'new_alloc> CloneIn<'new_alloc> for ArkUIChild<'_> {
    ...
    fn clone_in_impl(
        ...
        match self {
            Self::Component(it) => {
                ArkUIChild::Component(CloneIn::clone_in_impl(it, with_semantic_ids, allocator))
            }
            Self::Expression(it) => {
                ArkUIChild::Expression(CloneIn::clone_in_impl(it, with_semantic_ids, allocator))
            }
            Self::Statement(it) => {
                ArkUIChild::Statement(CloneIn::clone_in_impl(it, with_semantic_ids, allocator))
            }
        }
    }
}

impl<'new_alloc> CloneIn<'new_alloc> for AnnotationDeclaration<'_> {
    type Cloned = AnnotationDeclaration<'new_alloc>;
...
impl<'new_alloc> CloneIn<'new_alloc> for AnnotationBody<'_> {
    type Cloned = AnnotationBody<'new_alloc>;
...
impl<'new_alloc> CloneIn<'new_alloc> for AnnotationElement<'_> {
    type Cloned = AnnotationElement<'new_alloc>;
