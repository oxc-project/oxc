...
impl ESTree for Expression<'_> {
    fn serialize<S: Serializer>(&self, serializer: S) {
        match self.kind() {
            ExpressionKind::BooleanLiteral(it) => it.serialize(serializer),
            ExpressionKind::NullLiteral(it) => it.serialize(serializer),
            ExpressionKind::NumericLiteral(it) => it.serialize(serializer),
            ExpressionKind::BigIntLiteral(it) => it.serialize(serializer),
            ExpressionKind::RegExpLiteral(it) => it.serialize(serializer),
            ExpressionKind::StringLiteral(it) => it.serialize(serializer),
            ExpressionKind::TemplateLiteral(it) => it.serialize(serializer),
            ExpressionKind::Identifier(it) => it.serialize(serializer),
            ExpressionKind::MetaProperty(it) => it.serialize(serializer),
            ExpressionKind::Super(it) => it.serialize(serializer),
            ExpressionKind::ArrayExpression(it) => it.serialize(serializer),
            ExpressionKind::ArrowFunctionExpression(it) => it.serialize(serializer),
            ExpressionKind::AssignmentExpression(it) => it.serialize(serializer),
            ExpressionKind::AwaitExpression(it) => it.serialize(serializer),
            ExpressionKind::BinaryExpression(it) => it.serialize(serializer),
            ExpressionKind::CallExpression(it) => it.serialize(serializer),
            ExpressionKind::ChainExpression(it) => it.serialize(serializer),
            ExpressionKind::ClassExpression(it) => it.serialize(serializer),
            ExpressionKind::ConditionalExpression(it) => it.serialize(serializer),
            ExpressionKind::FunctionExpression(it) => it.serialize(serializer),
            ExpressionKind::ImportExpression(it) => it.serialize(serializer),
            ExpressionKind::LogicalExpression(it) => it.serialize(serializer),
            ExpressionKind::NewExpression(it) => it.serialize(serializer),
            ExpressionKind::ObjectExpression(it) => it.serialize(serializer),
            ExpressionKind::ParenthesizedExpression(it) => it.serialize(serializer),
            ExpressionKind::SequenceExpression(it) => it.serialize(serializer),
            ExpressionKind::TaggedTemplateExpression(it) => it.serialize(serializer),
            ExpressionKind::ThisExpression(it) => it.serialize(serializer),
            ExpressionKind::UnaryExpression(it) => it.serialize(serializer),
            ExpressionKind::UpdateExpression(it) => it.serialize(serializer),
            ExpressionKind::YieldExpression(it) => it.serialize(serializer),
            ExpressionKind::PrivateInExpression(it) => it.serialize(serializer),
            ExpressionKind::JSXElement(it) => it.serialize(serializer),
            ExpressionKind::JSXFragment(it) => it.serialize(serializer),
            ExpressionKind::TSAsExpression(it) => it.serialize(serializer),
            ExpressionKind::TSSatisfiesExpression(it) => it.serialize(serializer),
            ExpressionKind::TSTypeAssertion(it) => it.serialize(serializer),
            ExpressionKind::TSNonNullExpression(it) => it.serialize(serializer),
            ExpressionKind::TSInstantiationExpression(it) => it.serialize(serializer),
            ExpressionKind::V8IntrinsicExpression(it) => it.serialize(serializer),
            ExpressionKind::ComputedMemberExpression(it) => it.serialize(serializer),
            ExpressionKind::StaticMemberExpression(it) => it.serialize(serializer),
            ExpressionKind::PrivateFieldExpression(it) => it.serialize(serializer),
        }
    }
}
...
impl ESTree for Statement<'_> {
    fn serialize<S: Serializer>(&self, serializer: S) {
        match self.kind() {
            StatementKind::BlockStatement(it) => it.serialize(serializer),
            StatementKind::BreakStatement(it) => it.serialize(serializer),
            StatementKind::ContinueStatement(it) => it.serialize(serializer),
            StatementKind::DebuggerStatement(it) => it.serialize(serializer),
            StatementKind::DoWhileStatement(it) => it.serialize(serializer),
            StatementKind::EmptyStatement(it) => it.serialize(serializer),
            StatementKind::ExpressionStatement(it) => it.serialize(serializer),
            StatementKind::ForInStatement(it) => it.serialize(serializer),
            StatementKind::ForOfStatement(it) => it.serialize(serializer),
            StatementKind::ForStatement(it) => it.serialize(serializer),
            StatementKind::IfStatement(it) => it.serialize(serializer),
            StatementKind::LabeledStatement(it) => it.serialize(serializer),
            StatementKind::ReturnStatement(it) => it.serialize(serializer),
            StatementKind::SwitchStatement(it) => it.serialize(serializer),
            StatementKind::ThrowStatement(it) => it.serialize(serializer),
            StatementKind::TryStatement(it) => it.serialize(serializer),
            StatementKind::WhileStatement(it) => it.serialize(serializer),
            StatementKind::WithStatement(it) => it.serialize(serializer),
            StatementKind::VariableDeclaration(it) => it.serialize(serializer),
            StatementKind::FunctionDeclaration(it) => it.serialize(serializer),
            StatementKind::ClassDeclaration(it) => it.serialize(serializer),
            StatementKind::TSTypeAliasDeclaration(it) => it.serialize(serializer),
            StatementKind::TSInterfaceDeclaration(it) => it.serialize(serializer),
            StatementKind::TSEnumDeclaration(it) => it.serialize(serializer),
            StatementKind::TSModuleDeclaration(it) => it.serialize(serializer),
            StatementKind::TSGlobalDeclaration(it) => it.serialize(serializer),
            StatementKind::TSImportEqualsDeclaration(it) => it.serialize(serializer),
            StatementKind::ImportDeclaration(it) => it.serialize(serializer),
            StatementKind::ExportAllDeclaration(it) => it.serialize(serializer),
            StatementKind::ExportDefaultDeclaration(it) => it.serialize(serializer),
            StatementKind::ExportNamedDeclaration(it) => it.serialize(serializer),
            StatementKind::TSExportAssignment(it) => it.serialize(serializer),
            StatementKind::TSNamespaceExportDeclaration(it) => it.serialize(serializer),
        }
    }
}
