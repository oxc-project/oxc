...
const _: () = {
    ...
    assert!(offset_of!(NewExpression, type_arguments) == 48);
    ...
    assert!(offset_of!(PropertyDefinition, computed) == 72);
    assert!(offset_of!(PropertyDefinition, r#static) == 73);
    assert!(offset_of!(PropertyDefinition, declare) == 74);
    assert!(offset_of!(PropertyDefinition, r#override) == 75);
    assert!(offset_of!(PropertyDefinition, optional) == 76);
    assert!(offset_of!(PropertyDefinition, definite) == 77);
    assert!(offset_of!(PropertyDefinition, readonly) == 78);
    assert!(offset_of!(PropertyDefinition, type_annotation) == 80);
    assert!(offset_of!(PropertyDefinition, accessibility) == 88);
    ...
    assert!(offset_of!(JSXOpeningElement, type_arguments) == 48);
...
const _: () = {
    ...
    assert!(offset_of!(TaggedTemplateExpression, type_arguments) == 72);
    ...
    assert!(size_of::<PropertyDefinition>() == 68);
    ...
    assert!(offset_of!(PropertyDefinition, computed) == 52);
    assert!(offset_of!(PropertyDefinition, r#static) == 53);
    assert!(offset_of!(PropertyDefinition, declare) == 54);
    assert!(offset_of!(PropertyDefinition, r#override) == 55);
    assert!(offset_of!(PropertyDefinition, optional) == 56);
    assert!(offset_of!(PropertyDefinition, definite) == 57);
    assert!(offset_of!(PropertyDefinition, readonly) == 58);
    assert!(offset_of!(PropertyDefinition, type_annotation) == 60);
