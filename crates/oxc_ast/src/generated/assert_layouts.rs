...
const _: () = {
    ...
    assert!(offset_of!(Program, source_text) == 32);
    assert!(offset_of!(Program, comments) == 48);
    assert!(offset_of!(Program, hashbang) == 8);
    ...
    assert!(offset_of!(TaggedTemplateExpression, tag) == 64);
    assert!(offset_of!(TaggedTemplateExpression, type_arguments) == 80);
    assert!(offset_of!(TaggedTemplateExpression, quasi) == 8);
    ...
    assert!(offset_of!(StaticMemberExpression, object) == 32);
    assert!(offset_of!(StaticMemberExpression, property) == 8);
    ...
    assert!(offset_of!(PrivateFieldExpression, object) == 32);
    assert!(offset_of!(PrivateFieldExpression, field) == 8);
    ...
    assert!(offset_of!(Class, decorators) == 40);
    assert!(offset_of!(Class, id) == 8);
    ...
    assert!(offset_of!(ImportDeclaration, specifiers) == 56);
    assert!(offset_of!(ImportDeclaration, source) == 8);
    ...
    assert!(offset_of!(ExportNamedDeclaration, declaration) == 56);
    assert!(offset_of!(ExportNamedDeclaration, specifiers) == 72);
    assert!(offset_of!(ExportNamedDeclaration, source) == 8);
    ...
    assert!(offset_of!(JSXMemberExpression, object) == 32);
    assert!(offset_of!(JSXMemberExpression, property) == 8);
    ...
    assert!(offset_of!(TSQualifiedName, left) == 32);
    assert!(offset_of!(TSQualifiedName, right) == 8);
    ...
    assert!(offset_of!(TSImportTypeQualifiedName, left) == 32);
    assert!(offset_of!(TSImportTypeQualifiedName, right) == 8);
...
const _: () = {
    ...
    // Padding: 4 bytes
    assert!(size_of::<TaggedTemplateExpression>() == 64);
    assert!(align_of::<TaggedTemplateExpression>() == 8);
    assert!(offset_of!(TaggedTemplateExpression, span) == 0);
    assert!(offset_of!(TaggedTemplateExpression, tag) == 48);
    ...
    // Padding: 6 bytes
    assert!(size_of::<BindingProperty>() == 40);
    assert!(align_of::<BindingProperty>() == 8);
    assert!(offset_of!(BindingProperty, span) == 0);
    assert!(offset_of!(BindingProperty, key) == 8);
    ...
    assert!(offset_of!(Class, decorators) == 32);
    assert!(offset_of!(Class, id) == 8);
    ...
    assert!(align_of::<ImportDeclaration>() == 8);
    assert!(offset_of!(ImportDeclaration, span) == 0);
    assert!(offset_of!(ImportDeclaration, specifiers) == 40);
    assert!(offset_of!(ImportDeclaration, source) == 8);
    ...
    assert!(size_of::<ImportAttributeKey>() == 40);
    assert!(align_of::<ImportAttributeKey>() == 8);
    ...
    assert!(offset_of!(TSTypePredicate, span) == 0);
    assert!(offset_of!(TSTypePredicate, parameter_name) == 8);
    assert!(offset_of!(TSTypePredicate, asserts) == 28);
    assert!(offset_of!(TSTypePredicate, type_annotation) == 24);
    ...
    assert!(size_of::<TSModuleDeclarationName>() == 40);
    assert!(align_of::<TSModuleDeclarationName>() == 8);
    ...
    assert!(align_of::<TSImportTypeQualifiedName>() == 8);
    assert!(offset_of!(TSImportTypeQualifiedName, span) == 0);
    assert!(offset_of!(TSImportTypeQualifiedName, left) == 24);
    assert!(offset_of!(TSImportTypeQualifiedName, right) == 8);
