...
const _: () = {
    ...
    assert!(offset_of!(ComputedMemberExpression, object) == 12);
    assert!(offset_of!(ComputedMemberExpression, expression) == 20);
    ...
    assert!(offset_of!(StaticMemberExpression, object) == 12);
    assert!(offset_of!(StaticMemberExpression, optional) == 20);
    ...
    assert!(offset_of!(PrivateFieldExpression, object) == 12);
    assert!(offset_of!(PrivateFieldExpression, optional) == 20);
    ...
    assert!(offset_of!(CallExpression, callee) == 12);
    assert!(offset_of!(CallExpression, type_arguments) == 20);
    assert!(offset_of!(CallExpression, arguments) == 24);
    assert!(offset_of!(CallExpression, optional) == 48);
    assert!(offset_of!(CallExpression, pure) == 49);
    ...
    assert!(offset_of!(NewExpression, callee) == 12);
    assert!(offset_of!(NewExpression, type_arguments) == 20);
    assert!(offset_of!(NewExpression, arguments) == 24);
    assert!(offset_of!(NewExpression, pure) == 48);
    ...
    assert!(offset_of!(BinaryExpression, left) == 12);
    ...
    assert!(offset_of!(PrivateInExpression, right) == 12);
    ...
    assert!(offset_of!(ArrayAssignmentTarget, rest) == 12);
    ...
    assert!(offset_of!(ObjectAssignmentTarget, rest) == 12);
    ...
    // Padding: 4 bytes
    assert!(size_of::<AssignmentTargetWithDefault>() == 32);
    ...
    assert!(offset_of!(AssignmentTargetPropertyIdentifier, init) == 12);
    ...
    assert!(offset_of!(AssignmentTargetPropertyProperty, name) == 12);
    assert!(offset_of!(AssignmentTargetPropertyProperty, binding) == 20);
    ...
    assert!(offset_of!(VariableDeclarator, type_annotation) == 20);
    ...
    // Padding: 4 bytes
    assert!(size_of::<DoWhileStatement>() == 32);
    ...
    // Padding: 4 bytes
    assert!(size_of::<WhileStatement>() == 32);
    ...
    assert!(offset_of!(ForStatement, init) == 12);
    assert!(offset_of!(ForStatement, test) == 20);
    assert!(offset_of!(ForStatement, update) == 28);
    assert!(offset_of!(ForStatement, body) == 36);
    ...
    assert!(offset_of!(ForInStatement, left) == 12);
    assert!(offset_of!(ForInStatement, right) == 20);
    assert!(offset_of!(ForInStatement, body) == 28);
    ...
    // Padding: 7 bytes
    assert!(size_of::<ForOfStatement>() == 48);
    ...
    assert!(offset_of!(WithStatement, object) == 12);
    assert!(offset_of!(WithStatement, body) == 20);
    assert!(offset_of!(WithStatement, scope_id) == 28);

    // Padding: 0 bytes
    assert!(size_of::<SwitchStatement>() == 48);
    assert!(align_of::<SwitchStatement>() == 8);
    assert!(offset_of!(SwitchStatement, span) == 0);
    assert!(offset_of!(SwitchStatement, node_id) == 8);
    assert!(offset_of!(SwitchStatement, discriminant) == 12);
    assert!(offset_of!(SwitchStatement, scope_id) == 20);
    ...
    assert!(offset_of!(ObjectPattern, rest) == 12);
    ...
    assert!(offset_of!(BindingProperty, key) == 12);
    assert!(offset_of!(BindingProperty, value) == 20);
    ...
    assert!(offset_of!(ArrayPattern, rest) == 12);
    ...
    assert!(offset_of!(FormalParameters, rest) == 12);
    assert!(offset_of!(FormalParameters, items) == 16);
    assert!(offset_of!(FormalParameters, kind) == 40);

    // Padding: 0 bytes
    assert!(size_of::<FormalParameter>() == 56);
    assert!(align_of::<FormalParameter>() == 8);
    assert!(offset_of!(FormalParameter, span) == 0);
    assert!(offset_of!(FormalParameter, node_id) == 8);
    assert!(offset_of!(FormalParameter, pattern) == 12);
    assert!(offset_of!(FormalParameter, type_annotation) == 20);
    assert!(offset_of!(FormalParameter, decorators) == 24);
    assert!(offset_of!(FormalParameter, initializer) == 48);
    assert!(offset_of!(FormalParameter, optional) == 52);
    assert!(offset_of!(FormalParameter, accessibility) == 53);
    assert!(offset_of!(FormalParameter, readonly) == 54);
    assert!(offset_of!(FormalParameter, r#override) == 55);
    ...
    assert!(offset_of!(FormalParameterRest, type_annotation) == 12);
    ...
    assert!(offset_of!(MethodDefinition, key) == 12);
    assert!(offset_of!(MethodDefinition, value) == 20);
    assert!(offset_of!(MethodDefinition, decorators) == 24);
    assert!(offset_of!(MethodDefinition, r#type) == 48);
    assert!(offset_of!(MethodDefinition, kind) == 49);
    assert!(offset_of!(MethodDefinition, computed) == 50);
    assert!(offset_of!(MethodDefinition, r#static) == 51);
    assert!(offset_of!(MethodDefinition, r#override) == 52);
    assert!(offset_of!(MethodDefinition, optional) == 53);
    assert!(offset_of!(MethodDefinition, accessibility) == 54);
    ...
    assert!(offset_of!(PropertyDefinition, key) == 12);
    assert!(offset_of!(PropertyDefinition, type_annotation) == 20);
    assert!(offset_of!(PropertyDefinition, decorators) == 24);
    assert!(offset_of!(PropertyDefinition, value) == 48);
    assert!(offset_of!(PropertyDefinition, r#type) == 56);
    assert!(offset_of!(PropertyDefinition, computed) == 57);
    assert!(offset_of!(PropertyDefinition, r#static) == 58);
    assert!(offset_of!(PropertyDefinition, declare) == 59);
    assert!(offset_of!(PropertyDefinition, r#override) == 60);
    assert!(offset_of!(PropertyDefinition, optional) == 61);
    assert!(offset_of!(PropertyDefinition, definite) == 62);
    assert!(offset_of!(PropertyDefinition, readonly) == 63);
    assert!(offset_of!(PropertyDefinition, accessibility) == 64);
    ...
    assert!(offset_of!(AccessorProperty, key) == 12);
    assert!(offset_of!(AccessorProperty, type_annotation) == 20);
    assert!(offset_of!(AccessorProperty, decorators) == 24);
    assert!(offset_of!(AccessorProperty, value) == 48);
    assert!(offset_of!(AccessorProperty, r#type) == 56);
    assert!(offset_of!(AccessorProperty, computed) == 57);
    assert!(offset_of!(AccessorProperty, r#static) == 58);
    assert!(offset_of!(AccessorProperty, r#override) == 59);
    assert!(offset_of!(AccessorProperty, definite) == 60);
    assert!(offset_of!(AccessorProperty, accessibility) == 61);
    ...
    assert!(offset_of!(ImportExpression, source) == 12);
    assert!(offset_of!(ImportExpression, options) == 20);
    ...
    assert!(offset_of!(ImportDeclaration, with_clause) == 12);
    ...
    // Padding: 7 bytes
    assert!(size_of::<ExportNamedDeclaration>() == 104);
    ...
    assert!(offset_of!(ExportNamedDeclaration, declaration) == 12);
    assert!(offset_of!(ExportNamedDeclaration, with_clause) == 20);
    ...
    assert!(offset_of!(ExportAllDeclaration, with_clause) == 12);
    ...
    // Padding: 0 bytes
    assert!(size_of::<JSXOpeningElement>() == 48);
    ...
    // Padding: 4 bytes
    assert!(size_of::<JSXMemberExpression>() == 56);
    ...
    // Padding: 4 bytes
    assert!(size_of::<JSXAttribute>() == 32);
    ...
    assert!(offset_of!(TSThisParameter, type_annotation) == 12);
    ...
    // Padding: 4 bytes
    assert!(size_of::<TSEnumMember>() == 32);
    ...
    assert!(offset_of!(TSConditionalType, check_type) == 12);
    assert!(offset_of!(TSConditionalType, extends_type) == 20);
    assert!(offset_of!(TSConditionalType, true_type) == 28);
    assert!(offset_of!(TSConditionalType, false_type) == 36);
    ...
    // Padding: 4 bytes
    assert!(size_of::<TSIndexedAccessType>() == 32);
    ...
    assert!(offset_of!(TSNamedTupleMember, element_type) == 12);
    assert!(offset_of!(TSNamedTupleMember, optional) == 20);
    ...
    // Padding: 4 bytes
    assert!(size_of::<TSQualifiedName>() == 56);
    ...
    // Padding: 1 bytes
    assert!(size_of::<TSTypeParameter>() == 64);
    assert!(align_of::<TSTypeParameter>() == 8);
    assert!(offset_of!(TSTypeParameter, span) == 0);
    assert!(offset_of!(TSTypeParameter, node_id) == 8);
    assert!(offset_of!(TSTypeParameter, constraint) == 12);
    assert!(offset_of!(TSTypeParameter, default) == 20);
    assert!(offset_of!(TSTypeParameter, r#in) == 28);
    assert!(offset_of!(TSTypeParameter, out) == 29);
    assert!(offset_of!(TSTypeParameter, r#const) == 30);
    assert!(offset_of!(TSTypeParameter, name) == 32);
    ...
    assert!(offset_of!(TSTypeAliasDeclaration, type_parameters) == 12);
    ...
    assert!(offset_of!(TSInterfaceDeclaration, type_parameters) == 12);
    ...
    assert!(offset_of!(TSInterfaceDeclaration, scope_id) == 76);
    ...
    // Padding: 5 bytes
    assert!(size_of::<TSPropertySignature>() == 32);
    ...
    assert!(offset_of!(TSIndexSignature, type_annotation) == 12);
    ...
    assert!(offset_of!(TSCallSignatureDeclaration, type_parameters) == 12);
    assert!(offset_of!(TSCallSignatureDeclaration, this_param) == 16);
    assert!(offset_of!(TSCallSignatureDeclaration, params) == 20);
    assert!(offset_of!(TSCallSignatureDeclaration, return_type) == 24);
    ...
    // Padding: 4 bytes
    assert!(size_of::<TSConstructSignatureDeclaration>() == 32);
    ...
    assert!(offset_of!(TSConstructSignatureDeclaration, type_parameters) == 12);
    assert!(offset_of!(TSConstructSignatureDeclaration, params) == 16);
    assert!(offset_of!(TSConstructSignatureDeclaration, return_type) == 20);
    ...
    assert!(offset_of!(TSIndexSignatureName, type_annotation) == 12);
    ...
    assert!(offset_of!(TSModuleDeclaration, body) == 12);
    assert!(offset_of!(TSModuleDeclaration, scope_id) == 20);
    ...
    assert!(offset_of!(TSFunctionType, type_parameters) == 12);
    assert!(offset_of!(TSFunctionType, this_param) == 16);
    assert!(offset_of!(TSFunctionType, params) == 20);
    assert!(offset_of!(TSFunctionType, return_type) == 24);
    ...
    // Padding: 6 bytes
    assert!(size_of::<TSMappedType>() == 80);
    assert!(align_of::<TSMappedType>() == 8);
    assert!(offset_of!(TSMappedType, span) == 0);
    assert!(offset_of!(TSMappedType, node_id) == 8);
    assert!(offset_of!(TSMappedType, constraint) == 12);
    assert!(offset_of!(TSMappedType, name_type) == 20);
    assert!(offset_of!(TSMappedType, type_annotation) == 28);
    assert!(offset_of!(TSMappedType, scope_id) == 36);
    assert!(offset_of!(TSMappedType, key) == 40);
    assert!(offset_of!(TSMappedType, optional) == 72);
    assert!(offset_of!(TSMappedType, readonly) == 73);
    ...
    // Padding: 4 bytes
    assert!(size_of::<TSAsExpression>() == 32);
    ...
    // Padding: 4 bytes
    assert!(size_of::<TSSatisfiesExpression>() == 32);
    ...
    // Padding: 4 bytes
    assert!(size_of::<TSTypeAssertion>() == 32);
    ...
    assert!(offset_of!(TSImportEqualsDeclaration, module_reference) == 12);
    assert!(offset_of!(TSImportEqualsDeclaration, import_kind) == 20);
    ...
    assert!(offset_of!(JSDocNullableType, type_annotation) == 12);
    ...
    assert!(offset_of!(JSDocNonNullableType, type_annotation) == 12);
...
const _: () = if cfg!(target_family = "wasm") || align_of::<u64>() == 8 {
    ...
    assert!(offset_of!(PrivateInExpression, node_id) == 8);
    assert!(offset_of!(PrivateInExpression, right) == 12);
    assert!(offset_of!(PrivateInExpression, left) == 20);
    ...
    assert!(offset_of!(AssignmentTargetPropertyIdentifier, node_id) == 8);
    assert!(offset_of!(AssignmentTargetPropertyIdentifier, init) == 12);
    assert!(offset_of!(AssignmentTargetPropertyIdentifier, binding) == 20);
    ...
    assert!(offset_of!(LabeledStatement, node_id) == 8);
    assert!(offset_of!(LabeledStatement, body) == 12);
    assert!(offset_of!(LabeledStatement, label) == 20);
    ...
    assert!(offset_of!(Function, type_parameters) == 12);
    assert!(offset_of!(Function, id) == 16);
    assert!(offset_of!(Function, this_param) == 44);
    assert!(offset_of!(Function, params) == 48);
    assert!(offset_of!(Function, return_type) == 52);
    assert!(offset_of!(Function, body) == 56);
    assert!(offset_of!(Function, scope_id) == 60);
    ...
    assert!(offset_of!(FormalParameter, type_annotation) == 20);
    assert!(offset_of!(FormalParameter, decorators) == 24);
    assert!(offset_of!(FormalParameter, initializer) == 40);
    ...
    assert!(offset_of!(Class, super_class) == 76);
    assert!(offset_of!(Class, super_type_arguments) == 84);
    assert!(offset_of!(Class, body) == 88);
    assert!(offset_of!(Class, scope_id) == 92);
    ...
    assert!(offset_of!(TSTypeAliasDeclaration, type_parameters) == 12);
    assert!(offset_of!(TSTypeAliasDeclaration, id) == 16);
    assert!(offset_of!(TSTypeAliasDeclaration, type_annotation) == 44);
    assert!(offset_of!(TSTypeAliasDeclaration, scope_id) == 52);
    ...
    assert!(offset_of!(TSInterfaceDeclaration, type_parameters) == 12);
    assert!(offset_of!(TSInterfaceDeclaration, id) == 16);
    assert!(offset_of!(TSInterfaceDeclaration, extends) == 44);
    assert!(offset_of!(TSInterfaceDeclaration, body) == 60);
