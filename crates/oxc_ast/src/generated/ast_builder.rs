...
impl<'a> AstBuilder<'a> {
    ...
    /// * `name`
    #[inline]
    pub fn property_key_private_identifier(self, span: Span, name: Ident<'a>) -> PropertyKey<'a> {
    ...
    /// * `name`
    #[inline]
    pub fn private_identifier(self, span: Span, name: Ident<'a>) -> PrivateIdentifier<'a> {
