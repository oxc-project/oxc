...
impl LeadingDotExpression<'_> {
    /// Get [`NodeId`] of [`LeadingDotExpression`].
    ///
    /// Only use this method on a post-semantic AST where [`NodeId`]s are always defined.
    #[inline]
    pub fn node_id(&self) -> NodeId {
    ...
    /// Set [`NodeId`] of [`LeadingDotExpression`].
    #[inline]
    pub fn set_node_id(&self, node_id: NodeId) {
        self.node_id.set(node_id);
    }
...
impl LazyImportDeclaration<'_> {
    /// Get [`NodeId`] of [`LazyImportDeclaration`].
    ///
    /// Only use this method on a post-semantic AST where [`NodeId`]s are always defined.
    #[inline]
    pub fn node_id(&self) -> NodeId {
    ...
    /// Set [`NodeId`] of [`LazyImportDeclaration`].
    #[inline]
    pub fn set_node_id(&self, node_id: NodeId) {
        self.node_id.set(node_id);
    }
...
impl StructStatement<'_> {
    /// Get [`NodeId`] of [`StructStatement`].
    ///
    /// Only use this method on a post-semantic AST where [`NodeId`]s are always defined.
    #[inline]
    pub fn node_id(&self) -> NodeId {
    ...
    /// Set [`NodeId`] of [`StructStatement`].
    #[inline]
    pub fn set_node_id(&self, node_id: NodeId) {
        self.node_id.set(node_id);
    }

    /// Get [`ScopeId`] of [`StructStatement`].
    ///
    /// Only use this method on a post-semantic AST where [`ScopeId`]s are always defined.
    ///
    /// # Panics
...
impl ArkUIComponentExpression<'_> {
    /// Get [`NodeId`] of [`ArkUIComponentExpression`].
    ///
    /// Only use this method on a post-semantic AST where [`NodeId`]s are always defined.
    #[inline]
    pub fn node_id(&self) -> NodeId {
    ...
    /// Set [`NodeId`] of [`ArkUIComponentExpression`].
    #[inline]
    pub fn set_node_id(&self, node_id: NodeId) {
        self.node_id.set(node_id);
    }
...
impl AnnotationDeclaration<'_> {
    /// Get [`NodeId`] of [`AnnotationDeclaration`].
    ///
    /// Only use this method on a post-semantic AST where [`NodeId`]s are always defined.
    #[inline]
    pub fn node_id(&self) -> NodeId {
    ...
    /// Set [`NodeId`] of [`AnnotationDeclaration`].
    #[inline]
    pub fn set_node_id(&self, node_id: NodeId) {
        self.node_id.set(node_id);
    }
...
impl AnnotationBody<'_> {
    /// Get [`NodeId`] of [`AnnotationBody`].
    ///
    /// Only use this method on a post-semantic AST where [`NodeId`]s are always defined.
    #[inline]
    pub fn node_id(&self) -> NodeId {
...
impl AnnotationElement<'_> {
    /// Get [`NodeId`] of [`AnnotationElement`].
    // `#[inline(always)]` because this should boil down to a single instruction.
    #[inline(always)]
    pub fn node_id(&self) -> NodeId {
        match self {
