...
impl GetAddress for AstKind<'_> {
    fn address(&self) -> Address {
        match self {
            ...
            Self::ArrayExpressionElement(it) => Address::from_ptr(*it),
            ...
            Self::Argument(it) => Address::from_ptr(*it),
            ...
            Self::AssignmentTarget(it) => Address::from_ptr(*it),
            Self::SimpleAssignmentTarget(it) => Address::from_ptr(*it),
            Self::AssignmentTargetPattern(it) => Address::from_ptr(*it),
            ...
            Self::ForStatementInit(it) => Address::from_ptr(*it),
            ...
            Self::ModuleDeclaration(it) => Address::from_ptr(*it),
            ...
            Self::TSTypeName(it) => Address::from_ptr(*it),
            ...
            Self::TSModuleReference(it) => Address::from_ptr(*it),
