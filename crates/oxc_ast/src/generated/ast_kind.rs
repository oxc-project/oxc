...
pub enum AstType {
    ...
    ObjectProperty = 13,
    TemplateLiteral = 14,
    TaggedTemplateExpression = 15,
    TemplateElement = 16,
    ComputedMemberExpression = 17,
    StaticMemberExpression = 18,
    PrivateFieldExpression = 19,
    CallExpression = 20,
    NewExpression = 21,
    MetaProperty = 22,
    SpreadElement = 23,
    ...
    CatchClause = 64,
    CatchParameter = 65,
    DebuggerStatement = 66,
    AssignmentPattern = 67,
    ObjectPattern = 68,
    BindingProperty = 69,
    ArrayPattern = 70,
    BindingRestElement = 71,
    Function = 72,
    FormalParameters = 73,
    FormalParameter = 74,
    FormalParameterRest = 75,
    FunctionBody = 76,
