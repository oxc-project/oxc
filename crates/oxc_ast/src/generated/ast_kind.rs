...
pub enum AstType {
    ...
    TSCallSignatureDeclaration = 155,
    TSMethodSignature = 156,
    TSConstructSignatureDeclaration = 157,
    TSIndexSignatureName = 158,
    TSInterfaceHeritage = 159,
    TSTypePredicate = 160,
    TSModuleDeclaration = 161,
    TSModuleBlock = 162,
    TSTypeLiteral = 163,
    TSInferType = 164,
    TSTypeQuery = 165,
