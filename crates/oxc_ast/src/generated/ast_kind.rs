...
pub enum AstType {
    ...
    WithClause = 89,
    ImportAttribute = 90,
    ExportDeclaration = 91,
    ExportNamedDeclaration = 92,
    ExportFromDeclaration = 93,
    ...
    TSTypePredicate = 166,
    TSExternalModuleDeclaration = 167,
    TSNamespaceDeclaration = 168,
    TSGlobalDeclaration = 169,
    TSModuleBlock = 170,
    TSTypeLiteral = 171,
    TSInferType = 172,
    TSTypeQuery = 173,
    TSImportType = 174,
    TSImportTypeQualifiedName = 175,
    TSFunctionType = 176,
    TSConstructorType = 177,
    TSMappedType = 178,
    TSTemplateLiteralType = 179,
    TSAsExpression = 180,
    TSSatisfiesExpression = 181,
    TSTypeAssertion = 182,
    TSImportEqualsDeclaration = 183,
    TSExternalModuleReference = 184,
    TSNonNullExpression = 185,
    Decorator = 186,
    TSExportAssignment = 187,
    TSNamespaceExportDeclaration = 188,
    TSInstantiationExpression = 189,
    JSDocNullableType = 190,
    JSDocNonNullableType = 191,
    JSDocUnknownType = 192,
}
...
pub enum AstKind<'a> {
    ...
    ClassConstructor(&'a ClassConstructor<'a>) = AstType::ClassConstructor as u8,
    ...
    ExportDeclaration(&'a ExportDeclaration<'a>) = AstType::ExportDeclaration as u8,
    ExportNamedDeclaration(&'a ExportNamedDeclaration<'a>) = AstType::ExportNamedDeclaration as u8,
    ExportFromDeclaration(&'a ExportFromDeclaration<'a>) = AstType::ExportFromDeclaration as u8,
...
impl AstKind<'_> {
    ...
    pub fn node_id(&self) -> NodeId {
        match self {
            ...
            Self::ClassConstructor(it) => it.node_id(),
    ...
    pub fn set_node_id(&self, node_id: NodeId) {
        match self {
            ...
            Self::ClassConstructor(it) => it.set_node_id(node_id),
...
impl GetSpan for AstKind<'_> {
    ...
    fn span(&self) -> Span {
        match self {
            ...
            Self::ClassConstructor(it) => it.span(),
            ...
            Self::ExportDeclaration(it) => it.span(),
            Self::ExportNamedDeclaration(it) => it.span(),
            Self::ExportFromDeclaration(it) => it.span(),
...
impl GetAddress for AstKind<'_> {
    ...
    fn address(&self) -> Address {
        match *self {
            ...
            Self::ClassConstructor(it) => it.unstable_address(),
            ...
            Self::ExportDeclaration(it) => it.unstable_address(),
            Self::ExportNamedDeclaration(it) => it.unstable_address(),
            Self::ExportFromDeclaration(it) => it.unstable_address(),
...
impl<'a> AstKind<'a> {
    ...
    #[inline]
    pub fn as_class_constructor(self) -> Option<&'a ClassConstructor<'a>> {
        if let Self::ClassConstructor(v) = self { Some(v) } else { None }
    }
    ...
    #[inline]
    pub fn as_export_declaration(self) -> Option<&'a ExportDeclaration<'a>> {
        if let Self::ExportDeclaration(v) = self { Some(v) } else { None }
    }
    ...
    #[inline]
    pub fn as_export_from_declaration(self) -> Option<&'a ExportFromDeclaration<'a>> {
        if let Self::ExportFromDeclaration(v) = self { Some(v) } else { None }
    }
