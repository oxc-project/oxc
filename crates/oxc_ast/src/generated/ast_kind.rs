...
impl GetAddress for AstKind<'_> {
    fn address(&self) -> Address {
        match *self {
            Self::Program(it) => Address::from_ref(it),
            Self::IdentifierName(it) => Address::from_ref(it),
            Self::IdentifierReference(it) => Address::from_ref(it),
            Self::BindingIdentifier(it) => Address::from_ref(it),
            Self::LabelIdentifier(it) => Address::from_ref(it),
            Self::ThisExpression(it) => Address::from_ref(it),
            Self::ArrayExpression(it) => Address::from_ref(it),
            Self::Elision(it) => Address::from_ref(it),
            Self::ObjectExpression(it) => Address::from_ref(it),
            Self::ObjectProperty(it) => Address::from_ref(it),
            Self::TemplateLiteral(it) => Address::from_ref(it),
            Self::TaggedTemplateExpression(it) => Address::from_ref(it),
            Self::TemplateElement(it) => Address::from_ref(it),
            Self::ComputedMemberExpression(it) => Address::from_ref(it),
            Self::StaticMemberExpression(it) => Address::from_ref(it),
            Self::PrivateFieldExpression(it) => Address::from_ref(it),
            Self::CallExpression(it) => Address::from_ref(it),
            Self::NewExpression(it) => Address::from_ref(it),
            Self::MetaProperty(it) => Address::from_ref(it),
            Self::SpreadElement(it) => Address::from_ref(it),
            Self::UpdateExpression(it) => Address::from_ref(it),
            Self::UnaryExpression(it) => Address::from_ref(it),
            Self::BinaryExpression(it) => Address::from_ref(it),
            Self::PrivateInExpression(it) => Address::from_ref(it),
            Self::LogicalExpression(it) => Address::from_ref(it),
            Self::ConditionalExpression(it) => Address::from_ref(it),
            Self::AssignmentExpression(it) => Address::from_ref(it),
            Self::ArrayAssignmentTarget(it) => Address::from_ref(it),
            Self::ObjectAssignmentTarget(it) => Address::from_ref(it),
            Self::AssignmentTargetRest(it) => Address::from_ref(it),
            Self::AssignmentTargetWithDefault(it) => Address::from_ref(it),
            Self::AssignmentTargetPropertyIdentifier(it) => Address::from_ref(it),
            Self::AssignmentTargetPropertyProperty(it) => Address::from_ref(it),
            Self::SequenceExpression(it) => Address::from_ref(it),
            Self::Super(it) => Address::from_ref(it),
            Self::AwaitExpression(it) => Address::from_ref(it),
            Self::ChainExpression(it) => Address::from_ref(it),
            Self::ParenthesizedExpression(it) => Address::from_ref(it),
            Self::Directive(it) => Address::from_ref(it),
            Self::Hashbang(it) => Address::from_ref(it),
            Self::BlockStatement(it) => Address::from_ref(it),
            Self::VariableDeclaration(it) => Address::from_ref(it),
            Self::VariableDeclarator(it) => Address::from_ref(it),
            Self::EmptyStatement(it) => Address::from_ref(it),
            Self::ExpressionStatement(it) => Address::from_ref(it),
            Self::IfStatement(it) => Address::from_ref(it),
            Self::DoWhileStatement(it) => Address::from_ref(it),
            Self::WhileStatement(it) => Address::from_ref(it),
            Self::ForStatement(it) => Address::from_ref(it),
            Self::ForInStatement(it) => Address::from_ref(it),
            Self::ForOfStatement(it) => Address::from_ref(it),
            Self::ContinueStatement(it) => Address::from_ref(it),
            Self::BreakStatement(it) => Address::from_ref(it),
            Self::ReturnStatement(it) => Address::from_ref(it),
            Self::WithStatement(it) => Address::from_ref(it),
            Self::SwitchStatement(it) => Address::from_ref(it),
            Self::SwitchCase(it) => Address::from_ref(it),
            Self::LabeledStatement(it) => Address::from_ref(it),
            Self::ThrowStatement(it) => Address::from_ref(it),
            Self::TryStatement(it) => Address::from_ref(it),
            Self::CatchClause(it) => Address::from_ref(it),
            Self::CatchParameter(it) => Address::from_ref(it),
            Self::DebuggerStatement(it) => Address::from_ref(it),
            Self::AssignmentPattern(it) => Address::from_ref(it),
            Self::ObjectPattern(it) => Address::from_ref(it),
            Self::BindingProperty(it) => Address::from_ref(it),
            Self::ArrayPattern(it) => Address::from_ref(it),
            Self::BindingRestElement(it) => Address::from_ref(it),
            Self::Function(it) => Address::from_ref(it),
            Self::FormalParameters(it) => Address::from_ref(it),
            Self::FormalParameter(it) => Address::from_ref(it),
            Self::FunctionBody(it) => Address::from_ref(it),
            Self::ArrowFunctionExpression(it) => Address::from_ref(it),
            Self::YieldExpression(it) => Address::from_ref(it),
            Self::Class(it) => Address::from_ref(it),
            Self::ClassBody(it) => Address::from_ref(it),
            Self::MethodDefinition(it) => Address::from_ref(it),
            Self::PropertyDefinition(it) => Address::from_ref(it),
            Self::PrivateIdentifier(it) => Address::from_ref(it),
            Self::StaticBlock(it) => Address::from_ref(it),
            Self::AccessorProperty(it) => Address::from_ref(it),
            Self::ImportExpression(it) => Address::from_ref(it),
            Self::ImportDeclaration(it) => Address::from_ref(it),
            Self::ImportSpecifier(it) => Address::from_ref(it),
            Self::ImportDefaultSpecifier(it) => Address::from_ref(it),
            Self::ImportNamespaceSpecifier(it) => Address::from_ref(it),
            Self::WithClause(it) => Address::from_ref(it),
            Self::ImportAttribute(it) => Address::from_ref(it),
            Self::ExportNamedDeclaration(it) => Address::from_ref(it),
            Self::ExportDefaultDeclaration(it) => Address::from_ref(it),
            Self::ExportAllDeclaration(it) => Address::from_ref(it),
            Self::ExportSpecifier(it) => Address::from_ref(it),
            Self::V8IntrinsicExpression(it) => Address::from_ref(it),
            Self::BooleanLiteral(it) => Address::from_ref(it),
            Self::NullLiteral(it) => Address::from_ref(it),
            Self::NumericLiteral(it) => Address::from_ref(it),
            Self::StringLiteral(it) => Address::from_ref(it),
            Self::BigIntLiteral(it) => Address::from_ref(it),
            Self::RegExpLiteral(it) => Address::from_ref(it),
            Self::JSXElement(it) => Address::from_ref(it),
            Self::JSXOpeningElement(it) => Address::from_ref(it),
            Self::JSXClosingElement(it) => Address::from_ref(it),
            Self::JSXFragment(it) => Address::from_ref(it),
            Self::JSXOpeningFragment(it) => Address::from_ref(it),
            Self::JSXClosingFragment(it) => Address::from_ref(it),
            Self::JSXNamespacedName(it) => Address::from_ref(it),
            Self::JSXMemberExpression(it) => Address::from_ref(it),
            Self::JSXExpressionContainer(it) => Address::from_ref(it),
            Self::JSXEmptyExpression(it) => Address::from_ref(it),
            Self::JSXAttribute(it) => Address::from_ref(it),
            Self::JSXSpreadAttribute(it) => Address::from_ref(it),
            Self::JSXIdentifier(it) => Address::from_ref(it),
            Self::JSXSpreadChild(it) => Address::from_ref(it),
            Self::JSXText(it) => Address::from_ref(it),
            Self::TSThisParameter(it) => Address::from_ref(it),
            Self::TSEnumDeclaration(it) => Address::from_ref(it),
            Self::TSEnumBody(it) => Address::from_ref(it),
            Self::TSEnumMember(it) => Address::from_ref(it),
            Self::TSTypeAnnotation(it) => Address::from_ref(it),
            Self::TSLiteralType(it) => Address::from_ref(it),
            Self::TSConditionalType(it) => Address::from_ref(it),
            Self::TSUnionType(it) => Address::from_ref(it),
            Self::TSIntersectionType(it) => Address::from_ref(it),
            Self::TSParenthesizedType(it) => Address::from_ref(it),
            Self::TSTypeOperator(it) => Address::from_ref(it),
            Self::TSArrayType(it) => Address::from_ref(it),
            Self::TSIndexedAccessType(it) => Address::from_ref(it),
            Self::TSTupleType(it) => Address::from_ref(it),
            Self::TSNamedTupleMember(it) => Address::from_ref(it),
            Self::TSOptionalType(it) => Address::from_ref(it),
            Self::TSRestType(it) => Address::from_ref(it),
            Self::TSAnyKeyword(it) => Address::from_ref(it),
            Self::TSStringKeyword(it) => Address::from_ref(it),
            Self::TSBooleanKeyword(it) => Address::from_ref(it),
            Self::TSNumberKeyword(it) => Address::from_ref(it),
            Self::TSNeverKeyword(it) => Address::from_ref(it),
            Self::TSIntrinsicKeyword(it) => Address::from_ref(it),
            Self::TSUnknownKeyword(it) => Address::from_ref(it),
            Self::TSNullKeyword(it) => Address::from_ref(it),
            Self::TSUndefinedKeyword(it) => Address::from_ref(it),
            Self::TSVoidKeyword(it) => Address::from_ref(it),
            Self::TSSymbolKeyword(it) => Address::from_ref(it),
            Self::TSThisType(it) => Address::from_ref(it),
            Self::TSObjectKeyword(it) => Address::from_ref(it),
            Self::TSBigIntKeyword(it) => Address::from_ref(it),
            Self::TSTypeReference(it) => Address::from_ref(it),
            Self::TSQualifiedName(it) => Address::from_ref(it),
            Self::TSTypeParameterInstantiation(it) => Address::from_ref(it),
            Self::TSTypeParameter(it) => Address::from_ref(it),
            Self::TSTypeParameterDeclaration(it) => Address::from_ref(it),
            Self::TSTypeAliasDeclaration(it) => Address::from_ref(it),
            Self::TSClassImplements(it) => Address::from_ref(it),
            Self::TSInterfaceDeclaration(it) => Address::from_ref(it),
            Self::TSInterfaceBody(it) => Address::from_ref(it),
            Self::TSPropertySignature(it) => Address::from_ref(it),
            Self::TSIndexSignature(it) => Address::from_ref(it),
            Self::TSCallSignatureDeclaration(it) => Address::from_ref(it),
            Self::TSMethodSignature(it) => Address::from_ref(it),
            Self::TSConstructSignatureDeclaration(it) => Address::from_ref(it),
            Self::TSIndexSignatureName(it) => Address::from_ref(it),
            Self::TSInterfaceHeritage(it) => Address::from_ref(it),
            Self::TSTypePredicate(it) => Address::from_ref(it),
            Self::TSModuleDeclaration(it) => Address::from_ref(it),
            Self::TSModuleBlock(it) => Address::from_ref(it),
            Self::TSTypeLiteral(it) => Address::from_ref(it),
            Self::TSInferType(it) => Address::from_ref(it),
            Self::TSTypeQuery(it) => Address::from_ref(it),
            Self::TSImportType(it) => Address::from_ref(it),
            Self::TSImportTypeQualifiedName(it) => Address::from_ref(it),
            Self::TSFunctionType(it) => Address::from_ref(it),
            Self::TSConstructorType(it) => Address::from_ref(it),
            Self::TSMappedType(it) => Address::from_ref(it),
            Self::TSTemplateLiteralType(it) => Address::from_ref(it),
            Self::TSAsExpression(it) => Address::from_ref(it),
            Self::TSSatisfiesExpression(it) => Address::from_ref(it),
            Self::TSTypeAssertion(it) => Address::from_ref(it),
            Self::TSImportEqualsDeclaration(it) => Address::from_ref(it),
            Self::TSExternalModuleReference(it) => Address::from_ref(it),
            Self::TSNonNullExpression(it) => Address::from_ref(it),
            Self::Decorator(it) => Address::from_ref(it),
            Self::TSExportAssignment(it) => Address::from_ref(it),
            Self::TSNamespaceExportDeclaration(it) => Address::from_ref(it),
            Self::TSInstantiationExpression(it) => Address::from_ref(it),
            Self::JSDocNullableType(it) => Address::from_ref(it),
            Self::JSDocNonNullableType(it) => Address::from_ref(it),
            Self::JSDocUnknownType(it) => Address::from_ref(it),
        }
    }
}
