...
use oxc_allocator::{Allocator, Box, GetAllocator, IntoIn, Vec};
...
impl<'a> Expression<'a> {
    ...
    #[inline]
    pub fn new_number_0<A: GetAstBuilder<'a>>(accessor: &A) -> Self {
        Expression::new_numeric_literal(SPAN, 0.0, None, NumberBase::Decimal, accessor)
    }
    ...
    #[inline]
    pub fn new_void_0<A: GetAstBuilder<'a>>(span: Span, accessor: &A) -> Self {
        let argument = Expression::new_number_0(accessor);
        Expression::new_unary_expression(span, UnaryOperator::Void, argument, accessor)
    }
    ...
    /// * `span`: The [`Span`] covering this node
    #[inline]
    pub fn new_nan<A: GetAstBuilder<'a>>(span: Span, accessor: &A) -> Self {
        Expression::new_numeric_literal(span, f64::NAN, None, NumberBase::Decimal, accessor)
    }
}
...
impl<'a> Directive<'a> {
    ...
    #[inline]
    pub fn new_use_strict<A: GetAstBuilder<'a>>(accessor: &A) -> Self {
        let use_strict = Str::from("use strict");
        Directive::new(
            SPAN,
            StringLiteral::new(SPAN, use_strict, None, accessor),
            use_strict,
            accessor,
        )
    }
...
impl<'a> FormalParameter<'a> {
    ...
    /// * `pattern`
    #[inline]
    pub fn new_plain<A: GetAstBuilder<'a>>(
        span: Span,
        pattern: BindingPattern<'a>,
        accessor: &A,
    ) -> Self {
        let decorators = Vec::new_in(accessor.builder().allocator());
        FormalParameter::new(
            span, decorators, pattern, NONE, NONE, false, None, false, false, accessor,
        )
    }
}
...
impl<'a> Function<'a> {
    ...
    /// * `scope_id`
    #[inline]
    pub fn boxed_plain_with_scope_id<A: GetAstBuilder<'a>>(
        r#type: FunctionType,
        span: Span,
    ...
    /// * `scope_id`
    #[inline]
    pub fn boxed_with_scope_id<A: GetAstBuilder<'a>, T1, T2, T3, T4, T5>(
        span: Span,
        r#type: FunctionType,
        id: Option<BindingIdentifier<'a>>,
        generator: bool,
...
impl<'a> ExportNamedDeclaration<'a> {
    ...
    /// * `declaration`
    #[inline]
    pub fn new_plain_declaration<A: GetAstBuilder<'a>>(
        span: Span,
        declaration: Declaration<'a>,
        accessor: &A,
    ) -> Self {
        let specifiers = Vec::new_in(accessor.builder().allocator());
        ExportNamedDeclaration::new(
            span,
            Some(declaration),
            specifiers,
...
impl<'a> TemplateElement<'a> {
    ...
    /// * `tail`
    #[inline]
    pub fn new_escape_raw<A: GetAstBuilder<'a>>(
        span: Span,
        mut value: TemplateElementValue<'a>,
        tail: bool,
        accessor: &A,
    ) -> Self {
        value.raw = escape_template_element_raw(value.raw, accessor.builder().allocator());
        TemplateElement::new(span, value, tail, accessor)
    }
    ...
    #[inline]
    pub fn new_escape_raw_with_lone_surrogates<A: GetAstBuilder<'a>>(
        span: Span,
        mut value: TemplateElementValue<'a>,
        tail: bool,
        ...
        value.raw = escape_template_element_raw(value.raw, accessor.builder().allocator());
        TemplateElement::new_with_lone_surrogates(span, value, tail, lone_surrogates, accessor)
    }
}
