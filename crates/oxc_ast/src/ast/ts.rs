...
use oxc_allocator::{Box, CloneIn, GetAddress, TakeIn, Vec};
...
#[ast(visit)]
#[derive(Debug)]
#[generate_derive(CloneIn, TakeIn, GetSpan, GetSpanMut, ContentEq, ESTree)]
#[estree(
    rename = "Identifier",
...
#[ast(visit)]
#[derive(Debug)]
#[generate_derive(CloneIn, TakeIn, GetSpan, GetSpanMut, GetAddress, ContentEq, ESTree)]
...
#[generate_derive(CloneIn, TakeIn, ContentEq, ESTree)]
