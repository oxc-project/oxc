...
// AST Resource
server.registerResource("ast", new ResourceTemplate("ast://{type}", {
    list: undefined
}), {
    title: "AST Examples",
...
`
    ...
    const content = examples[type] || "Unknown AST type";
    return {
        contents: [{
                uri: uri.href,
                text: content,
...
server.registerResource("docs", new ResourceTemplate("docs://{section}", {
    list: undefined
}), {
...
`
    ...
    const content = docs[section] || "Documentation section not found";
    return {
        contents: [{
                uri: uri.href,
                text: content,
...
server.registerPrompt("code-examples", {
...
// Analysis Prompt
server.registerPrompt("analyze-prompt", {
