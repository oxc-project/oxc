...
// Create directories after tsdown build (since tsdown cleans the dist directory)
...
// Copy bindings.d.ts for TypeScript support
const bindingsDtsPath = join(rootDir, 'src-js/bindings.d.ts');
if (existsSync(bindingsDtsPath)) {
  copyFileSync(bindingsDtsPath, join(distDir, 'bindings.d.ts'));
  console.log('Copied bindings.d.ts');
}
