...
test("issue_1664", () => {
  const code =
    "var a=1;function f(){if(undefined)a=2;{function undefined(){}undefined()}}f();console.log(a);";
  const expected = ["1"];
  run(code, expected);
});
...
test("computed_class_properties", () => {
  const code =
    'const x="FOO";const y="BAR";class X{[x]="PASS";static[y]}if("BAR"in X){console.log((new X)[x])}';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("static_property_side_effects", () => {
  const code =
    'let x="FAIL";class cls{static[x="PASS"]}console.log(x);class cls2{static[console.log("PASS")]}';
...
test("issue_1631_1", () => {
  const code =
    "var pc=0;function f(x){pc=200;return 100}function x(){var t=f();pc+=t;return pc}console.log(x());";
  const expected = ["300"];
  run(code, expected);
});
...
test("issue_1631_2", () => {
  const code =
    "var a=0,b=1;function f(){a=2;return 4}function g(){var t=f();b=a+t;return b}console.log(g());";
  const expected = ["6"];
  run(code, expected);
});
...
test("issue_2187_1", () => {
  const code =
    "var a=1;!function(foo){foo();var a=2;console.log(a)}((function(){console.log(a)}));";
  const expected = ["1", "2"];
  run(code, expected);
});
...
test("issue_2364_6", () => {
  const code =
    'function f(a,b){var c=a.p;b.p="FAIL";return c}var o={p:"PASS"};console.log(f(o,o));';
  const expected = ["PASS"];
  run(code, expected);
});
...
test.skip("issue_2858", () => {
  const code =
    "var b;(function(){function f(){a++}f();var c=f();var a=void 0;c||(b=a)})();console.log(b);";
  const expected = ["undefined"];
  run(code, expected);
});
...
test("issue_2878", () => {
  const code =
    "var c=0;(function(a,b){function f2(){if(a)c++}b=f2();a=1;b&&b.b;f2()})();console.log(c);";
  const expected = ["1"];
  run(code, expected);
});
...
test("issue_2954_1", () => {
  const code =
    'var a="PASS",b;try{do{b=function(){throw 0}();a="FAIL";b&&b.c}while(0)}catch(e){}console.log(a);';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("collapse_rhs_regexp", () => {
  const code =
    "var a,b;function f(){a=/bar/;b=/bar/;return/bar/}var c=f();console.log(a===b,b===c,c===a);";
  const expected = ["false false false"];
  run(code, expected);
});
...
test("collapse_rhs_this", () => {
  const code =
    "var a,b;function f(){a=this;b=this;return this}var c=f();console.log(a===b,b===c,c===a);";
  const expected = ["true true true"];
  run(code, expected);
});
...
test("collapse_rhs_undefined", () => {
  const code =
    "var a,b;function f(){a=void 0;b=void 0;return void 0}var c=f();console.log(a===b,b===c,c===a);";
  const expected = ["true true true"];
  run(code, expected);
});
...
test("issue_2929", () => {
  const code =
    'console.log(function(a){try{return null.p=a=1}catch(e){return a?"PASS":"FAIL"}}());';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("unused_destructuring_object_method_param", () => {
  const code =
    '({baz({w:w=console.log("side effect"),x:x,y:z}){console.log(x)}}).baz({x:7,y:8,z:9});';
...
test("defun_lambda_same_name", () => {
  const code =
    "function f(n){return n?n*f(n-1):1}console.log(function f(n){return n?n*f(n-1):1}(5));";
  const expected = ["120"];
  run(code, expected);
});
...
test("function_argument_modified_by_function_statement", () => {
  const code =
    'var printTest=function(ret){function ret(){console.log("PASS")}return ret}("FAIL");printTest();';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("issue_2768", () => {
  const code =
    'var a="FAIL",c=1;var c=function(b){var d=b=a;var e=--b+(d&&(a="PASS"))}();console.log(a,typeof c);';
...
test("issue_2995", () => {
  const code =
    'function f(a){var b;a.b=b=function(){};b.c="PASS"}var o={};f(o);console.log(o.b.c);';
  const expected = ["PASS"];
  run(code, expected);
});
...
test.skip("issue_3146_1", () => {
  const code =
    '(function(f){f("g()")})((function(a){eval(a);function g(b){if(!b)b="PASS";console.log(b)}}));';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("issue_3146_3", () => {
  const code =
    'var g="PASS";(function(f){var g="FAIL";f("console.log(g)",g[g])})((function(a){eval(a)}));';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("issue_t161_top_retain_6", () => {
  const code =
    "(function(){function f(){return 2}function g(){return 3}console.log(f(),f(),g(),g())})();";
  const expected = ["2 2 3 3"];
  run(code, expected);
});
...
test("issue_t183", () => {
  const code =
    'function foo(val){function bar(x){if(x)return x;bar(x-1)}return bar(val)}console.log(foo("PASS"));';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("unused_class_with_static_props_side_effects_2", () => {
  const code =
    'let x="FAIL";function impure(){x="PASS"}class Unused{static _=impure()}console.log(x);';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("unused_class_which_extends_might_throw", () => {
  const code =
    'let x="FAIL";try{class X extends(might_throw_lol()){constructor(){}}}catch(e){x="PASS"}console.log(x);';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("unused_class_which_might_throw", () => {
  const code =
    'let x="FAIL";try{class X{static _=ima_throw_lol()}}catch(e){x="PASS"}console.log(x);';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("unused_class_which_might_throw_3", () => {
  const code =
    'let x="FAIL";try{class X{[ima_throw_lol()](){return null}}}catch(e){x="PASS"}console.log(x);';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("unused_class_which_might_throw_4", () => {
  const code =
    'let x="FAIL";try{class X{get[ima_throw_lol()](){return null}}}catch(e){x="PASS"}console.log(x);';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("pow_sequence_with_parens", () => {
  const code =
    "var one=1;var two=2;var four=4;console.log((four**one)**two,(four**one)**(one/two));";
  const expected = ["16 2"];
  run(code, expected);
});
...
test("issue_2916_1", () => {
  const code =
    'var c="PASS";(function(a,b){(function(d){d[0]=1})(b);a==b&&(c="FAIL")})("",[]);console.log(c);';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("issue_2916_2", () => {
  const code =
    'var c="FAIL";(function(b){(function(d){d[0]=1})(b);+b&&(c="PASS")})([]);console.log(c);';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("issue_2630_1", () => {
  const code =
    "var c=0;(function(){while(f());function f(){var a=function(){var b=c++,d=c=1+c}()}})();console.log(c);";
  const expected = ["2"];
  run(code, expected);
});
...
test("issue_2630_2", () => {
  const code =
    "var c=0;!function(){while(f()){}function f(){var not_used=function(){c=1+c}(c=c+1)}}();console.log(c);";
  const expected = ["2"];
  run(code, expected);
});
...
test("issue_2663_2", () => {
  const code =
    "(function(){var i;function fn(j){return function(){console.log(j)}()}for(i in{a:1,b:2,c:3})fn(i)})();";
  const expected = ["a", "b", "c"];
  run(code, expected);
});
...
test("issue_2898", () => {
  const code =
    "var c=0;(function(){while(f());function f(){var b=(c=1+c,void(c=1+c));b&&b[0]}})();console.log(c);";
  const expected = ["2"];
  run(code, expected);
});
...
test("issue_3016_2", () => {
  const code =
    "var b=1;do{(function(a){return a[b];try{a=2}catch(a){var a}})(3)}while(0);console.log(b);";
  const expected = ["1"];
  run(code, expected);
});
...
test("issue_3054", () => {
  const code =
    '"use strict";function f(){return{a:true}}console.log(function(b){b=false;return f()}().a,f.call().a);';
...
test("avoid_generating_duplicate_functions_compared_together_2", () => {
  const code =
    "const defaultArg=input=>input;const fn=(arg=defaultArg)=>arg;console.log(fn()===fn());";
  const expected = ["true"];
  run(code, expected);
});
...
test("issue_3021", () => {
  const code =
    "var a=1,b=2;(function(){b=a;if(a+++b--)return 1;return;var b={}})();console.log(a,b);";
  const expected = ["2 2"];
  run(code, expected);
});
...
test("issue_3071_3", () => {
  const code =
    "var c=0;(function(a,b){(function f(o){var n=2;while(--b+(o={p:c++})&&--n>0);})()})();console.log(c);";
  const expected = ["2"];
  run(code, expected);
});
...
test("inline_identity_inner_ref", () => {
  const code =
    "const id=a=>function(){return a}();const undef=a=>(a=>a)();console.log(id(1),id(2),undef(3),undef(4));";
...
test("issue_2120_1", () => {
  const code =
    '"aaaaaaaa";var a=1,b="FAIL";try{throw 1}catch(c){try{throw 0}catch(a){if(c)b="PASS"}}console.log(b);';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("issue_2254_1", () => {
  const code =
    '"eeeeee";try{console.log(f("PASS"))}catch(e){}function f(s){try{throw"FAIL"}catch(e){return s}}';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("issue_2740_5", () => {
  const code =
    "L1:for(var x=0;x<3;x++){break L1;L2:for(var y=0;y<2;y++){break L2}}console.log(x,y);";
...
test("prop_side_effects_1", () => {
  const code =
    "var C=1;console.log(C);var obj={bar:function(){return C+C}};console.log(obj.bar());";
  const expected = ["1", "2"];
  run(code, expected);
});
...
test("join_object_assignments_return_3", () => {
  const code =
    'console.log(function(){var o={p:3};return o.q="foo",o.p+="",console.log(o.q),o.p}());';
...
test("join_object_assignments_for", () => {
  const code =
    'console.log(function(){var o={p:3};for(o.q="foo";console.log(o.q););return o.p}());';
  const expected = ["foo", "3"];
  run(code, expected);
});
...
test("issue_869_1", () => {
  const code =
    'var o={p:"FAIL"};Object.defineProperty(o,"p",{get:function(){return"PASS"}});console.log(o.p);';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("issue_869_2", () => {
  const code =
    'var o={p:"FAIL"};Object.defineProperties(o,{p:{get:function(){return"PASS"}}});console.log(o.p);';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("issue_3188_1", () => {
  const code =
    '(function(){function f(){console.log(this.p)}(function(){var o={p:"PASS",f:f};o.f()})()})();';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("issue_3188_2", () => {
  const code =
    '(function(){var f=function(){console.log(this.p)};function g(){var o={p:"PASS",f:f};o.f()}g()})();';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("issue_3188_3", () => {
  const code =
    '(function(){function f(){console.log(this[0])}(function(){var o=["PASS",f];o[1]()})()})();';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("issue_2110_1", () => {
  const code =
    "function f(){function f(){}function g(){return this}f.g=g;return f.g()}console.log(typeof f());";
  const expected = ["function"];
  run(code, expected);
});
...
test("issue_2678", () => {
  const code =
    'var a=1,c="FAIL";(function f(){(a--&&f()).p;return{get p(){c="PASS"}}})();console.log(c);';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("collapse_rhs_setter", () => {
  const code =
    'try{console.log(({set length(v){throw"PASS"}}.length="FAIL","FAIL"))}catch(e){console.log(e)}';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("unsafe_evaluate_array_3", () => {
  const code =
    "var arr=[1,2,function(){return++arr[0]}];console.log(arr[0],arr[1],arr[2](),arr[0]);";
...
test("unsafe_evaluate_array_5", () => {
  const code =
    "var arr=[1,2,function(){return++this[0]}];console.log(arr[0],arr[1],arr[2](),arr[0]);";
  const expected = ["1 2 2 2"];
  run(code, expected);
});
...
test("issue_1670_5", () => {
  const code =
    "(function(a){switch(1){case a:console.log(a);break;default:console.log(2);break}})(1);";
  const expected = ["1"];
  run(code, expected);
});
...
test("issue_1670_6", () => {
  const code =
    "(function(a){switch(1){case a=1:console.log(a);break;default:console.log(2);break}})(1);";
  const expected = ["1"];
  run(code, expected);
});
...
test("booleans", () => {
  const code =
    'console.log(function(a){if(a!=0);switch(a){case 0:return"FAIL";case false:return"PASS"}}(false));';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("const_expr_2", () => {
  const code =
    "Object.prototype.c=function(){this.a++};var o={a:1,b:2};o.c();console.log(o.a,o.b);";
  const expected = ["2 2"];
  run(code, expected);
});
...
test("escaped_prop_1", () => {
  const code =
    "var obj={o:{a:1}};(function(o){o.a++})(obj.o);(function(o){console.log(o.a)})(obj.o);";
  const expected = ["2"];
  run(code, expected);
});
...
test("escaped_prop_3", () => {
  const code =
    "var a;function f(b){if(a)console.log(a===b.c);a=b.c}function g(){}function h(){f({c:g})}h();h();";
  const expected = ["true"];
  run(code, expected);
});
...
test("issue_2423_5", () => {
  const code =
    "function x(){y()}function y(){console.log(1)}function z(){function y(){console.log(2)}x()}z();z();";
  const expected = ["1", "1"];
  run(code, expected);
});
...
test("issue_2423_6", () => {
  const code =
    "function x(){y()}function y(){console.log(1)}function z(){function y(){console.log(2)}x();y()}z();z();";
  const expected = ["1", "2", "1", "2"];
  run(code, expected);
});
...
test("issue_2450_5", () => {
  const code =
    "var a;function f(b){console.log(a===b);a=b}function g(){}[1,2,3].forEach((function(){f(g)}));";
  const expected = ["false", "true", "true"];
  run(code, expected);
});
...
test("do_while", () => {
  const code =
    'function f(a){do{(function(){a&&(c="PASS")})()}while(a=0)}var c="FAIL";f(1);console.log(c);';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("defun_assign", () => {
  const code =
    "console.log(typeof a);a=42;console.log(typeof a);function a(){}console.log(typeof a);";
...
test("issue_2992", () => {
  const code =
    'var c="PASS";(function f(b){switch(0){case 0:case b=1:b&&(c="FAIL")}})();console.log(c);';
  const expected = ["PASS"];
  run(code, expected);
});
...
test("issue_3113_3", () => {
  const code =
    "var c=0;(function(){function f(){while(g());}var a;function g(){a&&a[c++]}g(a=1)})();console.log(c);";
  const expected = ["1"];
  run(code, expected);
});
...
test("conditional_nested_3", () => {
  const code =
    "var n=2,c=0;(function f(a){0<n--&&g(a=1);function g(){a&&c++}g();0<n--&&f()})();console.log(c);";
  const expected = ["2"];
  run(code, expected);
});
...
test("for_init_var", () => {
  const code =
    'var a="PASS";(function(){var b=42;for(var c=5;c>0;)c--;a="FAIL";var a})();console.log(a);';
  const expected = ["PASS"];
  run(code, expected);
});
