...
function deserialize(buffer, sourceText, sourceByteLen) {
  ...
  let data;
  if (isJsAst(buffer)) {
    if (deserializeJS === null) deserializeJS = require('@oxc-project/deserialize/deserialize/js').default;
    ...
    if (deserializeTS === null) deserializeTS = require('@oxc-project/deserialize/deserialize/ts').default;
