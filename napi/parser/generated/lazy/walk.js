...
// To edit this generated file you have to edit `tasks/ast_tools/src/generators/raw_transfer_lazy.rs`.
        ...
        import { Program, IdentifierName, IdentifierReference, BindingIdentifier, LabelIdentifier, ThisExpression, ArrayExpression, Elision, ObjectExpression, ObjectProperty, TemplateLiteral, TaggedTemplateExpression, TemplateElement, ComputedMemberExpression, StaticMemberExpression, PrivateFieldExpression, CallExpression, NewExpression, MetaProperty, SpreadElement, UpdateExpression, UnaryExpression, BinaryExpression, PrivateInExpression, LogicalExpression, ConditionalExpression, AssignmentExpression, ArrayAssignmentTarget, ObjectAssignmentTarget, AssignmentTargetWithDefault, AssignmentTargetPropertyIdentifier, AssignmentTargetPropertyProperty, SequenceExpression, Super, AwaitExpression, ChainExpression, ParenthesizedExpression, Hashbang, BlockStatement, VariableDeclaration, VariableDeclarator, EmptyStatement, ExpressionStatement, IfStatement, DoWhileStatement, WhileStatement, ForStatement, ForInStatement, ForOfStatement, ContinueStatement, BreakStatement, ReturnStatement, WithStatement, SwitchStatement, SwitchCase, LabeledStatement, ThrowStatement, TryStatement, CatchClause, DebuggerStatement, AssignmentPattern, ObjectPattern, BindingProperty, ArrayPattern, Function, FormalParameters, FunctionBody, ArrowFunctionExpression, YieldExpression, Class, ClassBody, MethodDefinition, PropertyDefinition, PrivateIdentifier, StaticBlock, AccessorProperty, ImportExpression, ImportDeclaration, ImportSpecifier, ImportDefaultSpecifier, ImportNamespaceSpecifier, ImportAttribute, ExportNamedDeclaration, ExportDefaultDeclaration, ExportAllDeclaration, ExportSpecifier, V8IntrinsicExpression, BooleanLiteral, NullLiteral, NumericLiteral, StringLiteral, BigIntLiteral, RegExpLiteral, JSXElement, JSXOpeningElement, JSXClosingElement, JSXFragment, JSXOpeningFragment, JSXClosingFragment, JSXNamespacedName, JSXMemberExpression, JSXExpressionContainer, JSXEmptyExpression, JSXAttribute, JSXSpreadAttribute, JSXIdentifier, JSXSpreadChild, JSXText, TSEnumDeclaration, TSEnumBody, TSEnumMember, TSTypeAnnotation, TSLiteralType, TSConditionalType, TSUnionType, TSIntersectionType, TSParenthesizedType, TSTypeOperator, TSArrayType, TSIndexedAccessType, TSTupleType, TSNamedTupleMember, TSOptionalType, TSRestType, TSAnyKeyword, TSStringKeyword, TSBooleanKeyword, TSNumberKeyword, TSNeverKeyword, TSIntrinsicKeyword, TSUnknownKeyword, TSNullKeyword, TSUndefinedKeyword, TSVoidKeyword, TSSymbolKeyword, TSThisType, TSObjectKeyword, TSBigIntKeyword, TSTypeReference, TSQualifiedName, TSTypeParameterInstantiation, TSTypeParameter, TSTypeParameterDeclaration, TSTypeAliasDeclaration, TSClassImplements, TSInterfaceDeclaration, TSInterfaceBody, TSPropertySignature, TSIndexSignature, TSCallSignatureDeclaration, TSMethodSignature, TSConstructSignatureDeclaration, TSIndexSignatureName, TSInterfaceHeritage, TSTypePredicate, TSModuleDeclaration, TSGlobalDeclaration, TSModuleBlock, TSTypeLiteral, TSInferType, TSTypeQuery, TSImportType, TSImportTypeQualifiedName, TSFunctionType, TSConstructorType, TSMappedType, TSTemplateLiteralType, TSAsExpression, TSSatisfiesExpression, TSTypeAssertion, TSImportEqualsDeclaration, TSExternalModuleReference, TSNonNullExpression, Decorator, TSExportAssignment, TSNamespaceExportDeclaration, TSInstantiationExpression, JSDocNullableType, JSDocNonNullableType, JSDocUnknownType,  } from './constructors.js';
...
walkVecStatement(pos + 96, ast, visitors);
            ...
            function walkExpression(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxBooleanLiteral(pos + 8, ast, visitors); return;case 1: walkBoxNullLiteral(pos + 8, ast, visitors); return;case 2: walkBoxNumericLiteral(pos + 8, ast, visitors); return;case 3: walkBoxBigIntLiteral(pos + 8, ast, visitors); return;case 4: walkBoxRegExpLiteral(pos + 8, ast, visitors); return;case 5: walkBoxStringLiteral(pos + 8, ast, visitors); return;case 6: walkBoxTemplateLiteral(pos + 8, ast, visitors); return;case 7: walkBoxIdentifierReference(pos + 8, ast, visitors); return;case 8: walkBoxMetaProperty(pos + 8, ast, visitors); return;case 9: walkBoxSuper(pos + 8, ast, visitors); return;case 10: walkBoxArrayExpression(pos + 8, ast, visitors); return;case 11: walkBoxArrowFunctionExpression(pos + 8, ast, visitors); return;case 12: walkBoxAssignmentExpression(pos + 8, ast, visitors); return;case 13: walkBoxAwaitExpression(pos + 8, ast, visitors); return;case 14: walkBoxBinaryExpression(pos + 8, ast, visitors); return;case 15: walkBoxCallExpression(pos + 8, ast, visitors); return;case 16: walkBoxChainExpression(pos + 8, ast, visitors); return;case 17: walkBoxClass(pos + 8, ast, visitors); return;case 18: walkBoxConditionalExpression(pos + 8, ast, visitors); return;case 19: walkBoxFunction(pos + 8, ast, visitors); return;case 20: walkBoxImportExpression(pos + 8, ast, visitors); return;case 21: walkBoxLogicalExpression(pos + 8, ast, visitors); return;case 22: walkBoxNewExpression(pos + 8, ast, visitors); return;case 23: walkBoxObjectExpression(pos + 8, ast, visitors); return;case 24: walkBoxParenthesizedExpression(pos + 8, ast, visitors); return;case 25: walkBoxSequenceExpression(pos + 8, ast, visitors); return;case 26: walkBoxTaggedTemplateExpression(pos + 8, ast, visitors); return;case 27: walkBoxThisExpression(pos + 8, ast, visitors); return;case 28: walkBoxUnaryExpression(pos + 8, ast, visitors); return;case 29: walkBoxUpdateExpression(pos + 8, ast, visitors); return;case 30: walkBoxYieldExpression(pos + 8, ast, visitors); return;case 31: walkBoxPrivateInExpression(pos + 8, ast, visitors); return;case 32: walkBoxJSXElement(pos + 8, ast, visitors); return;case 33: walkBoxJSXFragment(pos + 8, ast, visitors); return;case 34: walkBoxTSAsExpression(pos + 8, ast, visitors); return;case 35: walkBoxTSSatisfiesExpression(pos + 8, ast, visitors); return;case 36: walkBoxTSTypeAssertion(pos + 8, ast, visitors); return;case 37: walkBoxTSNonNullExpression(pos + 8, ast, visitors); return;case 38: walkBoxTSInstantiationExpression(pos + 8, ast, visitors); return;case 39: walkBoxV8IntrinsicExpression(pos + 8, ast, visitors); return;case 48: walkBoxComputedMemberExpression(pos + 8, ast, visitors); return;case 49: walkBoxStaticMemberExpression(pos + 8, ast, visitors); return;case 50: walkBoxPrivateFieldExpression(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for Expression`);
                }
            }
            ...
            function walkArrayExpressionElement(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxBooleanLiteral(pos + 8, ast, visitors); return;case 1: walkBoxNullLiteral(pos + 8, ast, visitors); return;case 2: walkBoxNumericLiteral(pos + 8, ast, visitors); return;case 3: walkBoxBigIntLiteral(pos + 8, ast, visitors); return;case 4: walkBoxRegExpLiteral(pos + 8, ast, visitors); return;case 5: walkBoxStringLiteral(pos + 8, ast, visitors); return;case 6: walkBoxTemplateLiteral(pos + 8, ast, visitors); return;case 7: walkBoxIdentifierReference(pos + 8, ast, visitors); return;case 8: walkBoxMetaProperty(pos + 8, ast, visitors); return;case 9: walkBoxSuper(pos + 8, ast, visitors); return;case 10: walkBoxArrayExpression(pos + 8, ast, visitors); return;case 11: walkBoxArrowFunctionExpression(pos + 8, ast, visitors); return;case 12: walkBoxAssignmentExpression(pos + 8, ast, visitors); return;case 13: walkBoxAwaitExpression(pos + 8, ast, visitors); return;case 14: walkBoxBinaryExpression(pos + 8, ast, visitors); return;case 15: walkBoxCallExpression(pos + 8, ast, visitors); return;case 16: walkBoxChainExpression(pos + 8, ast, visitors); return;case 17: walkBoxClass(pos + 8, ast, visitors); return;case 18: walkBoxConditionalExpression(pos + 8, ast, visitors); return;case 19: walkBoxFunction(pos + 8, ast, visitors); return;case 20: walkBoxImportExpression(pos + 8, ast, visitors); return;case 21: walkBoxLogicalExpression(pos + 8, ast, visitors); return;case 22: walkBoxNewExpression(pos + 8, ast, visitors); return;case 23: walkBoxObjectExpression(pos + 8, ast, visitors); return;case 24: walkBoxParenthesizedExpression(pos + 8, ast, visitors); return;case 25: walkBoxSequenceExpression(pos + 8, ast, visitors); return;case 26: walkBoxTaggedTemplateExpression(pos + 8, ast, visitors); return;case 27: walkBoxThisExpression(pos + 8, ast, visitors); return;case 28: walkBoxUnaryExpression(pos + 8, ast, visitors); return;case 29: walkBoxUpdateExpression(pos + 8, ast, visitors); return;case 30: walkBoxYieldExpression(pos + 8, ast, visitors); return;case 31: walkBoxPrivateInExpression(pos + 8, ast, visitors); return;case 32: walkBoxJSXElement(pos + 8, ast, visitors); return;case 33: walkBoxJSXFragment(pos + 8, ast, visitors); return;case 34: walkBoxTSAsExpression(pos + 8, ast, visitors); return;case 35: walkBoxTSSatisfiesExpression(pos + 8, ast, visitors); return;case 36: walkBoxTSTypeAssertion(pos + 8, ast, visitors); return;case 37: walkBoxTSNonNullExpression(pos + 8, ast, visitors); return;case 38: walkBoxTSInstantiationExpression(pos + 8, ast, visitors); return;case 39: walkBoxV8IntrinsicExpression(pos + 8, ast, visitors); return;case 48: walkBoxComputedMemberExpression(pos + 8, ast, visitors); return;case 49: walkBoxStaticMemberExpression(pos + 8, ast, visitors); return;case 50: walkBoxPrivateFieldExpression(pos + 8, ast, visitors); return;case 64: walkBoxSpreadElement(pos + 8, ast, visitors); return;case 65: walkElision(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for ArrayExpressionElement`);
                }
            }
            ...
            function walkObjectPropertyKind(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxObjectProperty(pos + 8, ast, visitors); return;case 1: walkBoxSpreadElement(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for ObjectPropertyKind`);
                }
            }
...
walkExpression(pos + 24, ast, visitors);
            ...
            function walkPropertyKey(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxBooleanLiteral(pos + 8, ast, visitors); return;case 1: walkBoxNullLiteral(pos + 8, ast, visitors); return;case 2: walkBoxNumericLiteral(pos + 8, ast, visitors); return;case 3: walkBoxBigIntLiteral(pos + 8, ast, visitors); return;case 4: walkBoxRegExpLiteral(pos + 8, ast, visitors); return;case 5: walkBoxStringLiteral(pos + 8, ast, visitors); return;case 6: walkBoxTemplateLiteral(pos + 8, ast, visitors); return;case 7: walkBoxIdentifierReference(pos + 8, ast, visitors); return;case 8: walkBoxMetaProperty(pos + 8, ast, visitors); return;case 9: walkBoxSuper(pos + 8, ast, visitors); return;case 10: walkBoxArrayExpression(pos + 8, ast, visitors); return;case 11: walkBoxArrowFunctionExpression(pos + 8, ast, visitors); return;case 12: walkBoxAssignmentExpression(pos + 8, ast, visitors); return;case 13: walkBoxAwaitExpression(pos + 8, ast, visitors); return;case 14: walkBoxBinaryExpression(pos + 8, ast, visitors); return;case 15: walkBoxCallExpression(pos + 8, ast, visitors); return;case 16: walkBoxChainExpression(pos + 8, ast, visitors); return;case 17: walkBoxClass(pos + 8, ast, visitors); return;case 18: walkBoxConditionalExpression(pos + 8, ast, visitors); return;case 19: walkBoxFunction(pos + 8, ast, visitors); return;case 20: walkBoxImportExpression(pos + 8, ast, visitors); return;case 21: walkBoxLogicalExpression(pos + 8, ast, visitors); return;case 22: walkBoxNewExpression(pos + 8, ast, visitors); return;case 23: walkBoxObjectExpression(pos + 8, ast, visitors); return;case 24: walkBoxParenthesizedExpression(pos + 8, ast, visitors); return;case 25: walkBoxSequenceExpression(pos + 8, ast, visitors); return;case 26: walkBoxTaggedTemplateExpression(pos + 8, ast, visitors); return;case 27: walkBoxThisExpression(pos + 8, ast, visitors); return;case 28: walkBoxUnaryExpression(pos + 8, ast, visitors); return;case 29: walkBoxUpdateExpression(pos + 8, ast, visitors); return;case 30: walkBoxYieldExpression(pos + 8, ast, visitors); return;case 31: walkBoxPrivateInExpression(pos + 8, ast, visitors); return;case 32: walkBoxJSXElement(pos + 8, ast, visitors); return;case 33: walkBoxJSXFragment(pos + 8, ast, visitors); return;case 34: walkBoxTSAsExpression(pos + 8, ast, visitors); return;case 35: walkBoxTSSatisfiesExpression(pos + 8, ast, visitors); return;case 36: walkBoxTSTypeAssertion(pos + 8, ast, visitors); return;case 37: walkBoxTSNonNullExpression(pos + 8, ast, visitors); return;case 38: walkBoxTSInstantiationExpression(pos + 8, ast, visitors); return;case 39: walkBoxV8IntrinsicExpression(pos + 8, ast, visitors); return;case 48: walkBoxComputedMemberExpression(pos + 8, ast, visitors); return;case 49: walkBoxStaticMemberExpression(pos + 8, ast, visitors); return;case 50: walkBoxPrivateFieldExpression(pos + 8, ast, visitors); return;case 64: walkBoxIdentifierName(pos + 8, ast, visitors); return;case 65: walkBoxPrivateIdentifier(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for PropertyKey`);
                }
            }
...
walkIdentifierName(pos + 32, ast, visitors);
            ...
            function walkArgument(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxBooleanLiteral(pos + 8, ast, visitors); return;case 1: walkBoxNullLiteral(pos + 8, ast, visitors); return;case 2: walkBoxNumericLiteral(pos + 8, ast, visitors); return;case 3: walkBoxBigIntLiteral(pos + 8, ast, visitors); return;case 4: walkBoxRegExpLiteral(pos + 8, ast, visitors); return;case 5: walkBoxStringLiteral(pos + 8, ast, visitors); return;case 6: walkBoxTemplateLiteral(pos + 8, ast, visitors); return;case 7: walkBoxIdentifierReference(pos + 8, ast, visitors); return;case 8: walkBoxMetaProperty(pos + 8, ast, visitors); return;case 9: walkBoxSuper(pos + 8, ast, visitors); return;case 10: walkBoxArrayExpression(pos + 8, ast, visitors); return;case 11: walkBoxArrowFunctionExpression(pos + 8, ast, visitors); return;case 12: walkBoxAssignmentExpression(pos + 8, ast, visitors); return;case 13: walkBoxAwaitExpression(pos + 8, ast, visitors); return;case 14: walkBoxBinaryExpression(pos + 8, ast, visitors); return;case 15: walkBoxCallExpression(pos + 8, ast, visitors); return;case 16: walkBoxChainExpression(pos + 8, ast, visitors); return;case 17: walkBoxClass(pos + 8, ast, visitors); return;case 18: walkBoxConditionalExpression(pos + 8, ast, visitors); return;case 19: walkBoxFunction(pos + 8, ast, visitors); return;case 20: walkBoxImportExpression(pos + 8, ast, visitors); return;case 21: walkBoxLogicalExpression(pos + 8, ast, visitors); return;case 22: walkBoxNewExpression(pos + 8, ast, visitors); return;case 23: walkBoxObjectExpression(pos + 8, ast, visitors); return;case 24: walkBoxParenthesizedExpression(pos + 8, ast, visitors); return;case 25: walkBoxSequenceExpression(pos + 8, ast, visitors); return;case 26: walkBoxTaggedTemplateExpression(pos + 8, ast, visitors); return;case 27: walkBoxThisExpression(pos + 8, ast, visitors); return;case 28: walkBoxUnaryExpression(pos + 8, ast, visitors); return;case 29: walkBoxUpdateExpression(pos + 8, ast, visitors); return;case 30: walkBoxYieldExpression(pos + 8, ast, visitors); return;case 31: walkBoxPrivateInExpression(pos + 8, ast, visitors); return;case 32: walkBoxJSXElement(pos + 8, ast, visitors); return;case 33: walkBoxJSXFragment(pos + 8, ast, visitors); return;case 34: walkBoxTSAsExpression(pos + 8, ast, visitors); return;case 35: walkBoxTSSatisfiesExpression(pos + 8, ast, visitors); return;case 36: walkBoxTSTypeAssertion(pos + 8, ast, visitors); return;case 37: walkBoxTSNonNullExpression(pos + 8, ast, visitors); return;case 38: walkBoxTSInstantiationExpression(pos + 8, ast, visitors); return;case 39: walkBoxV8IntrinsicExpression(pos + 8, ast, visitors); return;case 48: walkBoxComputedMemberExpression(pos + 8, ast, visitors); return;case 49: walkBoxStaticMemberExpression(pos + 8, ast, visitors); return;case 50: walkBoxPrivateFieldExpression(pos + 8, ast, visitors); return;case 64: walkBoxSpreadElement(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for Argument`);
                }
            }
...
walkExpression(pos + 24, ast, visitors);
            ...
            function walkAssignmentTarget(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxIdentifierReference(pos + 8, ast, visitors); return;case 1: walkBoxTSAsExpression(pos + 8, ast, visitors); return;case 2: walkBoxTSSatisfiesExpression(pos + 8, ast, visitors); return;case 3: walkBoxTSNonNullExpression(pos + 8, ast, visitors); return;case 4: walkBoxTSTypeAssertion(pos + 8, ast, visitors); return;case 8: walkBoxArrayAssignmentTarget(pos + 8, ast, visitors); return;case 9: walkBoxObjectAssignmentTarget(pos + 8, ast, visitors); return;case 48: walkBoxComputedMemberExpression(pos + 8, ast, visitors); return;case 49: walkBoxStaticMemberExpression(pos + 8, ast, visitors); return;case 50: walkBoxPrivateFieldExpression(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for AssignmentTarget`);
                }
            }
        
            function walkSimpleAssignmentTarget(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxIdentifierReference(pos + 8, ast, visitors); return;case 1: walkBoxTSAsExpression(pos + 8, ast, visitors); return;case 2: walkBoxTSSatisfiesExpression(pos + 8, ast, visitors); return;case 3: walkBoxTSNonNullExpression(pos + 8, ast, visitors); return;case 4: walkBoxTSTypeAssertion(pos + 8, ast, visitors); return;case 48: walkBoxComputedMemberExpression(pos + 8, ast, visitors); return;case 49: walkBoxStaticMemberExpression(pos + 8, ast, visitors); return;case 50: walkBoxPrivateFieldExpression(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for SimpleAssignmentTarget`);
                }
            }
            ...
            function walkAssignmentTargetMaybeDefault(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxIdentifierReference(pos + 8, ast, visitors); return;case 1: walkBoxTSAsExpression(pos + 8, ast, visitors); return;case 2: walkBoxTSSatisfiesExpression(pos + 8, ast, visitors); return;case 3: walkBoxTSNonNullExpression(pos + 8, ast, visitors); return;case 4: walkBoxTSTypeAssertion(pos + 8, ast, visitors); return;case 8: walkBoxArrayAssignmentTarget(pos + 8, ast, visitors); return;case 9: walkBoxObjectAssignmentTarget(pos + 8, ast, visitors); return;case 16: walkBoxAssignmentTargetWithDefault(pos + 8, ast, visitors); return;case 48: walkBoxComputedMemberExpression(pos + 8, ast, visitors); return;case 49: walkBoxStaticMemberExpression(pos + 8, ast, visitors); return;case 50: walkBoxPrivateFieldExpression(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for AssignmentTargetMaybeDefault`);
                }
            }
...
walkExpression(pos + 24, ast, visitors);
            ...
            function walkAssignmentTargetProperty(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxAssignmentTargetPropertyIdentifier(pos + 8, ast, visitors); return;case 1: walkBoxAssignmentTargetPropertyProperty(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for AssignmentTargetProperty`);
                }
            }
...
walkAssignmentTargetMaybeDefault(pos + 24, ast, visitors);
            ...
            function walkChainElement(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxCallExpression(pos + 8, ast, visitors); return;case 1: walkBoxTSNonNullExpression(pos + 8, ast, visitors); return;case 48: walkBoxComputedMemberExpression(pos + 8, ast, visitors); return;case 49: walkBoxStaticMemberExpression(pos + 8, ast, visitors); return;case 50: walkBoxPrivateFieldExpression(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for ChainElement`);
                }
            }
            ...
            function walkStatement(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxBlockStatement(pos + 8, ast, visitors); return;case 1: walkBoxBreakStatement(pos + 8, ast, visitors); return;case 2: walkBoxContinueStatement(pos + 8, ast, visitors); return;case 3: walkBoxDebuggerStatement(pos + 8, ast, visitors); return;case 4: walkBoxDoWhileStatement(pos + 8, ast, visitors); return;case 5: walkBoxEmptyStatement(pos + 8, ast, visitors); return;case 6: walkBoxExpressionStatement(pos + 8, ast, visitors); return;case 7: walkBoxForInStatement(pos + 8, ast, visitors); return;case 8: walkBoxForOfStatement(pos + 8, ast, visitors); return;case 9: walkBoxForStatement(pos + 8, ast, visitors); return;case 10: walkBoxIfStatement(pos + 8, ast, visitors); return;case 11: walkBoxLabeledStatement(pos + 8, ast, visitors); return;case 12: walkBoxReturnStatement(pos + 8, ast, visitors); return;case 13: walkBoxSwitchStatement(pos + 8, ast, visitors); return;case 14: walkBoxThrowStatement(pos + 8, ast, visitors); return;case 15: walkBoxTryStatement(pos + 8, ast, visitors); return;case 16: walkBoxWhileStatement(pos + 8, ast, visitors); return;case 17: walkBoxWithStatement(pos + 8, ast, visitors); return;case 32: walkBoxVariableDeclaration(pos + 8, ast, visitors); return;case 33: walkBoxFunction(pos + 8, ast, visitors); return;case 34: walkBoxClass(pos + 8, ast, visitors); return;case 35: walkBoxTSTypeAliasDeclaration(pos + 8, ast, visitors); return;case 36: walkBoxTSInterfaceDeclaration(pos + 8, ast, visitors); return;case 37: walkBoxTSEnumDeclaration(pos + 8, ast, visitors); return;case 38: walkBoxTSModuleDeclaration(pos + 8, ast, visitors); return;case 39: walkBoxTSGlobalDeclaration(pos + 8, ast, visitors); return;case 40: walkBoxTSImportEqualsDeclaration(pos + 8, ast, visitors); return;case 64: walkBoxImportDeclaration(pos + 8, ast, visitors); return;case 65: walkBoxExportAllDeclaration(pos + 8, ast, visitors); return;case 66: walkBoxExportDefaultDeclaration(pos + 8, ast, visitors); return;case 67: walkBoxExportNamedDeclaration(pos + 8, ast, visitors); return;case 68: walkBoxTSExportAssignment(pos + 8, ast, visitors); return;case 69: walkBoxTSNamespaceExportDeclaration(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for Statement`);
                }
            }
            ...
            function walkDeclaration(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 32: walkBoxVariableDeclaration(pos + 8, ast, visitors); return;case 33: walkBoxFunction(pos + 8, ast, visitors); return;case 34: walkBoxClass(pos + 8, ast, visitors); return;case 35: walkBoxTSTypeAliasDeclaration(pos + 8, ast, visitors); return;case 36: walkBoxTSInterfaceDeclaration(pos + 8, ast, visitors); return;case 37: walkBoxTSEnumDeclaration(pos + 8, ast, visitors); return;case 38: walkBoxTSModuleDeclaration(pos + 8, ast, visitors); return;case 39: walkBoxTSGlobalDeclaration(pos + 8, ast, visitors); return;case 40: walkBoxTSImportEqualsDeclaration(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for Declaration`);
                }
            }
...
walkStatement(pos + 56, ast, visitors);
            ...
            function walkForStatementInit(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxBooleanLiteral(pos + 8, ast, visitors); return;case 1: walkBoxNullLiteral(pos + 8, ast, visitors); return;case 2: walkBoxNumericLiteral(pos + 8, ast, visitors); return;case 3: walkBoxBigIntLiteral(pos + 8, ast, visitors); return;case 4: walkBoxRegExpLiteral(pos + 8, ast, visitors); return;case 5: walkBoxStringLiteral(pos + 8, ast, visitors); return;case 6: walkBoxTemplateLiteral(pos + 8, ast, visitors); return;case 7: walkBoxIdentifierReference(pos + 8, ast, visitors); return;case 8: walkBoxMetaProperty(pos + 8, ast, visitors); return;case 9: walkBoxSuper(pos + 8, ast, visitors); return;case 10: walkBoxArrayExpression(pos + 8, ast, visitors); return;case 11: walkBoxArrowFunctionExpression(pos + 8, ast, visitors); return;case 12: walkBoxAssignmentExpression(pos + 8, ast, visitors); return;case 13: walkBoxAwaitExpression(pos + 8, ast, visitors); return;case 14: walkBoxBinaryExpression(pos + 8, ast, visitors); return;case 15: walkBoxCallExpression(pos + 8, ast, visitors); return;case 16: walkBoxChainExpression(pos + 8, ast, visitors); return;case 17: walkBoxClass(pos + 8, ast, visitors); return;case 18: walkBoxConditionalExpression(pos + 8, ast, visitors); return;case 19: walkBoxFunction(pos + 8, ast, visitors); return;case 20: walkBoxImportExpression(pos + 8, ast, visitors); return;case 21: walkBoxLogicalExpression(pos + 8, ast, visitors); return;case 22: walkBoxNewExpression(pos + 8, ast, visitors); return;case 23: walkBoxObjectExpression(pos + 8, ast, visitors); return;case 24: walkBoxParenthesizedExpression(pos + 8, ast, visitors); return;case 25: walkBoxSequenceExpression(pos + 8, ast, visitors); return;case 26: walkBoxTaggedTemplateExpression(pos + 8, ast, visitors); return;case 27: walkBoxThisExpression(pos + 8, ast, visitors); return;case 28: walkBoxUnaryExpression(pos + 8, ast, visitors); return;case 29: walkBoxUpdateExpression(pos + 8, ast, visitors); return;case 30: walkBoxYieldExpression(pos + 8, ast, visitors); return;case 31: walkBoxPrivateInExpression(pos + 8, ast, visitors); return;case 32: walkBoxJSXElement(pos + 8, ast, visitors); return;case 33: walkBoxJSXFragment(pos + 8, ast, visitors); return;case 34: walkBoxTSAsExpression(pos + 8, ast, visitors); return;case 35: walkBoxTSSatisfiesExpression(pos + 8, ast, visitors); return;case 36: walkBoxTSTypeAssertion(pos + 8, ast, visitors); return;case 37: walkBoxTSNonNullExpression(pos + 8, ast, visitors); return;case 38: walkBoxTSInstantiationExpression(pos + 8, ast, visitors); return;case 39: walkBoxV8IntrinsicExpression(pos + 8, ast, visitors); return;case 48: walkBoxComputedMemberExpression(pos + 8, ast, visitors); return;case 49: walkBoxStaticMemberExpression(pos + 8, ast, visitors); return;case 50: walkBoxPrivateFieldExpression(pos + 8, ast, visitors); return;case 64: walkBoxVariableDeclaration(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for ForStatementInit`);
                }
            }
...
walkStatement(pos + 40, ast, visitors);
            ...
            function walkForStatementLeft(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxIdentifierReference(pos + 8, ast, visitors); return;case 1: walkBoxTSAsExpression(pos + 8, ast, visitors); return;case 2: walkBoxTSSatisfiesExpression(pos + 8, ast, visitors); return;case 3: walkBoxTSNonNullExpression(pos + 8, ast, visitors); return;case 4: walkBoxTSTypeAssertion(pos + 8, ast, visitors); return;case 8: walkBoxArrayAssignmentTarget(pos + 8, ast, visitors); return;case 9: walkBoxObjectAssignmentTarget(pos + 8, ast, visitors); return;case 16: walkBoxVariableDeclaration(pos + 8, ast, visitors); return;case 48: walkBoxComputedMemberExpression(pos + 8, ast, visitors); return;case 49: walkBoxStaticMemberExpression(pos + 8, ast, visitors); return;case 50: walkBoxPrivateFieldExpression(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for ForStatementLeft`);
                }
            }
...
walkOptionBoxTSTypeAnnotation(pos + 16, ast, visitors);
            ...
            function walkBindingPatternKind(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxBindingIdentifier(pos + 8, ast, visitors); return;case 1: walkBoxObjectPattern(pos + 8, ast, visitors); return;case 2: walkBoxArrayPattern(pos + 8, ast, visitors); return;case 3: walkBoxAssignmentPattern(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for BindingPatternKind`);
                }
            }
...
walkBoxClassBody(pos + 120, ast, visitors);
            ...
            function walkClassElement(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxStaticBlock(pos + 8, ast, visitors); return;case 1: walkBoxMethodDefinition(pos + 8, ast, visitors); return;case 2: walkBoxPropertyDefinition(pos + 8, ast, visitors); return;case 3: walkBoxAccessorProperty(pos + 8, ast, visitors); return;case 4: walkBoxTSIndexSignature(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for ClassElement`);
                }
            }
...
walkOptionBoxWithClause(pos + 80, ast, visitors);
            ...
            function walkImportDeclarationSpecifier(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxImportSpecifier(pos + 8, ast, visitors); return;case 1: walkBoxImportDefaultSpecifier(pos + 8, ast, visitors); return;case 2: walkBoxImportNamespaceSpecifier(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for ImportDeclarationSpecifier`);
                }
            }
...
walkStringLiteral(pos + 64, ast, visitors);
            ...
            function walkImportAttributeKey(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkIdentifierName(pos + 8, ast, visitors); return;case 1: walkStringLiteral(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for ImportAttributeKey`);
                }
            }
...
walkModuleExportName(pos + 64, ast, visitors);
            ...
            function walkExportDefaultDeclarationKind(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxBooleanLiteral(pos + 8, ast, visitors); return;case 1: walkBoxNullLiteral(pos + 8, ast, visitors); return;case 2: walkBoxNumericLiteral(pos + 8, ast, visitors); return;case 3: walkBoxBigIntLiteral(pos + 8, ast, visitors); return;case 4: walkBoxRegExpLiteral(pos + 8, ast, visitors); return;case 5: walkBoxStringLiteral(pos + 8, ast, visitors); return;case 6: walkBoxTemplateLiteral(pos + 8, ast, visitors); return;case 7: walkBoxIdentifierReference(pos + 8, ast, visitors); return;case 8: walkBoxMetaProperty(pos + 8, ast, visitors); return;case 9: walkBoxSuper(pos + 8, ast, visitors); return;case 10: walkBoxArrayExpression(pos + 8, ast, visitors); return;case 11: walkBoxArrowFunctionExpression(pos + 8, ast, visitors); return;case 12: walkBoxAssignmentExpression(pos + 8, ast, visitors); return;case 13: walkBoxAwaitExpression(pos + 8, ast, visitors); return;case 14: walkBoxBinaryExpression(pos + 8, ast, visitors); return;case 15: walkBoxCallExpression(pos + 8, ast, visitors); return;case 16: walkBoxChainExpression(pos + 8, ast, visitors); return;case 17: walkBoxClass(pos + 8, ast, visitors); return;case 18: walkBoxConditionalExpression(pos + 8, ast, visitors); return;case 19: walkBoxFunction(pos + 8, ast, visitors); return;case 20: walkBoxImportExpression(pos + 8, ast, visitors); return;case 21: walkBoxLogicalExpression(pos + 8, ast, visitors); return;case 22: walkBoxNewExpression(pos + 8, ast, visitors); return;case 23: walkBoxObjectExpression(pos + 8, ast, visitors); return;case 24: walkBoxParenthesizedExpression(pos + 8, ast, visitors); return;case 25: walkBoxSequenceExpression(pos + 8, ast, visitors); return;case 26: walkBoxTaggedTemplateExpression(pos + 8, ast, visitors); return;case 27: walkBoxThisExpression(pos + 8, ast, visitors); return;case 28: walkBoxUnaryExpression(pos + 8, ast, visitors); return;case 29: walkBoxUpdateExpression(pos + 8, ast, visitors); return;case 30: walkBoxYieldExpression(pos + 8, ast, visitors); return;case 31: walkBoxPrivateInExpression(pos + 8, ast, visitors); return;case 32: walkBoxJSXElement(pos + 8, ast, visitors); return;case 33: walkBoxJSXFragment(pos + 8, ast, visitors); return;case 34: walkBoxTSAsExpression(pos + 8, ast, visitors); return;case 35: walkBoxTSSatisfiesExpression(pos + 8, ast, visitors); return;case 36: walkBoxTSTypeAssertion(pos + 8, ast, visitors); return;case 37: walkBoxTSNonNullExpression(pos + 8, ast, visitors); return;case 38: walkBoxTSInstantiationExpression(pos + 8, ast, visitors); return;case 39: walkBoxV8IntrinsicExpression(pos + 8, ast, visitors); return;case 48: walkBoxComputedMemberExpression(pos + 8, ast, visitors); return;case 49: walkBoxStaticMemberExpression(pos + 8, ast, visitors); return;case 50: walkBoxPrivateFieldExpression(pos + 8, ast, visitors); return;case 64: walkBoxFunction(pos + 8, ast, visitors); return;case 65: walkBoxClass(pos + 8, ast, visitors); return;case 66: walkBoxTSInterfaceDeclaration(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for ExportDefaultDeclarationKind`);
                }
            }
        
            function walkModuleExportName(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkIdentifierName(pos + 8, ast, visitors); return;case 1: walkIdentifierReference(pos + 8, ast, visitors); return;case 2: walkStringLiteral(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for ModuleExportName`);
                }
            }
...
walkJSXClosingFragment(pos + 40, ast, visitors);
            ...
            function walkJSXElementName(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxJSXIdentifier(pos + 8, ast, visitors); return;case 1: walkBoxIdentifierReference(pos + 8, ast, visitors); return;case 2: walkBoxJSXNamespacedName(pos + 8, ast, visitors); return;case 3: walkBoxJSXMemberExpression(pos + 8, ast, visitors); return;case 4: walkBoxThisExpression(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for JSXElementName`);
                }
            }
...
walkJSXIdentifier(pos + 24, ast, visitors);
            ...
            function walkJSXMemberExpressionObject(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxIdentifierReference(pos + 8, ast, visitors); return;case 1: walkBoxJSXMemberExpression(pos + 8, ast, visitors); return;case 2: walkBoxThisExpression(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for JSXMemberExpressionObject`);
                }
            }
            ...
            function walkJSXExpression(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxBooleanLiteral(pos + 8, ast, visitors); return;case 1: walkBoxNullLiteral(pos + 8, ast, visitors); return;case 2: walkBoxNumericLiteral(pos + 8, ast, visitors); return;case 3: walkBoxBigIntLiteral(pos + 8, ast, visitors); return;case 4: walkBoxRegExpLiteral(pos + 8, ast, visitors); return;case 5: walkBoxStringLiteral(pos + 8, ast, visitors); return;case 6: walkBoxTemplateLiteral(pos + 8, ast, visitors); return;case 7: walkBoxIdentifierReference(pos + 8, ast, visitors); return;case 8: walkBoxMetaProperty(pos + 8, ast, visitors); return;case 9: walkBoxSuper(pos + 8, ast, visitors); return;case 10: walkBoxArrayExpression(pos + 8, ast, visitors); return;case 11: walkBoxArrowFunctionExpression(pos + 8, ast, visitors); return;case 12: walkBoxAssignmentExpression(pos + 8, ast, visitors); return;case 13: walkBoxAwaitExpression(pos + 8, ast, visitors); return;case 14: walkBoxBinaryExpression(pos + 8, ast, visitors); return;case 15: walkBoxCallExpression(pos + 8, ast, visitors); return;case 16: walkBoxChainExpression(pos + 8, ast, visitors); return;case 17: walkBoxClass(pos + 8, ast, visitors); return;case 18: walkBoxConditionalExpression(pos + 8, ast, visitors); return;case 19: walkBoxFunction(pos + 8, ast, visitors); return;case 20: walkBoxImportExpression(pos + 8, ast, visitors); return;case 21: walkBoxLogicalExpression(pos + 8, ast, visitors); return;case 22: walkBoxNewExpression(pos + 8, ast, visitors); return;case 23: walkBoxObjectExpression(pos + 8, ast, visitors); return;case 24: walkBoxParenthesizedExpression(pos + 8, ast, visitors); return;case 25: walkBoxSequenceExpression(pos + 8, ast, visitors); return;case 26: walkBoxTaggedTemplateExpression(pos + 8, ast, visitors); return;case 27: walkBoxThisExpression(pos + 8, ast, visitors); return;case 28: walkBoxUnaryExpression(pos + 8, ast, visitors); return;case 29: walkBoxUpdateExpression(pos + 8, ast, visitors); return;case 30: walkBoxYieldExpression(pos + 8, ast, visitors); return;case 31: walkBoxPrivateInExpression(pos + 8, ast, visitors); return;case 32: walkBoxJSXElement(pos + 8, ast, visitors); return;case 33: walkBoxJSXFragment(pos + 8, ast, visitors); return;case 34: walkBoxTSAsExpression(pos + 8, ast, visitors); return;case 35: walkBoxTSSatisfiesExpression(pos + 8, ast, visitors); return;case 36: walkBoxTSTypeAssertion(pos + 8, ast, visitors); return;case 37: walkBoxTSNonNullExpression(pos + 8, ast, visitors); return;case 38: walkBoxTSInstantiationExpression(pos + 8, ast, visitors); return;case 39: walkBoxV8IntrinsicExpression(pos + 8, ast, visitors); return;case 48: walkBoxComputedMemberExpression(pos + 8, ast, visitors); return;case 49: walkBoxStaticMemberExpression(pos + 8, ast, visitors); return;case 50: walkBoxPrivateFieldExpression(pos + 8, ast, visitors); return;case 64: walkJSXEmptyExpression(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for JSXExpression`);
                }
            }
            ...
            function walkJSXAttributeItem(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxJSXAttribute(pos + 8, ast, visitors); return;case 1: walkBoxJSXSpreadAttribute(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for JSXAttributeItem`);
                }
            }
...
walkOptionJSXAttributeValue(pos + 24, ast, visitors);
            ...
            function walkJSXAttributeName(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxJSXIdentifier(pos + 8, ast, visitors); return;case 1: walkBoxJSXNamespacedName(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for JSXAttributeName`);
                }
            }
        
            function walkJSXAttributeValue(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxStringLiteral(pos + 8, ast, visitors); return;case 1: walkBoxJSXExpressionContainer(pos + 8, ast, visitors); return;case 2: walkBoxJSXElement(pos + 8, ast, visitors); return;case 3: walkBoxJSXFragment(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for JSXAttributeValue`);
                }
            }
            ...
            function walkJSXChild(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxJSXText(pos + 8, ast, visitors); return;case 1: walkBoxJSXElement(pos + 8, ast, visitors); return;case 2: walkBoxJSXFragment(pos + 8, ast, visitors); return;case 3: walkBoxJSXExpressionContainer(pos + 8, ast, visitors); return;case 4: walkBoxJSXSpreadChild(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for JSXChild`);
                }
            }
...
walkOptionExpression(pos + 24, ast, visitors);
            ...
            function walkTSEnumMemberName(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxIdentifierName(pos + 8, ast, visitors); return;case 1: walkBoxStringLiteral(pos + 8, ast, visitors); return;case 2: walkBoxStringLiteral(pos + 8, ast, visitors); return;case 3: walkBoxTemplateLiteral(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for TSEnumMemberName`);
                }
            }
            ...
            function walkTSLiteral(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxBooleanLiteral(pos + 8, ast, visitors); return;case 1: walkBoxNumericLiteral(pos + 8, ast, visitors); return;case 2: walkBoxBigIntLiteral(pos + 8, ast, visitors); return;case 3: walkBoxStringLiteral(pos + 8, ast, visitors); return;case 4: walkBoxTemplateLiteral(pos + 8, ast, visitors); return;case 5: walkBoxUnaryExpression(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for TSLiteral`);
                }
            }
        
            function walkTSType(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxTSAnyKeyword(pos + 8, ast, visitors); return;case 1: walkBoxTSBigIntKeyword(pos + 8, ast, visitors); return;case 2: walkBoxTSBooleanKeyword(pos + 8, ast, visitors); return;case 3: walkBoxTSIntrinsicKeyword(pos + 8, ast, visitors); return;case 4: walkBoxTSNeverKeyword(pos + 8, ast, visitors); return;case 5: walkBoxTSNullKeyword(pos + 8, ast, visitors); return;case 6: walkBoxTSNumberKeyword(pos + 8, ast, visitors); return;case 7: walkBoxTSObjectKeyword(pos + 8, ast, visitors); return;case 8: walkBoxTSStringKeyword(pos + 8, ast, visitors); return;case 9: walkBoxTSSymbolKeyword(pos + 8, ast, visitors); return;case 10: walkBoxTSThisType(pos + 8, ast, visitors); return;case 11: walkBoxTSUndefinedKeyword(pos + 8, ast, visitors); return;case 12: walkBoxTSUnknownKeyword(pos + 8, ast, visitors); return;case 13: walkBoxTSVoidKeyword(pos + 8, ast, visitors); return;case 14: walkBoxTSArrayType(pos + 8, ast, visitors); return;case 15: walkBoxTSConditionalType(pos + 8, ast, visitors); return;case 16: walkBoxTSConstructorType(pos + 8, ast, visitors); return;case 17: walkBoxTSFunctionType(pos + 8, ast, visitors); return;case 18: walkBoxTSImportType(pos + 8, ast, visitors); return;case 19: walkBoxTSIndexedAccessType(pos + 8, ast, visitors); return;case 20: walkBoxTSInferType(pos + 8, ast, visitors); return;case 21: walkBoxTSIntersectionType(pos + 8, ast, visitors); return;case 22: walkBoxTSLiteralType(pos + 8, ast, visitors); return;case 23: walkBoxTSMappedType(pos + 8, ast, visitors); return;case 24: walkBoxTSNamedTupleMember(pos + 8, ast, visitors); return;case 26: walkBoxTSTemplateLiteralType(pos + 8, ast, visitors); return;case 27: walkBoxTSTupleType(pos + 8, ast, visitors); return;case 28: walkBoxTSTypeLiteral(pos + 8, ast, visitors); return;case 29: walkBoxTSTypeOperator(pos + 8, ast, visitors); return;case 30: walkBoxTSTypePredicate(pos + 8, ast, visitors); return;case 31: walkBoxTSTypeQuery(pos + 8, ast, visitors); return;case 32: walkBoxTSTypeReference(pos + 8, ast, visitors); return;case 33: walkBoxTSUnionType(pos + 8, ast, visitors); return;case 34: walkBoxTSParenthesizedType(pos + 8, ast, visitors); return;case 35: walkBoxJSDocNullableType(pos + 8, ast, visitors); return;case 36: walkBoxJSDocNonNullableType(pos + 8, ast, visitors); return;case 37: walkBoxJSDocUnknownType(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for TSType`);
                }
            }
...
walkTSTupleElement(pos + 32, ast, visitors);
            ...
            function walkTSTupleElement(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxTSAnyKeyword(pos + 8, ast, visitors); return;case 1: walkBoxTSBigIntKeyword(pos + 8, ast, visitors); return;case 2: walkBoxTSBooleanKeyword(pos + 8, ast, visitors); return;case 3: walkBoxTSIntrinsicKeyword(pos + 8, ast, visitors); return;case 4: walkBoxTSNeverKeyword(pos + 8, ast, visitors); return;case 5: walkBoxTSNullKeyword(pos + 8, ast, visitors); return;case 6: walkBoxTSNumberKeyword(pos + 8, ast, visitors); return;case 7: walkBoxTSObjectKeyword(pos + 8, ast, visitors); return;case 8: walkBoxTSStringKeyword(pos + 8, ast, visitors); return;case 9: walkBoxTSSymbolKeyword(pos + 8, ast, visitors); return;case 10: walkBoxTSThisType(pos + 8, ast, visitors); return;case 11: walkBoxTSUndefinedKeyword(pos + 8, ast, visitors); return;case 12: walkBoxTSUnknownKeyword(pos + 8, ast, visitors); return;case 13: walkBoxTSVoidKeyword(pos + 8, ast, visitors); return;case 14: walkBoxTSArrayType(pos + 8, ast, visitors); return;case 15: walkBoxTSConditionalType(pos + 8, ast, visitors); return;case 16: walkBoxTSConstructorType(pos + 8, ast, visitors); return;case 17: walkBoxTSFunctionType(pos + 8, ast, visitors); return;case 18: walkBoxTSImportType(pos + 8, ast, visitors); return;case 19: walkBoxTSIndexedAccessType(pos + 8, ast, visitors); return;case 20: walkBoxTSInferType(pos + 8, ast, visitors); return;case 21: walkBoxTSIntersectionType(pos + 8, ast, visitors); return;case 22: walkBoxTSLiteralType(pos + 8, ast, visitors); return;case 23: walkBoxTSMappedType(pos + 8, ast, visitors); return;case 24: walkBoxTSNamedTupleMember(pos + 8, ast, visitors); return;case 26: walkBoxTSTemplateLiteralType(pos + 8, ast, visitors); return;case 27: walkBoxTSTupleType(pos + 8, ast, visitors); return;case 28: walkBoxTSTypeLiteral(pos + 8, ast, visitors); return;case 29: walkBoxTSTypeOperator(pos + 8, ast, visitors); return;case 30: walkBoxTSTypePredicate(pos + 8, ast, visitors); return;case 31: walkBoxTSTypeQuery(pos + 8, ast, visitors); return;case 32: walkBoxTSTypeReference(pos + 8, ast, visitors); return;case 33: walkBoxTSUnionType(pos + 8, ast, visitors); return;case 34: walkBoxTSParenthesizedType(pos + 8, ast, visitors); return;case 35: walkBoxJSDocNullableType(pos + 8, ast, visitors); return;case 36: walkBoxJSDocNonNullableType(pos + 8, ast, visitors); return;case 37: walkBoxJSDocUnknownType(pos + 8, ast, visitors); return;case 64: walkBoxTSOptionalType(pos + 8, ast, visitors); return;case 65: walkBoxTSRestType(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for TSTupleElement`);
                }
            }
...
walkOptionBoxTSTypeParameterInstantiation(pos + 24, ast, visitors);
            ...
            function walkTSTypeName(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxIdentifierReference(pos + 8, ast, visitors); return;case 1: walkBoxTSQualifiedName(pos + 8, ast, visitors); return;case 2: walkBoxThisExpression(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for TSTypeName`);
                }
            }
...
walkOptionBoxTSTypeAnnotation(pos + 24, ast, visitors);
            ...
            function walkTSSignature(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxTSIndexSignature(pos + 8, ast, visitors); return;case 1: walkBoxTSPropertySignature(pos + 8, ast, visitors); return;case 2: walkBoxTSCallSignatureDeclaration(pos + 8, ast, visitors); return;case 3: walkBoxTSConstructSignatureDeclaration(pos + 8, ast, visitors); return;case 4: walkBoxTSMethodSignature(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for TSSignature`);
                }
            }
...
walkOptionBoxTSTypeAnnotation(pos + 24, ast, visitors);
            ...
            function walkTSTypePredicateName(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxIdentifierName(pos + 8, ast, visitors); return;case 1: walkTSThisType(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for TSTypePredicateName`);
                }
            }
...
walkOptionTSModuleDeclarationBody(pos + 64, ast, visitors);
            ...
            function walkTSModuleDeclarationName(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBindingIdentifier(pos + 8, ast, visitors); return;case 1: walkStringLiteral(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for TSModuleDeclarationName`);
                }
            }
        
            function walkTSModuleDeclarationBody(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxTSModuleDeclaration(pos + 8, ast, visitors); return;case 1: walkBoxTSModuleBlock(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for TSModuleDeclarationBody`);
                }
            }
...
walkOptionBoxTSTypeParameterInstantiation(pos + 24, ast, visitors);
            ...
            function walkTSTypeQueryExprName(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxIdentifierReference(pos + 8, ast, visitors); return;case 1: walkBoxTSQualifiedName(pos + 8, ast, visitors); return;case 2: walkBoxThisExpression(pos + 8, ast, visitors); return;case 3: walkBoxTSImportType(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for TSTypeQueryExprName`);
                }
            }
...
walkOptionBoxTSTypeParameterInstantiation(pos + 80, ast, visitors);
            ...
            function walkTSImportTypeQualifier(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxIdentifierName(pos + 8, ast, visitors); return;case 1: walkBoxTSImportTypeQualifiedName(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for TSImportTypeQualifier`);
                }
            }
...
walkTSModuleReference(pos + 40, ast, visitors);
            ...
            function walkTSModuleReference(pos, ast, visitors) {
                switch(ast.buffer[pos]) {
                    case 0: walkBoxIdentifierReference(pos + 8, ast, visitors); return;case 1: walkBoxTSQualifiedName(pos + 8, ast, visitors); return;case 2: walkBoxThisExpression(pos + 8, ast, visitors); return;case 3: walkBoxTSExternalModuleReference(pos + 8, ast, visitors); return;
                    default: throw new Error(`Unexpected discriminant ${ast.buffer[pos]} for TSModuleReference`);
                }
            }
...
walkBoxTSTypeParameterInstantiation(pos + 24, ast, visitors);
            ...
            function walkOptionHashbang(pos, ast, visitors) {
                if (!(ast.buffer.uint32[(pos + 8) >> 2] === 0 && ast.buffer.uint32[(pos + 12) >> 2] === 0)) walkHashbang(pos, ast, visitors);
            }
            ...
            function walkOptionBoxTSTypeParameterInstantiation(pos, ast, visitors) {
                if (!(ast.buffer.uint32[pos >> 2] === 0 && ast.buffer.uint32[(pos + 4) >> 2] === 0)) walkBoxTSTypeParameterInstantiation(pos, ast, visitors);
            }
            ...
            function walkOptionLabelIdentifier(pos, ast, visitors) {
                if (!(ast.buffer.uint32[(pos + 8) >> 2] === 0 && ast.buffer.uint32[(pos + 12) >> 2] === 0)) walkLabelIdentifier(pos, ast, visitors);
            }
            ...
            function walkOptionBoxCatchClause(pos, ast, visitors) {
                if (!(ast.buffer.uint32[pos >> 2] === 0 && ast.buffer.uint32[(pos + 4) >> 2] === 0)) walkBoxCatchClause(pos, ast, visitors);
            }
        
            function walkOptionBoxBlockStatement(pos, ast, visitors) {
                if (!(ast.buffer.uint32[pos >> 2] === 0 && ast.buffer.uint32[(pos + 4) >> 2] === 0)) walkBoxBlockStatement(pos, ast, visitors);
            }
            ...
            function walkOptionBoxTSTypeAnnotation(pos, ast, visitors) {
                if (!(ast.buffer.uint32[pos >> 2] === 0 && ast.buffer.uint32[(pos + 4) >> 2] === 0)) walkBoxTSTypeAnnotation(pos, ast, visitors);
            }
            ...
            function walkOptionBindingIdentifier(pos, ast, visitors) {
                if (!(ast.buffer.uint32[(pos + 8) >> 2] === 0 && ast.buffer.uint32[(pos + 12) >> 2] === 0)) walkBindingIdentifier(pos, ast, visitors);
            }
            ...
            function walkOptionBoxTSTypeParameterDeclaration(pos, ast, visitors) {
                if (!(ast.buffer.uint32[pos >> 2] === 0 && ast.buffer.uint32[(pos + 4) >> 2] === 0)) walkBoxTSTypeParameterDeclaration(pos, ast, visitors);
            }
            ...
            function walkOptionBoxFunctionBody(pos, ast, visitors) {
                if (!(ast.buffer.uint32[pos >> 2] === 0 && ast.buffer.uint32[(pos + 4) >> 2] === 0)) walkBoxFunctionBody(pos, ast, visitors);
            }
            ...
            function walkOptionVecImportDeclarationSpecifier(pos, ast, visitors) {
                if (!(ast.buffer.uint32[pos >> 2] === 0 && ast.buffer.uint32[(pos + 4) >> 2] === 0)) walkVecImportDeclarationSpecifier(pos, ast, visitors);
            }
            ...
            function walkOptionBoxWithClause(pos, ast, visitors) {
                if (!(ast.buffer.uint32[pos >> 2] === 0 && ast.buffer.uint32[(pos + 4) >> 2] === 0)) walkBoxWithClause(pos, ast, visitors);
            }
            ...
            function walkOptionBoxJSXClosingElement(pos, ast, visitors) {
                if (!(ast.buffer.uint32[pos >> 2] === 0 && ast.buffer.uint32[(pos + 4) >> 2] === 0)) walkBoxJSXClosingElement(pos, ast, visitors);
            }
            ...
            function walkOptionBoxObjectExpression(pos, ast, visitors) {
                if (!(ast.buffer.uint32[pos >> 2] === 0 && ast.buffer.uint32[(pos + 4) >> 2] === 0)) walkBoxObjectExpression(pos, ast, visitors);
            }
