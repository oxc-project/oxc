...
function deserializeTaggedTemplateExpression(pos) {
  return {
    ...
    typeArguments: deserializeOptionBoxTSTypeParameterInstantiation(pos + 80),
  };
}
...
function deserializePropertyDefinition(pos) {
  return {
    ...
    static: deserializeBool(pos + 73),
    computed: deserializeBool(pos + 72),
    key: deserializePropertyKey(pos + 40),
    value: deserializeOptionExpression(pos + 56),
    decorators: deserializeVecDecorator(pos + 16),
    declare: deserializeBool(pos + 74),
    override: deserializeBool(pos + 75),
    optional: deserializeBool(pos + 76),
    definite: deserializeBool(pos + 77),
    readonly: deserializeBool(pos + 78),
    typeAnnotation: deserializeOptionBoxTSTypeAnnotation(pos + 80),
