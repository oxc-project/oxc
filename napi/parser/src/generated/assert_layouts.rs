...
const _: () = {
    // Padding: 0 bytes
    assert!(size_of::<RawTransferData>() == 320);
    assert!(align_of::<RawTransferData>() == 8);
    assert!(offset_of!(RawTransferData, program) == 0);
    assert!(offset_of!(RawTransferData, comments) == 168);
    assert!(offset_of!(RawTransferData, module) == 192);
    assert!(offset_of!(RawTransferData, errors) == 296);
...
const _: () = if cfg!(target_family = "wasm") || align_of::<u64>() == 8 {
    // Padding: 0 bytes
    assert!(size_of::<RawTransferData>() == 208);
    assert!(align_of::<RawTransferData>() == 4);
    assert!(offset_of!(RawTransferData, program) == 0);
    assert!(offset_of!(RawTransferData, comments) == 108);
    assert!(offset_of!(RawTransferData, module) == 124);
    assert!(offset_of!(RawTransferData, errors) == 192);
