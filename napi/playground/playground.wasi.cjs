...
if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  ...
  try {
    __wasmFilePath = __nodePath.resolve('@oxc-playground/binding-wasm32-wasi');
  } catch {
    throw new Error(
      'Cannot find playground.wasm32-wasi.wasm file, and @oxc-playground/binding-wasm32-wasi package is not installed.',
    );
  }
}
