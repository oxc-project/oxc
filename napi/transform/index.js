...
const { Severity, HelperMode, isolatedDeclaration, isolatedDeclarationSync, moduleRunnerTransform, moduleRunnerTransformSync, transform, transformFast, transformSync, transformSyncFast } = nativeBinding
export { Severity }
export { HelperMode }
